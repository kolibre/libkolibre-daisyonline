...
int main(int argc, char **argv)
{
    ...
    DaisyOnlineHandler DOHandler(std::string(argv[1]), "faultinvalidoperation/1.2.3");
    ...
    assert(DOHandler.getStatus() == DaisyOnlineHandler::FAULT_INVALIDOPERATION);
    assert(DOHandler.getLastSoapFaultReason() == "Invalid Operation");
