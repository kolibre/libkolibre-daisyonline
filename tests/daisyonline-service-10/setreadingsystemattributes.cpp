...
int main(int argc, char **argv)
{
    ...
    // unsuccessful setReadingSystemAttributs request
    kdo::ReadingSystemAttributes invalidReadingSystemAttributes;
    assert(!DOHandler.setReadingSystemAttributes(invalidReadingSystemAttributes));
