...
int main(int argc, char **argv)
{
    ...
    DaisyOnlineHandler DOHandler(std::string(argv[1]), "faultinternalservererror/1.2.3");
    ...
    assert(DOHandler.getStatus() == DaisyOnlineHandler::FAULT_INTERNALSERVERERROR);
    assert(DOHandler.getLastSoapFaultReason() == "Internal Server Error");
