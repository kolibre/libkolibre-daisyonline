 ...
 */
        ...
        #ifndef ADB_ENCRYPTIONPROPERTIES_H
        #define ADB_ENCRYPTIONPROPERTIES_H

       /**
        * adb_EncryptionProperties.h
        *
       ...
       /**
        *  adb_EncryptionProperties class
        */
        ...
        typedef struct adb_EncryptionProperties adb_EncryptionProperties_t;
        ...
        /**
         * Constructor for creating adb_EncryptionProperties_t
         * @param env pointer to environment struct
         * @return newly created adb_EncryptionProperties_t object
         */
         ...
         * @param  _EncryptionProperties adb_EncryptionProperties_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_EncryptionProperties_t object
         * @param  _EncryptionProperties adb_EncryptionProperties_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _EncryptionProperties adb_EncryptionProperties_t object
         * @param env pointer to environment struct
       ...
       adb_EncryptionProperties_declare_parent_namespaces(
         ...
         * @param  _EncryptionProperties adb_EncryptionProperties_t object
         * @param env pointer to environment struct
         * @param EncryptionProperties_om_node node to serialize from
         * @param EncryptionProperties_om_element parent element to serialize from
        ...
        adb_EncryptionProperties_serialize(
            adb_EncryptionProperties_t* _EncryptionProperties,
            const axutil_env_t *env,
            axiom_node_t* EncryptionProperties_om_node, axiom_element_t *EncryptionProperties_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_EncryptionProperties is a particle class (E.g. group, inner sequence)
        ...
        adb_EncryptionProperties_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_EncryptionProperties_t object and return the property value.
     ...
     #endif /* ADB_ENCRYPTIONPROPERTIES_H */
