 ...
 */
        ...
        #ifndef ADB_SIGNATUREPROPERTY_H
        #define ADB_SIGNATUREPROPERTY_H

       /**
        * adb_SignatureProperty.h
        *
        ...
        */
        ...
        typedef struct adb_SignatureProperty adb_SignatureProperty_t;
        ...
        /**
         * Constructor for creating adb_SignatureProperty_t
         * @param env pointer to environment struct
         * @return newly created adb_SignatureProperty_t object
         */
         ...
         * @param  _SignatureProperty adb_SignatureProperty_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_SignatureProperty_t object
         * @param  _SignatureProperty adb_SignatureProperty_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _SignatureProperty adb_SignatureProperty_t object
         * @param env pointer to environment struct
         * @return adb_SignaturePropertyType_t*
         */
         ...
         * @param  _SignatureProperty adb_SignatureProperty_t object
         * @param env pointer to environment struct
         * @param arg_SignatureProperty adb_SignaturePropertyType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_SignatureProperty_declare_parent_namespaces(
         ...
         * @param  _SignatureProperty adb_SignatureProperty_t object
         * @param env pointer to environment struct
         * @param SignatureProperty_om_node node to serialize from
         * @param SignatureProperty_om_element parent element to serialize from
        ...
        adb_SignatureProperty_serialize(
            adb_SignatureProperty_t* _SignatureProperty,
            const axutil_env_t *env,
            axiom_node_t* SignatureProperty_om_node, axiom_element_t *SignatureProperty_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SignatureProperty is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_SignatureProperty_t
         * @param env pointer to environment struct
         * @param _SignatureProperty adb_SignaturePropertyType_t*
         * @return newly created adb_SignatureProperty_t object
         */
        adb_SignatureProperty_t* AXIS2_CALL
        adb_SignatureProperty_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SignatureProperty_t object and return the property value.
