 ...
 */
        ...
        #ifndef ADB_UAKTYPE_H
        #define ADB_UAKTYPE_H
        ...
        */
        ...
        typedef struct adb_UAKType adb_UAKType_t;
        ...
        /**
         * Constructor for creating adb_UAKType_t
         * @param env pointer to environment struct
         * @return newly created adb_UAKType_t object
         */
         ...
         * @param  _UAKType adb_UAKType_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _UAKType adb_UAKType_t object
         * @param env pointer to environment struct
         ...
         * @param  _UAKType adb_UAKType_t object
         * @param env pointer to environment struct
         * @param arg_issuerID axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _UAKType adb_UAKType_t object
         * @param env pointer to environment struct
         * @param arg_collectionID axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_UAKType_declare_parent_namespaces(
         ...
         * @param  _UAKType adb_UAKType_t object
         * @param env pointer to environment struct
         * @param UAKType_om_node node to serialize from
         * @param UAKType_om_element parent element to serialize from
        ...
        adb_UAKType_serialize(
            adb_UAKType_t* _UAKType,
            const axutil_env_t *env,
            axiom_node_t* UAKType_om_node, axiom_element_t *UAKType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_UAKType is a particle class (E.g. group, inner sequence)
         ...
         * @param _issuerID axis2_char_t*
         * @param _collectionID axis2_char_t*
         * @return newly created adb_UAKType_t object
         */
        adb_UAKType_t* AXIS2_CALL
        adb_UAKType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_UAKType_t object and return the property value.
