 ...
 */
        ...
        #ifndef ADB_SERVICEATTRIBUTES_H
        #define ADB_SERVICEATTRIBUTES_H

       /**
        * adb_serviceAttributes.h
        *
        ...
        */
        ...
        typedef struct adb_serviceAttributes adb_serviceAttributes_t;
        ...
        /**
         * Constructor for creating adb_serviceAttributes_t
         * @param env pointer to environment struct
         * @return newly created adb_serviceAttributes_t object
         */
         ...
         * @param  _serviceAttributes adb_serviceAttributes_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_serviceAttributes_t object
         * @param  _serviceAttributes adb_serviceAttributes_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _serviceAttributes adb_serviceAttributes_t object
         * @param env pointer to environment struct
       ...
       adb_serviceAttributes_declare_parent_namespaces(
         ...
         * @param  _serviceAttributes adb_serviceAttributes_t object
         * @param env pointer to environment struct
         * @param serviceAttributes_om_node node to serialize from
         * @param serviceAttributes_om_element parent element to serialize from
        ...
        adb_serviceAttributes_serialize(
            adb_serviceAttributes_t* _serviceAttributes,
            const axutil_env_t *env,
            axiom_node_t* serviceAttributes_om_node, axiom_element_t *serviceAttributes_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_serviceAttributes is a particle class (E.g. group, inner sequence)
        ...
        adb_serviceAttributes_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_serviceAttributes_t object and return the property value.
