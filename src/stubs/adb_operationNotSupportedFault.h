 ...
 */
        ...
        #ifndef ADB_OPERATIONNOTSUPPORTEDFAULT_H
        #define ADB_OPERATIONNOTSUPPORTEDFAULT_H

       /**
        * adb_operationNotSupportedFault.h
        *
       ...
       /**
        *  adb_operationNotSupportedFault class
        */
        ...
        typedef struct adb_operationNotSupportedFault adb_operationNotSupportedFault_t;
        ...
        /**
         * Constructor for creating adb_operationNotSupportedFault_t
         * @param env pointer to environment struct
         * @return newly created adb_operationNotSupportedFault_t object
         */
         ...
         * @param  _operationNotSupportedFault adb_operationNotSupportedFault_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_operationNotSupportedFault_t object
         * @param  _operationNotSupportedFault adb_operationNotSupportedFault_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _operationNotSupportedFault adb_operationNotSupportedFault_t object
         * @param env pointer to environment struct
         * @return adb_operationNotSupportedFaultType_t*
         */
         ...
         * @param  _operationNotSupportedFault adb_operationNotSupportedFault_t object
         * @param env pointer to environment struct
         * @param arg_operationNotSupportedFault adb_operationNotSupportedFaultType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_operationNotSupportedFault_declare_parent_namespaces(
         ...
         * @param  _operationNotSupportedFault adb_operationNotSupportedFault_t object
         * @param env pointer to environment struct
         * @param operationNotSupportedFault_om_node node to serialize from
         * @param operationNotSupportedFault_om_element parent element to serialize from
        ...
        adb_operationNotSupportedFault_serialize(
            adb_operationNotSupportedFault_t* _operationNotSupportedFault,
            const axutil_env_t *env,
            axiom_node_t* operationNotSupportedFault_om_node, axiom_element_t *operationNotSupportedFault_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_operationNotSupportedFault is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_operationNotSupportedFault_t
         * @param env pointer to environment struct
         * @param _operationNotSupportedFault adb_operationNotSupportedFaultType_t*
         * @return newly created adb_operationNotSupportedFault_t object
         */
        adb_operationNotSupportedFault_t* AXIS2_CALL
        adb_operationNotSupportedFault_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_operationNotSupportedFault_t object and return the property value.
     ...
     #endif /* ADB_OPERATIONNOTSUPPORTEDFAULT_H */
