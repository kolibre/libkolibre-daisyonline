 ...
 */
        ...
        #ifndef ADB_RSAKEYVALUE_H
        #define ADB_RSAKEYVALUE_H
        ...
        */
        ...
        typedef struct adb_RSAKeyValue adb_RSAKeyValue_t;
        ...
        /**
         * Constructor for creating adb_RSAKeyValue_t
         * @param env pointer to environment struct
         * @return newly created adb_RSAKeyValue_t object
         */
         ...
         * @param  _RSAKeyValue adb_RSAKeyValue_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _RSAKeyValue adb_RSAKeyValue_t object
         * @param env pointer to environment struct
       ...
       adb_RSAKeyValue_declare_parent_namespaces(
         ...
         * @param  _RSAKeyValue adb_RSAKeyValue_t object
         * @param env pointer to environment struct
         * @param RSAKeyValue_om_node node to serialize from
         * @param RSAKeyValue_om_element parent element to serialize from
        ...
        adb_RSAKeyValue_serialize(
            adb_RSAKeyValue_t* _RSAKeyValue,
            const axutil_env_t *env,
            axiom_node_t* RSAKeyValue_om_node, axiom_element_t *RSAKeyValue_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_RSAKeyValue is a particle class (E.g. group, inner sequence)
        ...
        adb_RSAKeyValue_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_RSAKeyValue_t object and return the property value.
