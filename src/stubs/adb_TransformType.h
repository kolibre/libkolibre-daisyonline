 ...
 */
        ...
        #ifndef ADB_TRANSFORMTYPE_H
        #define ADB_TRANSFORMTYPE_H
        ...
        */
        ...
        typedef struct adb_TransformType adb_TransformType_t;
        ...
        /**
         * Constructor for creating adb_TransformType_t
         * @param env pointer to environment struct
         * @return newly created adb_TransformType_t object
         */
         ...
         * @param  _TransformType adb_TransformType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_TransformType_t object
         * @param  _TransformType adb_TransformType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for TransformTypeChoice. Deprecated for array types, Use adb_TransformType_get_TransformTypeChoice_at instead
         * @param  _TransformType adb_TransformType_t object
         * @param env pointer to environment struct
         * @return Array of adb_TransformTypeChoice_t*s.
         */
        ...
        /**
         * Setter for TransformTypeChoice.Deprecated for array types, Use adb_TransformType_set_TransformTypeChoice_at
         * or adb_TransformType_add_TransformTypeChoice instead.
         * @param  _TransformType adb_TransformType_t object
         * @param env pointer to environment struct
         * @param arg_TransformTypeChoice Array of adb_TransformTypeChoice_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of TransformTypeChoice.
         * @param  _TransformType adb_TransformType_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @return ith adb_TransformTypeChoice_t* of the array
         */
        ...
        /**
         * Set the ith element of TransformTypeChoice. (If the ith already exist, it will be replaced)
         * @param  _TransformType adb_TransformType_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_TransformTypeChoice element to set adb_TransformTypeChoice_t* to the array
         * @return ith adb_TransformTypeChoice_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _TransformType adb_TransformType_t object
         * @param env pointer to environment struct
         * @param arg_TransformTypeChoice element to add adb_TransformTypeChoice_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _TransformType adb_TransformType_t object
         * @param env pointer to environment struct.
         * @return the size of the TransformTypeChoice array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of TransformTypeChoice.
         * @param  _TransformType adb_TransformType_t object
         * @param env pointer to environment struct
         ...
         * @param  _TransformType _ adb_TransformType_t object
         * @param env pointer to environment struct.
       ...
       adb_TransformType_declare_parent_namespaces(
         ...
         * @param  _TransformType adb_TransformType_t object
         * @param env pointer to environment struct
         * @param TransformType_om_node node to serialize from
         * @param TransformType_om_element parent element to serialize from
        ...
        adb_TransformType_serialize(
            adb_TransformType_t* _TransformType,
            const axutil_env_t *env,
            axiom_node_t* TransformType_om_node, axiom_element_t *TransformType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_TransformType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_TransformType_t
         * @param env pointer to environment struct
         * @param _TransformTypeChoice axutil_array_list_t*
        ...
        adb_TransformType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_TransformType_t object and return the property value.
