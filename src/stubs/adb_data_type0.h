 ...
 */
        ...
        #ifndef ADB_DATA_TYPE0_H
        #define ADB_DATA_TYPE0_H
        ...
        */
        ...
        typedef struct adb_data_type0 adb_data_type0_t;
        ...
        /**
         * Constructor for creating adb_data_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_data_type0_t object
         */
         ...
         * @param  _data_type0 adb_data_type0_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _data_type0 adb_data_type0_t object
         * @param env pointer to environment struct
       ...
       adb_data_type0_declare_parent_namespaces(
         ...
         * @param  _data_type0 adb_data_type0_t object
         * @param env pointer to environment struct
         * @param data_type0_om_node node to serialize from
         * @param data_type0_om_element parent element to serialize from
        ...
        adb_data_type0_serialize(
            adb_data_type0_t* _data_type0,
            const axutil_env_t *env,
            axiom_node_t* data_type0_om_node, axiom_element_t *data_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_data_type0 is a particle class (E.g. group, inner sequence)
        ...
        adb_data_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_data_type0_t object and return the property value.
