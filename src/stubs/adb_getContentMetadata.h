 ...
 */
        ...
        #ifndef ADB_GETCONTENTMETADATA_H
        #define ADB_GETCONTENTMETADATA_H

       /**
        * adb_getContentMetadata.h
        *
        ...
        */
        ...
        typedef struct adb_getContentMetadata adb_getContentMetadata_t;
        ...
        /**
         * Constructor for creating adb_getContentMetadata_t
         * @param env pointer to environment struct
         * @return newly created adb_getContentMetadata_t object
         */
         ...
         * @param  _getContentMetadata adb_getContentMetadata_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getContentMetadata_t object
         * @param  _getContentMetadata adb_getContentMetadata_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getContentMetadata adb_getContentMetadata_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getContentMetadata_declare_parent_namespaces(
         ...
         * @param  _getContentMetadata adb_getContentMetadata_t object
         * @param env pointer to environment struct
         * @param getContentMetadata_om_node node to serialize from
         * @param getContentMetadata_om_element parent element to serialize from
        ...
        adb_getContentMetadata_serialize(
            adb_getContentMetadata_t* _getContentMetadata,
            const axutil_env_t *env,
            axiom_node_t* getContentMetadata_om_node, axiom_element_t *getContentMetadata_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getContentMetadata is a particle class (E.g. group, inner sequence)
        ...
        adb_getContentMetadata_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getContentMetadata_t object and return the property value.
     ...
     #endif /* ADB_GETCONTENTMETADATA_H */
