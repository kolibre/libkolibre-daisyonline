 ...
 */
        ...
        #ifndef ADB_QUESTIONS_H
        #define ADB_QUESTIONS_H
        ...
        */
        ...
        typedef struct adb_questions adb_questions_t;
        ...
        /**
         * Constructor for creating adb_questions_t
         * @param env pointer to environment struct
         * @return newly created adb_questions_t object
         */
         ...
         * @param  _questions adb_questions_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for questionsChoice_type0. Deprecated for array types, Use adb_questions_get_questionsChoice_type0_at instead
         * @param  _questions adb_questions_t object
         * @param env pointer to environment struct
         * @return Array of adb_questionsChoice_type0_t*s.
         */
        ...
        /**
         * Setter for questionsChoice_type0.Deprecated for array types, Use adb_questions_set_questionsChoice_type0_at
         * or adb_questions_add_questionsChoice_type0 instead.
         * @param  _questions adb_questions_t object
         * @param env pointer to environment struct
         * @param arg_questionsChoice_type0 Array of adb_questionsChoice_type0_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of questionsChoice_type0.
         * @param  _questions adb_questions_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @return ith adb_questionsChoice_type0_t* of the array
         */
        ...
        /**
         * Set the ith element of questionsChoice_type0. (If the ith already exist, it will be replaced)
         * @param  _questions adb_questions_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_questionsChoice_type0 element to set adb_questionsChoice_type0_t* to the array
         * @return ith adb_questionsChoice_type0_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _questions adb_questions_t object
         * @param env pointer to environment struct
         * @param arg_questionsChoice_type0 element to add adb_questionsChoice_type0_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _questions adb_questions_t object
         * @param env pointer to environment struct.
         * @return the size of the questionsChoice_type0 array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of questionsChoice_type0.
         * @param  _questions adb_questions_t object
         * @param env pointer to environment struct
         ...
         * @param  _questions _ adb_questions_t object
         * @param env pointer to environment struct.
       ...
       adb_questions_declare_parent_namespaces(
         ...
         * @param  _questions adb_questions_t object
         * @param env pointer to environment struct
         * @param questions_om_node node to serialize from
         * @param questions_om_element parent element to serialize from
        ...
        adb_questions_serialize(
            adb_questions_t* _questions,
            const axutil_env_t *env,
            axiom_node_t* questions_om_node, axiom_element_t *questions_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_questions is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_questions_t
         * @param env pointer to environment struct
         * @param _questionsChoice_type0 axutil_array_list_t*
        ...
        adb_questions_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_questions_t object and return the property value.
