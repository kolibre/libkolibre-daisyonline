 ...
 */
        ...
        #ifndef ADB_BOOKMARKSET_H
        #define ADB_BOOKMARKSET_H
        ...
        */
        ...
        typedef struct adb_bookmarkSet adb_bookmarkSet_t;
        ...
        /**
         * Constructor for creating adb_bookmarkSet_t
         * @param env pointer to environment struct
         * @return newly created adb_bookmarkSet_t object
         */
         ...
         * @param  _bookmarkSet adb_bookmarkSet_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for title. 
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct
        ...
        /**
         * Getter for bookmarkSetChoice_type0. Deprecated for array types, Use adb_bookmarkSet_get_bookmarkSetChoice_type0_at instead
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct
         * @return Array of adb_bookmarkSetChoice_type0_t*s.
         */
        ...
        /**
         * Setter for bookmarkSetChoice_type0.Deprecated for array types, Use adb_bookmarkSet_set_bookmarkSetChoice_type0_at
         * or adb_bookmarkSet_add_bookmarkSetChoice_type0 instead.
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct
         * @param arg_bookmarkSetChoice_type0 Array of adb_bookmarkSetChoice_type0_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of bookmarkSetChoice_type0.
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @return ith adb_bookmarkSetChoice_type0_t* of the array
         */
        ...
        /**
         * Set the ith element of bookmarkSetChoice_type0. (If the ith already exist, it will be replaced)
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_bookmarkSetChoice_type0 element to set adb_bookmarkSetChoice_type0_t* to the array
         * @return ith adb_bookmarkSetChoice_type0_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct
         * @param arg_bookmarkSetChoice_type0 element to add adb_bookmarkSetChoice_type0_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct.
         * @return the size of the bookmarkSetChoice_type0 array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of bookmarkSetChoice_type0.
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct
         ...
         * @param  _bookmarkSet _ adb_bookmarkSet_t object
         * @param env pointer to environment struct.
       ...
       adb_bookmarkSet_declare_parent_namespaces(
         ...
         * @param  _bookmarkSet adb_bookmarkSet_t object
         * @param env pointer to environment struct
         * @param bookmarkSet_om_node node to serialize from
         * @param bookmarkSet_om_element parent element to serialize from
        ...
        adb_bookmarkSet_serialize(
            adb_bookmarkSet_t* _bookmarkSet,
            const axutil_env_t *env,
            axiom_node_t* bookmarkSet_om_node, axiom_element_t *bookmarkSet_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_bookmarkSet is a particle class (E.g. group, inner sequence)
         ...
         * @param _bookmarkSetChoice_type0 axutil_array_list_t*
         * @return newly created adb_bookmarkSet_t object
         */
        adb_bookmarkSet_t* AXIS2_CALL
        adb_bookmarkSet_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_bookmarkSet_t object and return the property value.
