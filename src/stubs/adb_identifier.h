 ...
 */
        ...
        #ifndef ADB_IDENTIFIER_H
        #define ADB_IDENTIFIER_H
        ...
        */
        ...
        typedef struct adb_identifier adb_identifier_t;
        ...
        /**
         * Constructor for creating adb_identifier_t
         * @param env pointer to environment struct
         * @return newly created adb_identifier_t object
         */
         ...
         * @param  _identifier adb_identifier_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _identifier adb_identifier_t object
         * @param env pointer to environment struct
         * @return axiom_node_t*
         */
       ...
       adb_identifier_declare_parent_namespaces(
         ...
         * @param  _identifier adb_identifier_t object
         * @param env pointer to environment struct
         * @param identifier_om_node node to serialize from
         * @param identifier_om_element parent element to serialize from
        ...
        adb_identifier_serialize(
            adb_identifier_t* _identifier,
            const axutil_env_t *env,
            axiom_node_t* identifier_om_node, axiom_element_t *identifier_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_identifier is a particle class (E.g. group, inner sequence)
        ...
        adb_identifier_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_identifier_t object and return the property value.
