 ...
 */
        ...
        #ifndef ADB_CONTENTITEM_TYPE0_H
        #define ADB_CONTENTITEM_TYPE0_H

       /**
        * adb_contentItem_type0.h
        *
        ...
        */
        ...
        typedef struct adb_contentItem_type0 adb_contentItem_type0_t;
        ...
        /**
         * Constructor for creating adb_contentItem_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_contentItem_type0_t object
         */
         ...
         * @param  _contentItem_type0 adb_contentItem_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_contentItem_type0_t object
         * @param  _contentItem_type0 adb_contentItem_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for label. 
         * @param  _contentItem_type0 adb_contentItem_type0_t object
         * @param env pointer to environment struct
       ...
       adb_contentItem_type0_declare_parent_namespaces(
         ...
         * @param  _contentItem_type0 adb_contentItem_type0_t object
         * @param env pointer to environment struct
         * @param contentItem_type0_om_node node to serialize from
         * @param contentItem_type0_om_element parent element to serialize from
        ...
        adb_contentItem_type0_serialize(
            adb_contentItem_type0_t* _contentItem_type0,
            const axutil_env_t *env,
            axiom_node_t* contentItem_type0_om_node, axiom_element_t *contentItem_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_contentItem_type0 is a particle class (E.g. group, inner sequence)
        ...
        adb_contentItem_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_contentItem_type0_t object and return the property value.
