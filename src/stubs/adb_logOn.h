 ...
 */
        ...
        */
        ...
        typedef struct adb_logOn adb_logOn_t;
        ...
        /**
         * Constructor for creating adb_logOn_t
         * @param env pointer to environment struct
         * @return newly created adb_logOn_t object
         */
         ...
         * @param  _logOn adb_logOn_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for username. 
         * @param  _logOn adb_logOn_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_logOn_declare_parent_namespaces(
        ...
        /**
         * Check whether the adb_logOn is a particle class (E.g. group, inner sequence)
        ...
        adb_logOn_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_logOn_t object and return the property value.
