 ...
 */
        ...
        #ifndef ADB_OPERATION_TYPE1_H
        #define ADB_OPERATION_TYPE1_H

       /**
        * adb_operation_type1.h
        *
        ...
        */
        ...
        typedef struct adb_operation_type1 adb_operation_type1_t;
        ...
        /**
         * Constructor for creating adb_operation_type1_t
         * @param env pointer to environment struct
         * @return newly created adb_operation_type1_t object
         */
         ...
         * @param  _operation_type1 adb_operation_type1_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_operation_type1_t object
         * @param  _operation_type1 adb_operation_type1_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _operation_type1 adb_operation_type1_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_operation_type1_declare_parent_namespaces(
         ...
         * @param  _operation_type1 adb_operation_type1_t object
         * @param env pointer to environment struct
         * @param operation_type1_om_node node to serialize from
         * @param operation_type1_om_element parent element to serialize from
        ...
        adb_operation_type1_serialize(
            adb_operation_type1_t* _operation_type1,
            const axutil_env_t *env,
            axiom_node_t* operation_type1_om_node, axiom_element_t *operation_type1_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_operation_type1 is a particle class (E.g. group, inner sequence)
        ...
        adb_operation_type1_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_operation_type1_t object and return the property value.
