 ...
 */
        ...
        #ifndef ADB_SIGNATUREVALUETYPE_H
        #define ADB_SIGNATUREVALUETYPE_H

       /**
        * adb_SignatureValueType.h
        *
        ...
        */
        ...
        typedef struct adb_SignatureValueType adb_SignatureValueType_t;
        ...
        /**
         * Constructor for creating adb_SignatureValueType_t
         * @param env pointer to environment struct
         * @return newly created adb_SignatureValueType_t object
         */
         ...
         * @param  _SignatureValueType adb_SignatureValueType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_SignatureValueType_t object
         * @param  _SignatureValueType adb_SignatureValueType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _SignatureValueType adb_SignatureValueType_t object
         * @param env pointer to environment struct
         ...
         * @param  _SignatureValueType adb_SignatureValueType_t object
         * @param env pointer to environment struct
         * @param arg_base64Binary axutil_base64_binary_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_SignatureValueType_declare_parent_namespaces(
         ...
         * @param  _SignatureValueType adb_SignatureValueType_t object
         * @param env pointer to environment struct
         * @param SignatureValueType_om_node node to serialize from
         * @param SignatureValueType_om_element parent element to serialize from
        ...
        adb_SignatureValueType_serialize(
            adb_SignatureValueType_t* _SignatureValueType,
            const axutil_env_t *env,
            axiom_node_t* SignatureValueType_om_node, axiom_element_t *SignatureValueType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SignatureValueType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_SignatureValueType_t
         * @param env pointer to environment struct
         * @param _base64Binary axutil_base64_binary_t*
        ...
        adb_SignatureValueType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SignatureValueType_t object and return the property value.
     ...
     #endif /* ADB_SIGNATUREVALUETYPE_H */
