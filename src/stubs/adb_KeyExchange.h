 ...
 */
        ...
        #ifndef ADB_KEYEXCHANGE_H
        #define ADB_KEYEXCHANGE_H
        ...
        */
        ...
        typedef struct adb_KeyExchange adb_KeyExchange_t;
        ...
        /**
         * Constructor for creating adb_KeyExchange_t
         * @param env pointer to environment struct
         * @return newly created adb_KeyExchange_t object
         */
         ...
         * @param  _KeyExchange adb_KeyExchange_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for Issuer. 
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct
        ...
        /**
         * Getter for KeyExchangeChoice_type0. Deprecated for array types, Use adb_KeyExchange_get_KeyExchangeChoice_type0_at instead
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct
         * @return Array of adb_KeyExchangeChoice_type0_t*s.
         */
        ...
        /**
         * Setter for KeyExchangeChoice_type0.Deprecated for array types, Use adb_KeyExchange_set_KeyExchangeChoice_type0_at
         * or adb_KeyExchange_add_KeyExchangeChoice_type0 instead.
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct
         * @param arg_KeyExchangeChoice_type0 Array of adb_KeyExchangeChoice_type0_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of KeyExchangeChoice_type0.
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @return ith adb_KeyExchangeChoice_type0_t* of the array
         */
        ...
        /**
         * Set the ith element of KeyExchangeChoice_type0. (If the ith already exist, it will be replaced)
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_KeyExchangeChoice_type0 element to set adb_KeyExchangeChoice_type0_t* to the array
         * @return ith adb_KeyExchangeChoice_type0_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct
         * @param arg_KeyExchangeChoice_type0 element to add adb_KeyExchangeChoice_type0_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct.
         * @return the size of the KeyExchangeChoice_type0 array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of KeyExchangeChoice_type0.
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct
         ...
         * @param  _KeyExchange _ adb_KeyExchange_t object
         * @param env pointer to environment struct.
       ...
       adb_KeyExchange_declare_parent_namespaces(
         ...
         * @param  _KeyExchange adb_KeyExchange_t object
         * @param env pointer to environment struct
         * @param KeyExchange_om_node node to serialize from
         * @param KeyExchange_om_element parent element to serialize from
        ...
        adb_KeyExchange_serialize(
            adb_KeyExchange_t* _KeyExchange,
            const axutil_env_t *env,
            axiom_node_t* KeyExchange_om_node, axiom_element_t *KeyExchange_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_KeyExchange is a particle class (E.g. group, inner sequence)
         ...
         * @param _KeyExchangeChoice_type0 axutil_array_list_t*
         * @return newly created adb_KeyExchange_t object
         */
        adb_KeyExchange_t* AXIS2_CALL
        adb_KeyExchange_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_KeyExchange_t object and return the property value.
