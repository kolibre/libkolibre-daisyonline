 ...
 */
        ...
        #ifndef ADB_PGPDATATYPESEQUENCE_TYPE1_H
        #define ADB_PGPDATATYPESEQUENCE_TYPE1_H

       /**
        * adb_PGPDataTypeSequence_type1.h
        *
       ...
       /**
        *  adb_PGPDataTypeSequence_type1 class
        */
        ...
        typedef struct adb_PGPDataTypeSequence_type1 adb_PGPDataTypeSequence_type1_t;
        ...
        /**
         * Constructor for creating adb_PGPDataTypeSequence_type1_t
         * @param env pointer to environment struct
         * @return newly created adb_PGPDataTypeSequence_type1_t object
         */
         ...
         * @param  _PGPDataTypeSequence_type1 adb_PGPDataTypeSequence_type1_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_PGPDataTypeSequence_type1_t object
         * @param  _PGPDataTypeSequence_type1 adb_PGPDataTypeSequence_type1_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _PGPDataTypeSequence_type1 adb_PGPDataTypeSequence_type1_t object
         * @param env pointer to environment struct
        ...
        /**
         * Getter for extraElement. Deprecated for array types, Use adb_PGPDataTypeSequence_type1_get_extraElement_at instead
         * @param  _PGPDataTypeSequence_type1 adb_PGPDataTypeSequence_type1_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for extraElement.Deprecated for array types, Use adb_PGPDataTypeSequence_type1_set_extraElement_at
         * or adb_PGPDataTypeSequence_type1_add_extraElement instead.
         * @param  _PGPDataTypeSequence_type1 adb_PGPDataTypeSequence_type1_t object
         * @param env pointer to environment struct
         ...
         * @param  _PGPDataTypeSequence_type1 _ adb_PGPDataTypeSequence_type1_t object
         * @param env pointer to environment struct.
       ...
       adb_PGPDataTypeSequence_type1_declare_parent_namespaces(
         ...
         * @param  _PGPDataTypeSequence_type1 adb_PGPDataTypeSequence_type1_t object
         * @param env pointer to environment struct
         * @param PGPDataTypeSequence_type1_om_node node to serialize from
         * @param PGPDataTypeSequence_type1_om_element parent element to serialize from
        ...
        adb_PGPDataTypeSequence_type1_serialize(
            adb_PGPDataTypeSequence_type1_t* _PGPDataTypeSequence_type1,
            const axutil_env_t *env,
            axiom_node_t* PGPDataTypeSequence_type1_om_node, axiom_element_t *PGPDataTypeSequence_type1_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_PGPDataTypeSequence_type1 is a particle class (E.g. group, inner sequence)
        ...
        adb_PGPDataTypeSequence_type1_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_PGPDataTypeSequence_type1_t object and return the property value.
     ...
     #endif /* ADB_PGPDATATYPESEQUENCE_TYPE1_H */
