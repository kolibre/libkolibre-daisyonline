 ...
 */
        ...
        #ifndef ADB_TRANSFORMTYPECHOICE_H
        #define ADB_TRANSFORMTYPECHOICE_H

       /**
        * adb_TransformTypeChoice.h
        *
        ...
        */
        ...
        typedef struct adb_TransformTypeChoice adb_TransformTypeChoice_t;
        ...
        /**
         * Constructor for creating adb_TransformTypeChoice_t
         * @param env pointer to environment struct
         * @return newly created adb_TransformTypeChoice_t object
         */
         ...
         * @param  _TransformTypeChoice adb_TransformTypeChoice_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_TransformTypeChoice_t object
         * @param  _TransformTypeChoice adb_TransformTypeChoice_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _TransformTypeChoice adb_TransformTypeChoice_t object
         * @param env pointer to environment struct
         * @return axiom_node_t*
         */
       ...
       adb_TransformTypeChoice_declare_parent_namespaces(
         ...
         * @param  _TransformTypeChoice adb_TransformTypeChoice_t object
         * @param env pointer to environment struct
         * @param TransformTypeChoice_om_node node to serialize from
         * @param TransformTypeChoice_om_element parent element to serialize from
        ...
        adb_TransformTypeChoice_serialize(
            adb_TransformTypeChoice_t* _TransformTypeChoice,
            const axutil_env_t *env,
            axiom_node_t* TransformTypeChoice_om_node, axiom_element_t *TransformTypeChoice_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_TransformTypeChoice is a particle class (E.g. group, inner sequence)
        ...
        adb_TransformTypeChoice_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_TransformTypeChoice_t object and return the property value.
     ...
     #endif /* ADB_TRANSFORMTYPECHOICE_H */
