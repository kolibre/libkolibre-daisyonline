 ...
 */
        ...
        #ifndef ADB_GETCONTENTLISTRESPONSE_H
        #define ADB_GETCONTENTLISTRESPONSE_H

       /**
        * adb_getContentListResponse.h
        *
       ...
       /**
        *  adb_getContentListResponse class
        */
        ...
        typedef struct adb_getContentListResponse adb_getContentListResponse_t;
        ...
        /**
         * Constructor for creating adb_getContentListResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_getContentListResponse_t object
         */
         ...
         * @param  _getContentListResponse adb_getContentListResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getContentListResponse_t object
         * @param  _getContentListResponse adb_getContentListResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getContentListResponse adb_getContentListResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _getContentListResponse adb_getContentListResponse_t object
         * @param env pointer to environment struct
         * @param arg_contentList adb_contentList_type0_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getContentListResponse_declare_parent_namespaces(
         ...
         * @param  _getContentListResponse adb_getContentListResponse_t object
         * @param env pointer to environment struct
         * @param getContentListResponse_om_node node to serialize from
         * @param getContentListResponse_om_element parent element to serialize from
        ...
        adb_getContentListResponse_serialize(
            adb_getContentListResponse_t* _getContentListResponse,
            const axutil_env_t *env,
            axiom_node_t* getContentListResponse_om_node, axiom_element_t *getContentListResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getContentListResponse is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_getContentListResponse_t
         * @param env pointer to environment struct
         * @param _contentList adb_contentList_type0_t*
         * @return newly created adb_getContentListResponse_t object
         */
        adb_getContentListResponse_t* AXIS2_CALL
        adb_getContentListResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getContentListResponse_t object and return the property value.
     ...
     #endif /* ADB_GETCONTENTLISTRESPONSE_H */
