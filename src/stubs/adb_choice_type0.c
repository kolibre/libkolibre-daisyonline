 ...
 */
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_choice_type0_set_label_nil(
                        adb_choice_type0_t* _choice_type0,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_choice_type0_set_id_nil(
                        adb_choice_type0_t* _choice_type0,
                        const axutil_env_t *env);
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_choice_type0_create(
            const axutil_env_t *env)
        {
            adb_choice_type0_t *_choice_type0 = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _choice_type0 = (adb_choice_type0_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_choice_type0_t));

            if(NULL == _choice_type0)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_choice_type0, 0, sizeof(adb_choice_type0_t));

            _choice_type0->property_TypeName = axutil_strdup(env, "adb_choice_type0");
            _choice_type0->property_label  = NULL;
                  _choice_type0->is_valid_label  = AXIS2_FALSE;
            _choice_type0->property_id  = NULL;
                  _choice_type0->is_valid_id  = AXIS2_FALSE;
            

            return _choice_type0;
        }
        ...
        adb_choice_type0_create_with_values(
            const axutil_env_t *env,
                ...
                axis2_char_t* _id)
        {
            adb_choice_type0_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_choice_type0_create(env);

            
              status = adb_choice_type0_set_label(
                                     adb_obj,
                                     env,
                                     _label);
              if(status == AXIS2_FAILURE) {
                  adb_choice_type0_free (adb_obj, env);
                  return NULL;
              }
            
              status = adb_choice_type0_set_id(
                                     adb_obj,
                                     env,
                                     _id);
              if(status == AXIS2_FAILURE) {
        ...
        adb_label_type0_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _choice_type0->property_label;

                    _choice_type0->property_label = (adb_label_type0_t*)NULL;
                    adb_choice_type0_free(_choice_type0, env);
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _choice_type0, AXIS2_FAILURE);

            if (_choice_type0->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _choice_type0->property_TypeName);
            }

            adb_choice_type0_reset_label(_choice_type0, env);
            adb_choice_type0_reset_id(_choice_type0, env);
            

            if(_choice_type0)
            {
                AXIS2_FREE(env->allocator, _choice_type0);
                _choice_type0 = NULL;
            }
            ...
            AXIS2_PARAM_CHECK(env->error, _choice_type0, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                            "Failed in building adb object for choice_type0 : "
                ...
                return AXIS2_FAILURE;
                 ...
                 attribute_hash = axiom_element_get_all_attributes(parent_element, env);
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_choice_type0_set_label(_choice_type0, env,
                  ...
                  if(attrib_text != NULL)
                  {
                      ...
                      adb_choice_type0_set_id(_choice_type0,
                                                          env, attrib_text);
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            ...
            if (_choice_type0 == NULL)
            {
                return adb_choice_type0_serialize_obj(
                    _choice_type0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            }
            else
            {
                return axis2_extension_mapper_serialize(
                    (adb_stubtype_t*) _choice_type0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index, "adb_choice_type0");
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axis2_char_t* type_attrib = NULL;
            ...
            adb_choice_type0_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_choice_type0_get_label(_choice_type0,
                                             env);
            }
            ...
            adb_choice_type0_get_label(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _choice_type0->property_label;
             }
            ...
            adb_choice_type0_set_label(
                    ...
                    adb_label_type0_t*  arg_label)
             {
                ...
                if(_choice_type0->is_valid_label &&
                        arg_label == _choice_type0->property_label)
                {
                ...
                _choice_type0->property_label = arg_label;
                        _choice_type0->is_valid_label = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _choice_type0, AXIS2_FAILURE);
                ...
                if(_choice_type0->property_label != NULL)
                {
                   
                   adb_label_type0_free(_choice_type0->property_label, env);
                     _choice_type0->property_label = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _choice_type0, AXIS2_TRUE);
               
               return !_choice_type0->is_valid_label;
           }
           ...
           adb_choice_type0_set_label_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_choice_type0_reset_label(_choice_type0, env);
           }
            ...
            adb_choice_type0_get_property2(
                ...
                const axutil_env_t *env)
            {
                return adb_choice_type0_get_id(_choice_type0,
                                             env);
            }
            ...
            adb_choice_type0_get_id(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _choice_type0->property_id;
             }
            ...
            adb_choice_type0_set_id(
                    ...
                    const axis2_char_t*  arg_id)
             {
                ...
                if(_choice_type0->is_valid_id &&
                        arg_id == _choice_type0->property_id)
                {
                ...
                _choice_type0->property_id = (axis2_char_t *)axutil_strdup(env, arg_id);
                        if(NULL == _choice_type0->property_id)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for id");
                            return AXIS2_FAILURE;
                        }
                        _choice_type0->is_valid_id = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _choice_type0, AXIS2_FAILURE);
                ...
                if(_choice_type0->property_id != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _choice_type0->property_id);
                     _choice_type0->property_id = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_choice_type0->is_valid_id;
           }
           ...
           adb_choice_type0_set_id_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_choice_type0_reset_id(_choice_type0, env);
           }
