 ...
 */
        ...
        #ifndef ADB_SIGNEDINFO_H
        #define ADB_SIGNEDINFO_H
        ...
        */
        ...
        typedef struct adb_SignedInfo adb_SignedInfo_t;
        ...
        /**
         * Constructor for creating adb_SignedInfo_t
         * @param env pointer to environment struct
         * @return newly created adb_SignedInfo_t object
         */
         ...
         * @param  _SignedInfo adb_SignedInfo_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _SignedInfo adb_SignedInfo_t object
         * @param env pointer to environment struct
       ...
       adb_SignedInfo_declare_parent_namespaces(
         ...
         * @param  _SignedInfo adb_SignedInfo_t object
         * @param env pointer to environment struct
         * @param SignedInfo_om_node node to serialize from
         * @param SignedInfo_om_element parent element to serialize from
        ...
        adb_SignedInfo_serialize(
            adb_SignedInfo_t* _SignedInfo,
            const axutil_env_t *env,
            axiom_node_t* SignedInfo_om_node, axiom_element_t *SignedInfo_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SignedInfo is a particle class (E.g. group, inner sequence)
        ...
        adb_SignedInfo_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SignedInfo_t object and return the property value.
