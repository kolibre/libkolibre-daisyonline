 ...
 */
        ...
        #ifndef ADB_IDSTRING_H
        #define ADB_IDSTRING_H
        ...
        */
        ...
        typedef struct adb_IdString adb_IdString_t;
        ...
        /**
         * Constructor for creating adb_IdString_t
         * @param env pointer to environment struct
         * @return newly created adb_IdString_t object
         */
         ...
         * @param  _IdString adb_IdString_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for IdString. 
         * @param  _IdString adb_IdString_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _IdString adb_IdString_t object
         * @param env pointer to environment struct
         * @param arg_IdString axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_IdString_declare_parent_namespaces(
         ...
         * @param  _IdString adb_IdString_t object
         * @param env pointer to environment struct
         * @param IdString_om_node node to serialize from
         * @param IdString_om_element parent element to serialize from
        ...
        adb_IdString_serialize(
            adb_IdString_t* _IdString,
            const axutil_env_t *env,
            axiom_node_t* IdString_om_node, axiom_element_t *IdString_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_IdString is a particle class (E.g. group, inner sequence)
        ...
        adb_IdString_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_IdString_t object and return the property value.
