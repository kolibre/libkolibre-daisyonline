 ...
 */
        ...
        */
        ...
        typedef struct adb_audio adb_audio_t;
        ...
        /**
         * Constructor for creating adb_audio_t
         * @param env pointer to environment struct
         * @return newly created adb_audio_t object
         */
         ...
         * @param  _audio adb_audio_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for audio. 
         * @param  _audio adb_audio_t object
         * @param env pointer to environment struct
       ...
       adb_audio_declare_parent_namespaces(
         ...
         * @param  _audio adb_audio_t object
         * @param env pointer to environment struct
         * @param audio_om_node node to serialize from
         * @param audio_om_element parent element to serialize from
        ...
        adb_audio_serialize(
            adb_audio_t* _audio,
            const axutil_env_t *env,
            axiom_node_t* audio_om_node, axiom_element_t *audio_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_audio is a particle class (E.g. group, inner sequence)
        ...
        adb_audio_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_audio_t object and return the property value.
