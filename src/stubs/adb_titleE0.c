 ...
 */
        ...
        #include "adb_titleE0.h"
        
               /*
                * implmentation of the title|http://www.daisy.org/z3986/2005/bookmark/ element
                */
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_titleE0_create(
            const axutil_env_t *env)
        {
            adb_titleE0_t *_titleE0 = NULL;
            
                axutil_qname_t* qname = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _titleE0 = (adb_titleE0_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_titleE0_t));
            ...
            memset(_titleE0, 0, sizeof(adb_titleE0_t));

            _titleE0->property_TypeName = axutil_strdup(env, "adb_titleE0");
            _titleE0->property_title  = NULL;
                  _titleE0->is_valid_title  = AXIS2_FALSE;
            
                  qname =  axutil_qname_create (env,
                        "title",
                        "http://www.daisy.org/z3986/2005/bookmark/",
                        NULL);
                _titleE0->qname = qname;
        ...
        {
            adb_titleE0_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_titleE0_create(env);

            
              status = adb_titleE0_set_title(
                                     adb_obj,
                                     env,
                                     _title);
              if(status == AXIS2_FAILURE) {
                  adb_titleE0_free (adb_obj, env);
                  return NULL;
              }
        ...
        adb_title_type0_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _titleE0->property_title;

                    _titleE0->property_title = (adb_title_type0_t*)NULL;
                    adb_titleE0_free(_titleE0, env);
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _titleE0, AXIS2_FAILURE);

            if (_titleE0->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _titleE0->property_TypeName);
            }

            adb_titleE0_reset_title(_titleE0, env);
            
              if(_titleE0->qname)
              {
                  axutil_qname_free (_titleE0->qname, env);
                  _titleE0->qname = NULL;
              }
            ...
            if(_titleE0)
            {
                AXIS2_FREE(env->allocator, _titleE0);
                _titleE0 = NULL;
            }
                ...
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            return adb_titleE0_deserialize_obj(
                _titleE0,
                env,
                dp_parent,
            ...
            AXIS2_PARAM_CHECK(env->error, _titleE0, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                return AXIS2_FAILURE;
                    ...
                    if (axutil_qname_equals(qname, env, _titleE0-> qname))
                    {
                    ...
                    else
                    {
                        AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                              ...
                              axutil_qname_to_string(_titleE0-> qname, env),
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_titleE0_set_title(_titleE0, env,
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
                ...
                return adb_titleE0_serialize_obj(
                    _titleE0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axiom_attribute_t* xsi_type_attri = NULL;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _titleE0, NULL);
                   ...
                   else
                   {
                    ...
                    adb_title_type0_serialize(_titleE0->property_title, 
                                                                                 env, current_node, parent_element,
                                                                                 adb_title_type0_is_particle() || AXIS2_TRUE, namespaces, next_ns_index);
            ...
            adb_titleE0_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_titleE0_get_title(_titleE0,
                                             env);
            }
            ...
            adb_titleE0_get_title(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _titleE0->property_title;
             }
            ...
            adb_titleE0_set_title(
                    ...
                    adb_title_type0_t*  arg_title)
             {
                ...
                if(_titleE0->is_valid_title &&
                        arg_title == _titleE0->property_title)
                {
                ...
                _titleE0->property_title = arg_title;
                        _titleE0->is_valid_title = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _titleE0, AXIS2_FAILURE);
                ...
                if(_titleE0->property_title != NULL)
                {
                   
                   adb_title_type0_free(_titleE0->property_title, env);
                     _titleE0->property_title = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _titleE0, AXIS2_TRUE);
               
               return !_titleE0->is_valid_title;
           }
           ...
           adb_titleE0_set_title_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_titleE0_reset_title(_titleE0, env);
           }
