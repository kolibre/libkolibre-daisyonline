 ...
 */
        ...
        #ifndef ADB_QUESTIONSCHOICE_TYPE1_H
        #define ADB_QUESTIONSCHOICE_TYPE1_H

       /**
        * adb_questionsChoice_type1.h
        *
       ...
       /**
        *  adb_questionsChoice_type1 class
        */
        ...
        typedef struct adb_questionsChoice_type1 adb_questionsChoice_type1_t;
        ...
        /**
         * Constructor for creating adb_questionsChoice_type1_t
         * @param env pointer to environment struct
         * @return newly created adb_questionsChoice_type1_t object
         */
         ...
         * @param  _questionsChoice_type1 adb_questionsChoice_type1_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_questionsChoice_type1_t object
         * @param  _questionsChoice_type1 adb_questionsChoice_type1_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _questionsChoice_type1 adb_questionsChoice_type1_t object
         * @param env pointer to environment struct
       ...
       adb_questionsChoice_type1_declare_parent_namespaces(
         ...
         * @param  _questionsChoice_type1 adb_questionsChoice_type1_t object
         * @param env pointer to environment struct
         * @param questionsChoice_type1_om_node node to serialize from
         * @param questionsChoice_type1_om_element parent element to serialize from
        ...
        adb_questionsChoice_type1_serialize(
            adb_questionsChoice_type1_t* _questionsChoice_type1,
            const axutil_env_t *env,
            axiom_node_t* questionsChoice_type1_om_node, axiom_element_t *questionsChoice_type1_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_questionsChoice_type1 is a particle class (E.g. group, inner sequence)
        ...
        adb_questionsChoice_type1_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_questionsChoice_type1_t object and return the property value.
     ...
     #endif /* ADB_QUESTIONSCHOICE_TYPE1_H */
