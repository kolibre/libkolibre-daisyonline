 ...
 */
        ...
        /**
         * adb_additionalTransferProtocols_type0.c
         *
        ...
        #include "adb_additionalTransferProtocols_type0.h"
                 ...
                 * name = additionalTransferProtocols_type0
        ...
        struct adb_additionalTransferProtocols_type0
        {
            axis2_char_t *property_TypeName;

            axutil_array_list_t* property_protocol;
       ...
       /************************* Private Function prototypes ********************************/
                 ...
                 adb_additionalTransferProtocols_type0_set_protocol_nil_at(
                        adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0, 
                        const axutil_env_t *env, int i);
                

                axis2_status_t AXIS2_CALL
                adb_additionalTransferProtocols_type0_set_protocol_nil(
                        adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_additionalTransferProtocols_type0_create(
            const axutil_env_t *env)
        {
            adb_additionalTransferProtocols_type0_t *_additionalTransferProtocols_type0 = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _additionalTransferProtocols_type0 = (adb_additionalTransferProtocols_type0_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_additionalTransferProtocols_type0_t));

            if(NULL == _additionalTransferProtocols_type0)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_additionalTransferProtocols_type0, 0, sizeof(adb_additionalTransferProtocols_type0_t));

            _additionalTransferProtocols_type0->property_TypeName = axutil_strdup(env, "adb_additionalTransferProtocols_type0");
            _additionalTransferProtocols_type0->property_protocol  = NULL;
                  _additionalTransferProtocols_type0->is_valid_protocol  = AXIS2_FALSE;
            

            return _additionalTransferProtocols_type0;
        }

        adb_additionalTransferProtocols_type0_t* AXIS2_CALL
        adb_additionalTransferProtocols_type0_create_with_values(
            const axutil_env_t *env,
                axutil_array_list_t* _protocol)
        {
            adb_additionalTransferProtocols_type0_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_additionalTransferProtocols_type0_create(env);

            
              status = adb_additionalTransferProtocols_type0_set_protocol(
                                     adb_obj,
                                     env,
                                     _protocol);
              if(status == AXIS2_FAILURE) {
                  adb_additionalTransferProtocols_type0_free (adb_obj, env);
                  return NULL;
              }
        ...
        axutil_array_list_t* AXIS2_CALL
                adb_additionalTransferProtocols_type0_free_popping_value(
                        adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                        const axutil_env_t *env)
                {
                    ...
                    value = _additionalTransferProtocols_type0->property_protocol;

                    _additionalTransferProtocols_type0->property_protocol = (axutil_array_list_t*)NULL;
                    adb_additionalTransferProtocols_type0_free(_additionalTransferProtocols_type0, env);
        ...
        axis2_status_t AXIS2_CALL
        adb_additionalTransferProtocols_type0_free_obj(
                adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                const axutil_env_t *env)
        {
            ...
            if (_additionalTransferProtocols_type0->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _additionalTransferProtocols_type0->property_TypeName);
            }

            adb_additionalTransferProtocols_type0_reset_protocol(_additionalTransferProtocols_type0, env);
            

            if(_additionalTransferProtocols_type0)
            {
                AXIS2_FREE(env->allocator, _additionalTransferProtocols_type0);
                _additionalTransferProtocols_type0 = NULL;
            }
        ...
        axis2_status_t AXIS2_CALL
        adb_additionalTransferProtocols_type0_deserialize(
                adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                const axutil_env_t *env,
                ...
                axis2_bool_t dont_care_minoccurs)
        {
          ...
          adb_additionalTransferProtocols_type0_is_particle()
          {
          ...
          void AXIS2_CALL
          adb_additionalTransferProtocols_type0_declare_parent_namespaces(
                    adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
        ...
        adb_additionalTransferProtocols_type0_serialize(
                adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            
            
            if (_additionalTransferProtocols_type0 == NULL)
            {
                return adb_additionalTransferProtocols_type0_serialize_obj(
                    _additionalTransferProtocols_type0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            }
            else
            {
                return axis2_extension_mapper_serialize(
                    (adb_stubtype_t*) _additionalTransferProtocols_type0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index, "adb_additionalTransferProtocols_type0");
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axis2_char_t* type_attrib = NULL;
            ...
            /**
             * Getter for protocol by  Property Number 1
             */
            axutil_array_list_t* AXIS2_CALL
            adb_additionalTransferProtocols_type0_get_property1(
                adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                const axutil_env_t *env)
            {
                return adb_additionalTransferProtocols_type0_get_protocol(_additionalTransferProtocols_type0,
                                             env);
            }
             ...
             */
            axutil_array_list_t* AXIS2_CALL
            adb_additionalTransferProtocols_type0_get_protocol(
                    adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                    const axutil_env_t *env)
             {
                ...
                return _additionalTransferProtocols_type0->property_protocol;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_additionalTransferProtocols_type0_set_protocol(
                    adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                    const axutil_env_t *env,
                    axutil_array_list_t*  arg_protocol)
             {
                ...
                if(_additionalTransferProtocols_type0->is_valid_protocol &&
                        arg_protocol == _additionalTransferProtocols_type0->property_protocol)
                {
                 ...
                 size = axutil_array_list_size(arg_protocol, env);
                 
                 if (size < 1)
                 {
                     AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "protocol has less than minOccurs(1)");
                     return AXIS2_FAILURE;
                 }
                 for(i = 0; i < size; i ++ )
                 {
                     if(NULL != axutil_array_list_get(arg_protocol, env, i))
                     {
                ...
                _additionalTransferProtocols_type0->property_protocol = arg_protocol;
                        if(non_nil_exists)
                        {
            ...
            /**
             * Get ith element of protocol.
             */
            axis2_char_t* AXIS2_CALL
            adb_additionalTransferProtocols_type0_get_protocol_at(
                    adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                    const axutil_env_t *env, int i)
            {
                ...
                ret_val = (axis2_char_t*)axutil_array_list_get(_additionalTransferProtocols_type0->property_protocol, env, i);
             ...
             */
            int AXIS2_CALL
            adb_additionalTransferProtocols_type0_sizeof_protocol(
                    adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                    const axutil_env_t *env)
            {
                AXIS2_ENV_CHECK(env, -1);
                AXIS2_PARAM_CHECK(env->error, _additionalTransferProtocols_type0, -1);
                if(_additionalTransferProtocols_type0->property_protocol == NULL)
                {
                    return 0;
                }
                return axutil_array_list_size(_additionalTransferProtocols_type0->property_protocol, env);
            }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_additionalTransferProtocols_type0_remove_protocol_at(
                    adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                    const axutil_env_t *env, int i)
            {
                return adb_additionalTransferProtocols_type0_set_protocol_nil_at(_additionalTransferProtocols_type0, env, i);
            }
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_additionalTransferProtocols_type0_reset_protocol(
                   adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _additionalTransferProtocols_type0, AXIS2_FAILURE);
                ...
                if(element != NULL)
                {
                     ...
                     element = NULL;
                      ...
                      axutil_array_list_free(_additionalTransferProtocols_type0->property_protocol, env);
                  }
                _additionalTransferProtocols_type0->is_valid_protocol = AXIS2_FALSE; 
               return AXIS2_SUCCESS;
           }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_additionalTransferProtocols_type0_is_protocol_nil(
                   adb_additionalTransferProtocols_type0_t* _additionalTransferProtocols_type0,
                   const axutil_env_t *env)
           {
               ...
               return !_additionalTransferProtocols_type0->is_valid_protocol;
           }
           ...
           adb_additionalTransferProtocols_type0_set_protocol_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_additionalTransferProtocols_type0_reset_protocol(_additionalTransferProtocols_type0, env);
           }
                   ...
                   const axutil_env_t *env, int i)
           {
                ...
                axutil_array_list_set(_additionalTransferProtocols_type0->property_protocol , env, i, NULL);
