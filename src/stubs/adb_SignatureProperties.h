 ...
 */
        ...
        #ifndef ADB_SIGNATUREPROPERTIES_H
        #define ADB_SIGNATUREPROPERTIES_H

       /**
        * adb_SignatureProperties.h
        *
        ...
        */
        ...
        typedef struct adb_SignatureProperties adb_SignatureProperties_t;
        ...
        /**
         * Constructor for creating adb_SignatureProperties_t
         * @param env pointer to environment struct
         * @return newly created adb_SignatureProperties_t object
         */
         ...
         * @param  _SignatureProperties adb_SignatureProperties_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_SignatureProperties_t object
         * @param  _SignatureProperties adb_SignatureProperties_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _SignatureProperties adb_SignatureProperties_t object
         * @param env pointer to environment struct
         * @return adb_SignaturePropertiesType_t*
         */
         ...
         * @param  _SignatureProperties adb_SignatureProperties_t object
         * @param env pointer to environment struct
         * @param arg_SignatureProperties adb_SignaturePropertiesType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_SignatureProperties_declare_parent_namespaces(
         ...
         * @param  _SignatureProperties adb_SignatureProperties_t object
         * @param env pointer to environment struct
         * @param SignatureProperties_om_node node to serialize from
         * @param SignatureProperties_om_element parent element to serialize from
        ...
        adb_SignatureProperties_serialize(
            adb_SignatureProperties_t* _SignatureProperties,
            const axutil_env_t *env,
            axiom_node_t* SignatureProperties_om_node, axiom_element_t *SignatureProperties_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SignatureProperties is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_SignatureProperties_t
         * @param env pointer to environment struct
         * @param _SignatureProperties adb_SignaturePropertiesType_t*
         * @return newly created adb_SignatureProperties_t object
         */
        adb_SignatureProperties_t* AXIS2_CALL
        adb_SignatureProperties_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SignatureProperties_t object and return the property value.
     ...
     #endif /* ADB_SIGNATUREPROPERTIES_H */
