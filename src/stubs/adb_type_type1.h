 ...
 */
        ...
        #ifndef ADB_TYPE_TYPE1_H
        #define ADB_TYPE_TYPE1_H
        ...
        */
        ...
        typedef struct adb_type_type1 adb_type_type1_t;
        ...
        typedef enum {
            TYPE_TYPE1_WARNING,
            TYPE_TYPE1_ERROR,
            TYPE_TYPE1_INFORMATION,
            TYPE_TYPE1_SYSTEM } adb_type_type1_enum_t;
        

        /******************************* Create and Free functions *********************************/

        /**
         * Constructor for creating adb_type_type1_t
         * @param env pointer to environment struct
         * @return newly created adb_type_type1_t object
         */
         ...
         * @param  _type_type1 adb_type_type1_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _type_type1 adb_type_type1_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _type_type1 adb_type_type1_t object
         * @param env pointer to environment struct
         * @param arg_type_type1 axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        adb_type_type1_reset_type_type1(
            ...
            /**
            * Enum getter for type_type1.
            * @param  _type_type1 adb_type_type1_t object
            * @param env pointer to environment struct
            * @return adb_type_type1_enum_t; -1 on failure
            */
            ...
            /**
            * Enum setter for type_type1.
            * @param  _type_type1 adb_type_type1_t object
            * @param env pointer to environment struct
            * @param arg_type_type1 adb_type_type1_enum_t
            * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
            */
            axis2_status_t AXIS2_CALL
       ...
       adb_type_type1_declare_parent_namespaces(
         ...
         * @param  _type_type1 adb_type_type1_t object
         * @param env pointer to environment struct
         * @param type_type1_om_node node to serialize from
         * @param type_type1_om_element parent element to serialize from
        ...
        adb_type_type1_serialize(
            adb_type_type1_t* _type_type1,
            const axutil_env_t *env,
            axiom_node_t* type_type1_om_node, axiom_element_t *type_type1_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_type_type1 is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_type_type1_t
         * @param env pointer to environment struct
         * @param _type_type1 axis2_char_t*
         * @return newly created adb_type_type1_t object
         */
        adb_type_type1_t* AXIS2_CALL
        adb_type_type1_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_type_type1_t object and return the property value.
