 ...
 */
        ...
        /**
         * adb_serviceAttributes.c
         *
         * This file was auto-generated from WSDL
         * by the Apache Axis2/C version: SNAPSHOT  Built on : Mar 10, 2008 (08:35:52 GMT+00:00)
         */

        #include "adb_serviceAttributes.h"
        
               /*
                * implmentation of the serviceAttributes|http://www.daisy.org/ns/daisy-online/ element
                */
           


        struct adb_serviceAttributes
        {
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_serviceAttributes_set_serviceProvider_nil(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_serviceAttributes_set_service_nil(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_serviceAttributes_set_supportedContentSelectionMethods_nil(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_serviceAttributes_set_supportsServerSideBack_nil(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_serviceAttributes_set_supportsSearch_nil(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_serviceAttributes_set_supportedUplinkAudioCodecs_nil(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_serviceAttributes_set_supportsAudioLabels_nil(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_serviceAttributes_set_supportedOptionalOperations_nil(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env);
       ...
       /************************* Function Implmentations ********************************/
        adb_serviceAttributes_t* AXIS2_CALL
        adb_serviceAttributes_create(
            const axutil_env_t *env)
        {
            adb_serviceAttributes_t *_serviceAttributes = NULL;
            
                axutil_qname_t* qname = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _serviceAttributes = (adb_serviceAttributes_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_serviceAttributes_t));

            if(NULL == _serviceAttributes)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_serviceAttributes, 0, sizeof(adb_serviceAttributes_t));

            _serviceAttributes->property_TypeName = axutil_strdup(env, "adb_serviceAttributes");
            _serviceAttributes->property_serviceProvider  = NULL;
                  _serviceAttributes->is_valid_serviceProvider  = AXIS2_FALSE;
            _serviceAttributes->property_service  = NULL;
                  _serviceAttributes->is_valid_service  = AXIS2_FALSE;
            _serviceAttributes->property_supportedContentSelectionMethods  = NULL;
                  _serviceAttributes->is_valid_supportedContentSelectionMethods  = AXIS2_FALSE;
            _serviceAttributes->is_valid_supportsServerSideBack  = AXIS2_FALSE;
            _serviceAttributes->is_valid_supportsSearch  = AXIS2_FALSE;
            _serviceAttributes->property_supportedUplinkAudioCodecs  = NULL;
                  _serviceAttributes->is_valid_supportedUplinkAudioCodecs  = AXIS2_FALSE;
            _serviceAttributes->is_valid_supportsAudioLabels  = AXIS2_FALSE;
            _serviceAttributes->property_supportedOptionalOperations  = NULL;
                  _serviceAttributes->is_valid_supportedOptionalOperations  = AXIS2_FALSE;
            
                  qname =  axutil_qname_create (env,
                        "serviceAttributes",
                        "http://www.daisy.org/ns/daisy-online/",
                        NULL);
                _serviceAttributes->qname = qname;
        ...
        adb_serviceAttributes_t* AXIS2_CALL
        adb_serviceAttributes_create_with_values(
            const axutil_env_t *env,
        ...
        {
            adb_serviceAttributes_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_serviceAttributes_create(env);

            
              status = adb_serviceAttributes_set_serviceProvider(
                                     adb_obj,
                                     env,
                                     _serviceProvider);
              if(status == AXIS2_FAILURE) {
                  adb_serviceAttributes_free (adb_obj, env);
                  return NULL;
              }
            
              status = adb_serviceAttributes_set_service(
                                     adb_obj,
                                     env,
                                     _service);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_serviceAttributes_set_supportedContentSelectionMethods(
                                     adb_obj,
                                     env,
              ...
              status = adb_serviceAttributes_set_supportsServerSideBack(
                                     adb_obj,
                                     env,
              ...
              status = adb_serviceAttributes_set_supportsSearch(
                                     adb_obj,
                                     env,
                                     _supportsSearch);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_serviceAttributes_set_supportedUplinkAudioCodecs(
                                     adb_obj,
                                     env,
              ...
              status = adb_serviceAttributes_set_supportsAudioLabels(
                                     adb_obj,
                                     env,
              ...
              status = adb_serviceAttributes_set_supportedOptionalOperations(
                                     adb_obj,
                                     env,
        ...
        adb_serviceProvider_type0_t* AXIS2_CALL
                adb_serviceAttributes_free_popping_value(
                        adb_serviceAttributes_t* _serviceAttributes,
                        const axutil_env_t *env)
                {
                    ...
                    value = _serviceAttributes->property_serviceProvider;

                    _serviceAttributes->property_serviceProvider = (adb_serviceProvider_type0_t*)NULL;
                    adb_serviceAttributes_free(_serviceAttributes, env);
        ...
        axis2_status_t AXIS2_CALL
        adb_serviceAttributes_free(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
        {
            
            
            return adb_serviceAttributes_free_obj(
                _serviceAttributes,
                env);
        ...
        axis2_status_t AXIS2_CALL
        adb_serviceAttributes_free_obj(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _serviceAttributes, AXIS2_FAILURE);

            if (_serviceAttributes->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _serviceAttributes->property_TypeName);
            }

            adb_serviceAttributes_reset_serviceProvider(_serviceAttributes, env);
            adb_serviceAttributes_reset_service(_serviceAttributes, env);
            adb_serviceAttributes_reset_supportedContentSelectionMethods(_serviceAttributes, env);
            adb_serviceAttributes_reset_supportsServerSideBack(_serviceAttributes, env);
            adb_serviceAttributes_reset_supportsSearch(_serviceAttributes, env);
            adb_serviceAttributes_reset_supportedUplinkAudioCodecs(_serviceAttributes, env);
            adb_serviceAttributes_reset_supportsAudioLabels(_serviceAttributes, env);
            adb_serviceAttributes_reset_supportedOptionalOperations(_serviceAttributes, env);
            
              if(_serviceAttributes->qname)
              {
                  axutil_qname_free (_serviceAttributes->qname, env);
                  _serviceAttributes->qname = NULL;
              }
            

            if(_serviceAttributes)
            {
                AXIS2_FREE(env->allocator, _serviceAttributes);
                _serviceAttributes = NULL;
            }
        ...
        axis2_status_t AXIS2_CALL
        adb_serviceAttributes_deserialize(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env,
                ...
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            return adb_serviceAttributes_deserialize_obj(
                _serviceAttributes,
                env,
                dp_parent,
        ...
        axis2_status_t AXIS2_CALL
        adb_serviceAttributes_deserialize_obj(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env,
                axiom_node_t **dp_parent,
                axis2_bool_t *dp_is_early_node_valid,
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _serviceAttributes, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                            "Failed in building adb object for serviceAttributes : "
                ...
                return AXIS2_FAILURE;
                    ...
                    if (axutil_qname_equals(qname, env, _serviceAttributes-> qname))
                    {
                    ...
                    else
                    {
                        AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                              ...
                              axutil_qname_to_string(_serviceAttributes-> qname, env),
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_serviceAttributes_set_serviceProvider(_serviceAttributes, env,
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_serviceAttributes_set_service(_serviceAttributes, env,
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_serviceAttributes_set_supportedContentSelectionMethods(_serviceAttributes, env,
                              ...
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            ...
                                            {
                                                status = adb_serviceAttributes_set_supportsServerSideBack(_serviceAttributes, env,
                                                                 AXIS2_TRUE);
                                            }
                                            else
                                            {
                              ...
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            if (!axutil_strcasecmp(text_value , "true"))
                                            {
                                                status = adb_serviceAttributes_set_supportsSearch(_serviceAttributes, env,
                                                                 AXIS2_TRUE);
                                            }
                                            else
                                            {
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_serviceAttributes_set_supportedUplinkAudioCodecs(_serviceAttributes, env,
                              ...
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            if (!axutil_strcasecmp(text_value , "true"))
                                            {
                                                status = adb_serviceAttributes_set_supportsAudioLabels(_serviceAttributes, env,
                                                                 AXIS2_TRUE);
                                            }
                                            else
                                            {
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_serviceAttributes_set_supportedOptionalOperations(_serviceAttributes, env,
          ...
          adb_serviceAttributes_is_particle()
          {
          ...
          void AXIS2_CALL
          adb_serviceAttributes_declare_parent_namespaces(
                    adb_serviceAttributes_t* _serviceAttributes,
        ...
        adb_serviceAttributes_serialize(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            
            
                return adb_serviceAttributes_serialize_obj(
                    _serviceAttributes, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            
        }

        axiom_node_t* AXIS2_CALL
        adb_serviceAttributes_serialize_obj(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axiom_attribute_t* xsi_type_attri = NULL;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _serviceAttributes, NULL);
                    ...
                    parent_element = axiom_element_create (env, NULL, "serviceAttributes", ns1 , &parent);
                   ...
                   if (!_serviceAttributes->is_valid_serviceProvider)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_serviceProvider_type0_serialize(_serviceAttributes->property_serviceProvider, 
                   ...
                   if (!_serviceAttributes->is_valid_service)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_service_type0_serialize(_serviceAttributes->property_service, 
                                                                                 env, current_node, parent_element,
                   ...
                   if (!_serviceAttributes->is_valid_supportedContentSelectionMethods)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_supportedContentSelectionMethods_type0_serialize(_serviceAttributes->property_supportedContentSelectionMethods, 
                                                                                 env, current_node, parent_element,
                   ...
                   if (!_serviceAttributes->is_valid_supportsServerSideBack)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           strcpy(text_value_4, (_serviceAttributes->property_supportsServerSideBack)?"true":"false");
                   ...
                   if (!_serviceAttributes->is_valid_supportsSearch)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           strcpy(text_value_5, (_serviceAttributes->property_supportsSearch)?"true":"false");
                   ...
                   if (!_serviceAttributes->is_valid_supportedUplinkAudioCodecs)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_supportedUplinkAudioCodecs_type0_serialize(_serviceAttributes->property_supportedUplinkAudioCodecs, 
                                                                                 env, current_node, parent_element,
                   ...
                   if (!_serviceAttributes->is_valid_supportsAudioLabels)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           strcpy(text_value_7, (_serviceAttributes->property_supportsAudioLabels)?"true":"false");
                   ...
                   if (!_serviceAttributes->is_valid_supportedOptionalOperations)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_supportedOptionalOperations_type0_serialize(_serviceAttributes->property_supportedOptionalOperations, 
                                                                                 env, current_node, parent_element,
             ...
             */
            adb_serviceProvider_type0_t* AXIS2_CALL
            adb_serviceAttributes_get_property1(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
            {
                return adb_serviceAttributes_get_serviceProvider(_serviceAttributes,
                                             env);
            }
             ...
             */
            adb_serviceProvider_type0_t* AXIS2_CALL
            adb_serviceAttributes_get_serviceProvider(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env)
             {
                ...
                return _serviceAttributes->property_serviceProvider;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_serviceAttributes_set_serviceProvider(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env,
                    adb_serviceProvider_type0_t*  arg_serviceProvider)
             {
                ...
                if(_serviceAttributes->is_valid_serviceProvider &&
                        arg_serviceProvider == _serviceAttributes->property_serviceProvider)
                {
                ...
                _serviceAttributes->property_serviceProvider = arg_serviceProvider;
                        _serviceAttributes->is_valid_serviceProvider = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_serviceAttributes_reset_serviceProvider(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _serviceAttributes, AXIS2_FAILURE);
                ...
                if(_serviceAttributes->property_serviceProvider != NULL)
                {
                   
                   adb_serviceProvider_type0_free(_serviceAttributes->property_serviceProvider, env);
                     _serviceAttributes->property_serviceProvider = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_serviceAttributes_is_serviceProvider_nil(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               AXIS2_PARAM_CHECK(env->error, _serviceAttributes, AXIS2_TRUE);
               
               return !_serviceAttributes->is_valid_serviceProvider;
           }
           ...
           adb_serviceAttributes_set_serviceProvider_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_serviceAttributes_reset_serviceProvider(_serviceAttributes, env);
           }
            ...
            adb_serviceAttributes_get_property2(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
            {
                return adb_serviceAttributes_get_service(_serviceAttributes,
                                             env);
            }
             ...
             */
            adb_service_type0_t* AXIS2_CALL
            adb_serviceAttributes_get_service(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env)
             {
                ...
                return _serviceAttributes->property_service;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_serviceAttributes_set_service(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env,
                    adb_service_type0_t*  arg_service)
             {
                ...
                if(_serviceAttributes->is_valid_service &&
                        arg_service == _serviceAttributes->property_service)
                {
                ...
                _serviceAttributes->property_service = arg_service;
                        _serviceAttributes->is_valid_service = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_serviceAttributes_reset_service(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _serviceAttributes, AXIS2_FAILURE);
                ...
                if(_serviceAttributes->property_service != NULL)
                {
                   
                   adb_service_type0_free(_serviceAttributes->property_service, env);
                     _serviceAttributes->property_service = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_serviceAttributes_is_service_nil(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_serviceAttributes->is_valid_service;
           }
           ...
           adb_serviceAttributes_set_service_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_serviceAttributes_reset_service(_serviceAttributes, env);
           }
            ...
            adb_serviceAttributes_get_property3(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
            {
                return adb_serviceAttributes_get_supportedContentSelectionMethods(_serviceAttributes,
                                             env);
            }
             ...
             */
            adb_supportedContentSelectionMethods_type0_t* AXIS2_CALL
            adb_serviceAttributes_get_supportedContentSelectionMethods(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env)
             {
                ...
                return _serviceAttributes->property_supportedContentSelectionMethods;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_serviceAttributes_set_supportedContentSelectionMethods(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env,
                    adb_supportedContentSelectionMethods_type0_t*  arg_supportedContentSelectionMethods)
             {
                ...
                if(_serviceAttributes->is_valid_supportedContentSelectionMethods &&
                        arg_supportedContentSelectionMethods == _serviceAttributes->property_supportedContentSelectionMethods)
                {
                ...
                _serviceAttributes->property_supportedContentSelectionMethods = arg_supportedContentSelectionMethods;
                        _serviceAttributes->is_valid_supportedContentSelectionMethods = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_serviceAttributes_reset_supportedContentSelectionMethods(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _serviceAttributes, AXIS2_FAILURE);
                ...
                if(_serviceAttributes->property_supportedContentSelectionMethods != NULL)
                {
                   
                   adb_supportedContentSelectionMethods_type0_free(_serviceAttributes->property_supportedContentSelectionMethods, env);
                     _serviceAttributes->property_supportedContentSelectionMethods = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_serviceAttributes_is_supportedContentSelectionMethods_nil(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_serviceAttributes->is_valid_supportedContentSelectionMethods;
           }
           ...
           adb_serviceAttributes_set_supportedContentSelectionMethods_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_serviceAttributes_reset_supportedContentSelectionMethods(_serviceAttributes, env);
           }
             ...
             */
            axis2_bool_t AXIS2_CALL
            adb_serviceAttributes_get_property4(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
            {
                return adb_serviceAttributes_get_supportsServerSideBack(_serviceAttributes,
                                             env);
            }
             ...
             */
            axis2_bool_t AXIS2_CALL
            adb_serviceAttributes_get_supportsServerSideBack(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env)
             {
                
                    AXIS2_ENV_CHECK(env, (axis2_bool_t)0);
                    AXIS2_PARAM_CHECK(env->error, _serviceAttributes, (axis2_bool_t)0);
                  

                return _serviceAttributes->property_supportsServerSideBack;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_serviceAttributes_set_supportsServerSideBack(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env,
                    axis2_bool_t  arg_supportsServerSideBack)
             {
                ...
                if(_serviceAttributes->is_valid_supportsServerSideBack &&
                        arg_supportsServerSideBack == _serviceAttributes->property_supportsServerSideBack)
                {
                ...
                _serviceAttributes->property_supportsServerSideBack = arg_supportsServerSideBack;
                        _serviceAttributes->is_valid_supportsServerSideBack = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_serviceAttributes_reset_supportsServerSideBack(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               int i = 0;
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_serviceAttributes_is_supportsServerSideBack_nil(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_serviceAttributes->is_valid_supportsServerSideBack;
           }
           ...
           adb_serviceAttributes_set_supportsServerSideBack_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_serviceAttributes_reset_supportsServerSideBack(_serviceAttributes, env);
           }
             ...
             */
            axis2_bool_t AXIS2_CALL
            adb_serviceAttributes_get_property5(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
            {
                return adb_serviceAttributes_get_supportsSearch(_serviceAttributes,
                                             env);
            }
             ...
             */
            axis2_bool_t AXIS2_CALL
            adb_serviceAttributes_get_supportsSearch(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env)
             {
                ...
                return _serviceAttributes->property_supportsSearch;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_serviceAttributes_set_supportsSearch(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env,
                    axis2_bool_t  arg_supportsSearch)
             {
                ...
                if(_serviceAttributes->is_valid_supportsSearch &&
                        arg_supportsSearch == _serviceAttributes->property_supportsSearch)
                {
                ...
                _serviceAttributes->property_supportsSearch = arg_supportsSearch;
                        _serviceAttributes->is_valid_supportsSearch = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_serviceAttributes_reset_supportsSearch(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               int i = 0;
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_serviceAttributes_is_supportsSearch_nil(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_serviceAttributes->is_valid_supportsSearch;
           }
           ...
           adb_serviceAttributes_set_supportsSearch_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_serviceAttributes_reset_supportsSearch(_serviceAttributes, env);
           }
            ...
            adb_serviceAttributes_get_property6(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
            {
                return adb_serviceAttributes_get_supportedUplinkAudioCodecs(_serviceAttributes,
                                             env);
            }
             ...
             */
            adb_supportedUplinkAudioCodecs_type0_t* AXIS2_CALL
            adb_serviceAttributes_get_supportedUplinkAudioCodecs(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env)
             {
                ...
                return _serviceAttributes->property_supportedUplinkAudioCodecs;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_serviceAttributes_set_supportedUplinkAudioCodecs(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env,
                    adb_supportedUplinkAudioCodecs_type0_t*  arg_supportedUplinkAudioCodecs)
             {
                ...
                if(_serviceAttributes->is_valid_supportedUplinkAudioCodecs &&
                        arg_supportedUplinkAudioCodecs == _serviceAttributes->property_supportedUplinkAudioCodecs)
                {
                ...
                _serviceAttributes->property_supportedUplinkAudioCodecs = arg_supportedUplinkAudioCodecs;
                        _serviceAttributes->is_valid_supportedUplinkAudioCodecs = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_serviceAttributes_reset_supportedUplinkAudioCodecs(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _serviceAttributes, AXIS2_FAILURE);
                ...
                if(_serviceAttributes->property_supportedUplinkAudioCodecs != NULL)
                {
                   
                   adb_supportedUplinkAudioCodecs_type0_free(_serviceAttributes->property_supportedUplinkAudioCodecs, env);
                     _serviceAttributes->property_supportedUplinkAudioCodecs = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_serviceAttributes_is_supportedUplinkAudioCodecs_nil(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_serviceAttributes->is_valid_supportedUplinkAudioCodecs;
           }
           ...
           adb_serviceAttributes_set_supportedUplinkAudioCodecs_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_serviceAttributes_reset_supportedUplinkAudioCodecs(_serviceAttributes, env);
           }
             ...
             */
            axis2_bool_t AXIS2_CALL
            adb_serviceAttributes_get_property7(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
            {
                return adb_serviceAttributes_get_supportsAudioLabels(_serviceAttributes,
                                             env);
            }
             ...
             */
            axis2_bool_t AXIS2_CALL
            adb_serviceAttributes_get_supportsAudioLabels(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env)
             {
                ...
                return _serviceAttributes->property_supportsAudioLabels;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_serviceAttributes_set_supportsAudioLabels(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env,
                    axis2_bool_t  arg_supportsAudioLabels)
             {
                ...
                if(_serviceAttributes->is_valid_supportsAudioLabels &&
                        arg_supportsAudioLabels == _serviceAttributes->property_supportsAudioLabels)
                {
                ...
                _serviceAttributes->property_supportsAudioLabels = arg_supportsAudioLabels;
                        _serviceAttributes->is_valid_supportsAudioLabels = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_serviceAttributes_reset_supportsAudioLabels(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               int i = 0;
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_serviceAttributes_is_supportsAudioLabels_nil(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_serviceAttributes->is_valid_supportsAudioLabels;
           }
           ...
           adb_serviceAttributes_set_supportsAudioLabels_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_serviceAttributes_reset_supportsAudioLabels(_serviceAttributes, env);
           }
            ...
            adb_serviceAttributes_get_property8(
                adb_serviceAttributes_t* _serviceAttributes,
                const axutil_env_t *env)
            {
                return adb_serviceAttributes_get_supportedOptionalOperations(_serviceAttributes,
                                             env);
            }
             ...
             */
            adb_supportedOptionalOperations_type0_t* AXIS2_CALL
            adb_serviceAttributes_get_supportedOptionalOperations(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env)
             {
                ...
                return _serviceAttributes->property_supportedOptionalOperations;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_serviceAttributes_set_supportedOptionalOperations(
                    adb_serviceAttributes_t* _serviceAttributes,
                    const axutil_env_t *env,
                    adb_supportedOptionalOperations_type0_t*  arg_supportedOptionalOperations)
             {
                ...
                if(_serviceAttributes->is_valid_supportedOptionalOperations &&
                        arg_supportedOptionalOperations == _serviceAttributes->property_supportedOptionalOperations)
                {
                ...
                _serviceAttributes->property_supportedOptionalOperations = arg_supportedOptionalOperations;
                        _serviceAttributes->is_valid_supportedOptionalOperations = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_serviceAttributes_reset_supportedOptionalOperations(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _serviceAttributes, AXIS2_FAILURE);
                ...
                if(_serviceAttributes->property_supportedOptionalOperations != NULL)
                {
                   
                   adb_supportedOptionalOperations_type0_free(_serviceAttributes->property_supportedOptionalOperations, env);
                     _serviceAttributes->property_supportedOptionalOperations = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_serviceAttributes_is_supportedOptionalOperations_nil(
                   adb_serviceAttributes_t* _serviceAttributes,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_serviceAttributes->is_valid_supportedOptionalOperations;
           }
           ...
           adb_serviceAttributes_set_supportedOptionalOperations_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_serviceAttributes_reset_supportedOptionalOperations(_serviceAttributes, env);
           }
