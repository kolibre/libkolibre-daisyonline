 ...
 */
        ...
        #ifndef ADB_RSAKEYVALUETYPE_H
        #define ADB_RSAKEYVALUETYPE_H

       /**
        * adb_RSAKeyValueType.h
        *
        ...
        */
        ...
        typedef struct adb_RSAKeyValueType adb_RSAKeyValueType_t;
        ...
        /**
         * Constructor for creating adb_RSAKeyValueType_t
         * @param env pointer to environment struct
         * @return newly created adb_RSAKeyValueType_t object
         */
         ...
         * @param  _RSAKeyValueType adb_RSAKeyValueType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_RSAKeyValueType_t object
         * @param  _RSAKeyValueType adb_RSAKeyValueType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for Modulus. 
         * @param  _RSAKeyValueType adb_RSAKeyValueType_t object
         * @param env pointer to environment struct
         ...
         * @param  _RSAKeyValueType adb_RSAKeyValueType_t object
         * @param env pointer to environment struct
         * @param arg_Modulus adb_CryptoBinary_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _RSAKeyValueType adb_RSAKeyValueType_t object
         * @param env pointer to environment struct
         * @param arg_Exponent adb_CryptoBinary_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_RSAKeyValueType_declare_parent_namespaces(
         ...
         * @param  _RSAKeyValueType adb_RSAKeyValueType_t object
         * @param env pointer to environment struct
         * @param RSAKeyValueType_om_node node to serialize from
         * @param RSAKeyValueType_om_element parent element to serialize from
        ...
        adb_RSAKeyValueType_serialize(
            adb_RSAKeyValueType_t* _RSAKeyValueType,
            const axutil_env_t *env,
            axiom_node_t* RSAKeyValueType_om_node, axiom_element_t *RSAKeyValueType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_RSAKeyValueType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_RSAKeyValueType_t
         * @param env pointer to environment struct
         * @param _Modulus adb_CryptoBinary_t*
         * @param _Exponent adb_CryptoBinary_t*
         * @return newly created adb_RSAKeyValueType_t object
         */
        adb_RSAKeyValueType_t* AXIS2_CALL
        adb_RSAKeyValueType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_RSAKeyValueType_t object and return the property value.
