 ...
 */
        ...
        #include "adb_invalidParameterFault.h"
               ...
               /*
                * implmentation of the invalidParameterFault|http://www.daisy.org/ns/daisy-online/ element
                */
        ...
        struct adb_invalidParameterFault
        {
            ...
            adb_invalidParameterFaultType_t* property_invalidParameterFault;
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_invalidParameterFault_set_invalidParameterFault_nil(
                        adb_invalidParameterFault_t* _invalidParameterFault,
                        const axutil_env_t *env);
            


       /************************* Function Implmentations ********************************/
        adb_invalidParameterFault_t* AXIS2_CALL
        adb_invalidParameterFault_create(
            const axutil_env_t *env)
        {
            adb_invalidParameterFault_t *_invalidParameterFault = NULL;
            
                axutil_qname_t* qname = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _invalidParameterFault = (adb_invalidParameterFault_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_invalidParameterFault_t));
            ...
            memset(_invalidParameterFault, 0, sizeof(adb_invalidParameterFault_t));

            _invalidParameterFault->property_TypeName = axutil_strdup(env, "adb_invalidParameterFault");
        ...
        adb_invalidParameterFault_t* AXIS2_CALL
        adb_invalidParameterFault_create_with_values(
            const axutil_env_t *env,
                adb_invalidParameterFaultType_t* _invalidParameterFault)
        {
            ...
            adb_obj = adb_invalidParameterFault_create(env);
              ...
              status = adb_invalidParameterFault_set_invalidParameterFault(
                                     adb_obj,
                                     env,
        ...
        adb_invalidParameterFaultType_t* AXIS2_CALL
                adb_invalidParameterFault_free_popping_value(
                        adb_invalidParameterFault_t* _invalidParameterFault,
                        const axutil_env_t *env)
                {
                    adb_invalidParameterFaultType_t* value;

                    
                    
                    value = _invalidParameterFault->property_invalidParameterFault;

                    _invalidParameterFault->property_invalidParameterFault = (adb_invalidParameterFaultType_t*)NULL;
                    adb_invalidParameterFault_free(_invalidParameterFault, env);
        ...
        axis2_status_t AXIS2_CALL
        adb_invalidParameterFault_free(
                adb_invalidParameterFault_t* _invalidParameterFault,
                const axutil_env_t *env)
        {
            
            
            return adb_invalidParameterFault_free_obj(
                _invalidParameterFault,
                env);
        ...
        axis2_status_t AXIS2_CALL
        adb_invalidParameterFault_free_obj(
                adb_invalidParameterFault_t* _invalidParameterFault,
                const axutil_env_t *env)
        {
            ...
            adb_invalidParameterFault_reset_invalidParameterFault(_invalidParameterFault, env);
        ...
        axis2_status_t AXIS2_CALL
        adb_invalidParameterFault_deserialize(
                adb_invalidParameterFault_t* _invalidParameterFault,
                const axutil_env_t *env,
                ...
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            return adb_invalidParameterFault_deserialize_obj(
                _invalidParameterFault,
                env,
                dp_parent,
        ...
        axis2_status_t AXIS2_CALL
        adb_invalidParameterFault_deserialize_obj(
                adb_invalidParameterFault_t* _invalidParameterFault,
                const axutil_env_t *env,
                axiom_node_t **dp_parent,
                axis2_bool_t *dp_is_early_node_valid,
                axis2_bool_t dont_care_minoccurs)
        {
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(env, "invalidParameterFault", "http://www.daisy.org/ns/daisy-online/", NULL);
                                 

                           if (adb_invalidParameterFaultType_is_particle() ||  
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      element = (void*)axis2_extension_mapper_create_from_node(env, &current_node, "adb_invalidParameterFaultType");

                                      status =  adb_invalidParameterFaultType_deserialize((adb_invalidParameterFaultType_t*)element,
                                      ...
                                      {
                                          status = adb_invalidParameterFault_set_invalidParameterFault(_invalidParameterFault, env,
                                                                   (adb_invalidParameterFaultType_t*)element);
                                      }
          ...
          adb_invalidParameterFault_is_particle()
          {
          ...
          void AXIS2_CALL
          adb_invalidParameterFault_declare_parent_namespaces(
                    adb_invalidParameterFault_t* _invalidParameterFault,
        ...
        adb_invalidParameterFault_serialize(
                adb_invalidParameterFault_t* _invalidParameterFault,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            
            
                return adb_invalidParameterFault_serialize_obj(
                    _invalidParameterFault, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            
        }

        axiom_node_t* AXIS2_CALL
        adb_invalidParameterFault_serialize_obj(
                adb_invalidParameterFault_t* _invalidParameterFault,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axiom_attribute_t* xsi_type_attri = NULL;
            ...
            AXIS2_PARAM_CHECK(env->error, _invalidParameterFault, NULL);
                   ...
                   else
                   {
                    ...
                    adb_invalidParameterFaultType_serialize(_invalidParameterFault->property_invalidParameterFault, 
                                                                                 env, current_node, parent_element,
                                                                                 adb_invalidParameterFaultType_is_particle() || AXIS2_TRUE, namespaces, next_ns_index);
             ...
             */
            adb_invalidParameterFaultType_t* AXIS2_CALL
            adb_invalidParameterFault_get_property1(
                adb_invalidParameterFault_t* _invalidParameterFault,
                const axutil_env_t *env)
            {
                return adb_invalidParameterFault_get_invalidParameterFault(_invalidParameterFault,
                                             env);
            }
             ...
             */
            adb_invalidParameterFaultType_t* AXIS2_CALL
            adb_invalidParameterFault_get_invalidParameterFault(
                    adb_invalidParameterFault_t* _invalidParameterFault,
                    const axutil_env_t *env)
             {
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_invalidParameterFault_set_invalidParameterFault(
                    adb_invalidParameterFault_t* _invalidParameterFault,
                    const axutil_env_t *env,
                    adb_invalidParameterFaultType_t*  arg_invalidParameterFault)
             {
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_invalidParameterFault_reset_invalidParameterFault(
                   adb_invalidParameterFault_t* _invalidParameterFault,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _invalidParameterFault, AXIS2_FAILURE);
                ...
                if(_invalidParameterFault->property_invalidParameterFault != NULL)
                {
                   ...
                   adb_invalidParameterFaultType_free(_invalidParameterFault->property_invalidParameterFault, env);
                     _invalidParameterFault->property_invalidParameterFault = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_invalidParameterFault_is_invalidParameterFault_nil(
                   adb_invalidParameterFault_t* _invalidParameterFault,
                   const axutil_env_t *env)
           {
           ...
           adb_invalidParameterFault_set_invalidParameterFault_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_invalidParameterFault_reset_invalidParameterFault(_invalidParameterFault, env);
           }
