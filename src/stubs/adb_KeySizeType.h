 ...
 */
        ...
        #ifndef ADB_KEYSIZETYPE_H
        #define ADB_KEYSIZETYPE_H
        ...
        */
        ...
        typedef struct adb_KeySizeType adb_KeySizeType_t;
        ...
        /**
         * Constructor for creating adb_KeySizeType_t
         * @param env pointer to environment struct
         * @return newly created adb_KeySizeType_t object
         */
         ...
         * @param  _KeySizeType adb_KeySizeType_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _KeySizeType adb_KeySizeType_t object
         * @param env pointer to environment struct
         * @return int
         */
        int AXIS2_CALL
       ...
       adb_KeySizeType_declare_parent_namespaces(
         ...
         * @param  _KeySizeType adb_KeySizeType_t object
         * @param env pointer to environment struct
         * @param KeySizeType_om_node node to serialize from
         * @param KeySizeType_om_element parent element to serialize from
        ...
        adb_KeySizeType_serialize(
            adb_KeySizeType_t* _KeySizeType,
            const axutil_env_t *env,
            axiom_node_t* KeySizeType_om_node, axiom_element_t *KeySizeType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_KeySizeType is a particle class (E.g. group, inner sequence)
        ...
        adb_KeySizeType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_KeySizeType_t object and return the property value.
