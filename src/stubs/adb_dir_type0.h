 ...
 */
        ...
        #ifndef ADB_DIR_TYPE0_H
        #define ADB_DIR_TYPE0_H
        ...
        */
        ...
        typedef struct adb_dir_type0 adb_dir_type0_t;
        ...
        typedef enum {
            DIR_TYPE0_LTR,
            DIR_TYPE0_RTL } adb_dir_type0_enum_t;
        

        /******************************* Create and Free functions *********************************/

        /**
         * Constructor for creating adb_dir_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_dir_type0_t object
         */
         ...
         * @param  _dir_type0 adb_dir_type0_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _dir_type0 adb_dir_type0_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _dir_type0 adb_dir_type0_t object
         * @param env pointer to environment struct
         * @param arg_dir_type0 axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        adb_dir_type0_reset_dir_type0(
            ...
            /**
            * Enum getter for dir_type0.
            * @param  _dir_type0 adb_dir_type0_t object
            * @param env pointer to environment struct
            * @return adb_dir_type0_enum_t; -1 on failure
            */
            ...
            /**
            * Enum setter for dir_type0.
            * @param  _dir_type0 adb_dir_type0_t object
            * @param env pointer to environment struct
            * @param arg_dir_type0 adb_dir_type0_enum_t
            * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
            */
            axis2_status_t AXIS2_CALL
       ...
       adb_dir_type0_declare_parent_namespaces(
         ...
         * @param  _dir_type0 adb_dir_type0_t object
         * @param env pointer to environment struct
         * @param dir_type0_om_node node to serialize from
         * @param dir_type0_om_element parent element to serialize from
        ...
        adb_dir_type0_serialize(
            adb_dir_type0_t* _dir_type0,
            const axutil_env_t *env,
            axiom_node_t* dir_type0_om_node, axiom_element_t *dir_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_dir_type0 is a particle class (E.g. group, inner sequence)
        ...
        adb_dir_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_dir_type0_t object and return the property value.
