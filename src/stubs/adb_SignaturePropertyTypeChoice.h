 ...
 */
        ...
        #ifndef ADB_SIGNATUREPROPERTYTYPECHOICE_H
        #define ADB_SIGNATUREPROPERTYTYPECHOICE_H

       /**
        * adb_SignaturePropertyTypeChoice.h
        *
       ...
       /**
        *  adb_SignaturePropertyTypeChoice class
        */
        ...
        typedef struct adb_SignaturePropertyTypeChoice adb_SignaturePropertyTypeChoice_t;
        ...
        /**
         * Constructor for creating adb_SignaturePropertyTypeChoice_t
         * @param env pointer to environment struct
         * @return newly created adb_SignaturePropertyTypeChoice_t object
         */
         ...
         * @param  _SignaturePropertyTypeChoice adb_SignaturePropertyTypeChoice_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_SignaturePropertyTypeChoice_t object
         * @param  _SignaturePropertyTypeChoice adb_SignaturePropertyTypeChoice_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _SignaturePropertyTypeChoice adb_SignaturePropertyTypeChoice_t object
         * @param env pointer to environment struct
         * @return axiom_node_t*
         */
       ...
       adb_SignaturePropertyTypeChoice_declare_parent_namespaces(
         ...
         * @param  _SignaturePropertyTypeChoice adb_SignaturePropertyTypeChoice_t object
         * @param env pointer to environment struct
         * @param SignaturePropertyTypeChoice_om_node node to serialize from
         * @param SignaturePropertyTypeChoice_om_element parent element to serialize from
        ...
        adb_SignaturePropertyTypeChoice_serialize(
            adb_SignaturePropertyTypeChoice_t* _SignaturePropertyTypeChoice,
            const axutil_env_t *env,
            axiom_node_t* SignaturePropertyTypeChoice_om_node, axiom_element_t *SignaturePropertyTypeChoice_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SignaturePropertyTypeChoice is a particle class (E.g. group, inner sequence)
        ...
        adb_SignaturePropertyTypeChoice_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SignaturePropertyTypeChoice_t object and return the property value.
     ...
     #endif /* ADB_SIGNATUREPROPERTYTYPECHOICE_H */
