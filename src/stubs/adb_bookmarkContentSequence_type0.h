 ...
 */
        ...
        #ifndef ADB_BOOKMARKCONTENTSEQUENCE_TYPE0_H
        #define ADB_BOOKMARKCONTENTSEQUENCE_TYPE0_H

       /**
        * adb_bookmarkContentSequence_type0.h
        *
       ...
       /**
        *  adb_bookmarkContentSequence_type0 class
        */
        ...
        typedef struct adb_bookmarkContentSequence_type0 adb_bookmarkContentSequence_type0_t;
        ...
        /**
         * Constructor for creating adb_bookmarkContentSequence_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_bookmarkContentSequence_type0_t object
         */
         ...
         * @param  _bookmarkContentSequence_type0 adb_bookmarkContentSequence_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_bookmarkContentSequence_type0_t object
         * @param  _bookmarkContentSequence_type0 adb_bookmarkContentSequence_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _bookmarkContentSequence_type0 adb_bookmarkContentSequence_type0_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_bookmarkContentSequence_type0_declare_parent_namespaces(
         ...
         * @param  _bookmarkContentSequence_type0 adb_bookmarkContentSequence_type0_t object
         * @param env pointer to environment struct
         * @param bookmarkContentSequence_type0_om_node node to serialize from
         * @param bookmarkContentSequence_type0_om_element parent element to serialize from
        ...
        adb_bookmarkContentSequence_type0_serialize(
            adb_bookmarkContentSequence_type0_t* _bookmarkContentSequence_type0,
            const axutil_env_t *env,
            axiom_node_t* bookmarkContentSequence_type0_om_node, axiom_element_t *bookmarkContentSequence_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_bookmarkContentSequence_type0 is a particle class (E.g. group, inner sequence)
        ...
        adb_bookmarkContentSequence_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_bookmarkContentSequence_type0_t object and return the property value.
     ...
     #endif /* ADB_BOOKMARKCONTENTSEQUENCE_TYPE0_H */
