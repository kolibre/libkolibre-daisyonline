 ...
 */
        ...
        #ifndef ADB_SETREADINGSYSTEMATTRIBUTES_H
        #define ADB_SETREADINGSYSTEMATTRIBUTES_H

       /**
        * adb_setReadingSystemAttributes.h
        *
       ...
       /**
        *  adb_setReadingSystemAttributes class
        */
        ...
        typedef struct adb_setReadingSystemAttributes adb_setReadingSystemAttributes_t;
        ...
        /**
         * Constructor for creating adb_setReadingSystemAttributes_t
         * @param env pointer to environment struct
         * @return newly created adb_setReadingSystemAttributes_t object
         */
         ...
         * @param  _setReadingSystemAttributes adb_setReadingSystemAttributes_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_setReadingSystemAttributes_t object
         * @param  _setReadingSystemAttributes adb_setReadingSystemAttributes_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _setReadingSystemAttributes adb_setReadingSystemAttributes_t object
         * @param env pointer to environment struct
         * @return adb_readingSystemAttributes_type0_t*
         */
         ...
         * @param  _setReadingSystemAttributes adb_setReadingSystemAttributes_t object
         * @param env pointer to environment struct
         * @param arg_readingSystemAttributes adb_readingSystemAttributes_type0_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_setReadingSystemAttributes_declare_parent_namespaces(
         ...
         * @param  _setReadingSystemAttributes adb_setReadingSystemAttributes_t object
         * @param env pointer to environment struct
         * @param setReadingSystemAttributes_om_node node to serialize from
         * @param setReadingSystemAttributes_om_element parent element to serialize from
        ...
        adb_setReadingSystemAttributes_serialize(
            adb_setReadingSystemAttributes_t* _setReadingSystemAttributes,
            const axutil_env_t *env,
            axiom_node_t* setReadingSystemAttributes_om_node, axiom_element_t *setReadingSystemAttributes_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_setReadingSystemAttributes is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_setReadingSystemAttributes_t
         * @param env pointer to environment struct
         * @param _readingSystemAttributes adb_readingSystemAttributes_type0_t*
         * @return newly created adb_setReadingSystemAttributes_t object
         */
        adb_setReadingSystemAttributes_t* AXIS2_CALL
        adb_setReadingSystemAttributes_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_setReadingSystemAttributes_t object and return the property value.
     ...
     #endif /* ADB_SETREADINGSYSTEMATTRIBUTES_H */
