 ...
 */
        ...
        #ifndef ADB_HILITECONTENTCHOICE_TYPE0_H
        #define ADB_HILITECONTENTCHOICE_TYPE0_H

       /**
        * adb_hiliteContentChoice_type0.h
        *
       ...
       /**
        *  adb_hiliteContentChoice_type0 class
        */
        ...
        typedef struct adb_hiliteContentChoice_type0 adb_hiliteContentChoice_type0_t;
        ...
        /**
         * Constructor for creating adb_hiliteContentChoice_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_hiliteContentChoice_type0_t object
         */
         ...
         * @param  _hiliteContentChoice_type0 adb_hiliteContentChoice_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_hiliteContentChoice_type0_t object
         * @param  _hiliteContentChoice_type0 adb_hiliteContentChoice_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _hiliteContentChoice_type0 adb_hiliteContentChoice_type0_t object
         * @param env pointer to environment struct
         * @return adb_hiliteContentSequence_type0_t*
         */
         ...
         * @param  _hiliteContentChoice_type0 adb_hiliteContentChoice_type0_t object
         * @param env pointer to environment struct
         * @param arg_hiliteContentSequence_type0 adb_hiliteContentSequence_type0_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_hiliteContentChoice_type0_declare_parent_namespaces(
         ...
         * @param  _hiliteContentChoice_type0 adb_hiliteContentChoice_type0_t object
         * @param env pointer to environment struct
         * @param hiliteContentChoice_type0_om_node node to serialize from
         * @param hiliteContentChoice_type0_om_element parent element to serialize from
        ...
        adb_hiliteContentChoice_type0_serialize(
            adb_hiliteContentChoice_type0_t* _hiliteContentChoice_type0,
            const axutil_env_t *env,
            axiom_node_t* hiliteContentChoice_type0_om_node, axiom_element_t *hiliteContentChoice_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_hiliteContentChoice_type0 is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_hiliteContentChoice_type0_t
         * @param env pointer to environment struct
         * @param _hiliteContentSequence_type0 adb_hiliteContentSequence_type0_t*
        ...
        adb_hiliteContentChoice_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_hiliteContentChoice_type0_t object and return the property value.
     ...
     #endif /* ADB_HILITECONTENTCHOICE_TYPE0_H */
