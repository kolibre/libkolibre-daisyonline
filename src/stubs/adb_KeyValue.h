 ...
 */
        ...
        #ifndef ADB_KEYVALUE_H
        #define ADB_KEYVALUE_H
        ...
        */
        ...
        typedef struct adb_KeyValue adb_KeyValue_t;
        ...
        /**
         * Constructor for creating adb_KeyValue_t
         * @param env pointer to environment struct
         * @return newly created adb_KeyValue_t object
         */
         ...
         * @param  _KeyValue adb_KeyValue_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for KeyValue. 
         * @param  _KeyValue adb_KeyValue_t object
         * @param env pointer to environment struct
       ...
       adb_KeyValue_declare_parent_namespaces(
         ...
         * @param  _KeyValue adb_KeyValue_t object
         * @param env pointer to environment struct
         * @param KeyValue_om_node node to serialize from
         * @param KeyValue_om_element parent element to serialize from
        ...
        adb_KeyValue_serialize(
            adb_KeyValue_t* _KeyValue,
            const axutil_env_t *env,
            axiom_node_t* KeyValue_om_node, axiom_element_t *KeyValue_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_KeyValue is a particle class (E.g. group, inner sequence)
        ...
        adb_KeyValue_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_KeyValue_t object and return the property value.
