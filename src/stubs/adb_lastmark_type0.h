 ...
 */
        ...
        #ifndef ADB_LASTMARK_TYPE0_H
        #define ADB_LASTMARK_TYPE0_H

       /**
        * adb_lastmark_type0.h
        *
        ...
        */
        ...
        typedef struct adb_lastmark_type0 adb_lastmark_type0_t;
        ...
        /**
         * Constructor for creating adb_lastmark_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_lastmark_type0_t object
         */
         ...
         * @param  _lastmark_type0 adb_lastmark_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_lastmark_type0_t object
         * @param  _lastmark_type0 adb_lastmark_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _lastmark_type0 adb_lastmark_type0_t object
         * @param env pointer to environment struct
       ...
       adb_lastmark_type0_declare_parent_namespaces(
         ...
         * @param  _lastmark_type0 adb_lastmark_type0_t object
         * @param env pointer to environment struct
         * @param lastmark_type0_om_node node to serialize from
         * @param lastmark_type0_om_element parent element to serialize from
        ...
        adb_lastmark_type0_serialize(
            adb_lastmark_type0_t* _lastmark_type0,
            const axutil_env_t *env,
            axiom_node_t* lastmark_type0_om_node, axiom_element_t *lastmark_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_lastmark_type0 is a particle class (E.g. group, inner sequence)
        ...
        adb_lastmark_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_lastmark_type0_t object and return the property value.
