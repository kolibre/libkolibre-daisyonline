 ...
 */
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_EncryptedDataType_set_EncryptionMethod_nil(
                        adb_EncryptedDataType_t* _EncryptedDataType,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_EncryptedDataType_set_KeyInfo_nil(
                        adb_EncryptedDataType_t* _EncryptedDataType,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_EncryptedDataType_set_CipherData_nil(
                        adb_EncryptedDataType_t* _EncryptedDataType,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_EncryptedDataType_set_EncryptionProperties_nil(
                        adb_EncryptedDataType_t* _EncryptedDataType,
                        const axutil_env_t *env);
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_EncryptedDataType_create(
            const axutil_env_t *env)
        {
            adb_EncryptedDataType_t *_EncryptedDataType = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _EncryptedDataType = (adb_EncryptedDataType_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_EncryptedDataType_t));

            if(NULL == _EncryptedDataType)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_EncryptedDataType, 0, sizeof(adb_EncryptedDataType_t));

            _EncryptedDataType->property_TypeName = axutil_strdup(env, "adb_EncryptedDataType");
            _EncryptedDataType->property_EncryptionMethod  = NULL;
                  _EncryptedDataType->is_valid_EncryptionMethod  = AXIS2_FALSE;
            _EncryptedDataType->property_KeyInfo  = NULL;
                  _EncryptedDataType->is_valid_KeyInfo  = AXIS2_FALSE;
            _EncryptedDataType->property_CipherData  = NULL;
                  _EncryptedDataType->is_valid_CipherData  = AXIS2_FALSE;
            _EncryptedDataType->property_EncryptionProperties  = NULL;
                  _EncryptedDataType->is_valid_EncryptionProperties  = AXIS2_FALSE;
            _EncryptedDataType->property_Id  = NULL;
                  _EncryptedDataType->is_valid_Id  = AXIS2_FALSE;
            _EncryptedDataType->property_Type  = NULL;
                  _EncryptedDataType->is_valid_Type  = AXIS2_FALSE;
            _EncryptedDataType->property_MimeType  = NULL;
                  _EncryptedDataType->is_valid_MimeType  = AXIS2_FALSE;
            _EncryptedDataType->property_Encoding  = NULL;
                  _EncryptedDataType->is_valid_Encoding  = AXIS2_FALSE;
            

            return _EncryptedDataType;
        }
        ...
        {
            adb_EncryptedDataType_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_EncryptedDataType_create(env);

            
              status = adb_EncryptedDataType_set_EncryptionMethod(
                                     adb_obj,
                                     env,
                                     _EncryptionMethod);
              if(status == AXIS2_FAILURE) {
                  adb_EncryptedDataType_free (adb_obj, env);
                  return NULL;
              }
            
              status = adb_EncryptedDataType_set_KeyInfo(
                                     adb_obj,
                                     env,
                                     _KeyInfo);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_EncryptedDataType_set_CipherData(
                                     adb_obj,
                                     env,
                                     _CipherData);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_EncryptedDataType_set_EncryptionProperties(
                                     adb_obj,
                                     env,
              ...
              status = adb_EncryptedDataType_set_Id(
                                     adb_obj,
                                     env,
                                     _Id);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_EncryptedDataType_set_Type(
                                     adb_obj,
                                     env,
                                     _Type);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_EncryptedDataType_set_MimeType(
                                     adb_obj,
                                     env,
                                     _MimeType);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_EncryptedDataType_set_Encoding(
                                     adb_obj,
                                     env,
                                     _Encoding);
              if(status == AXIS2_FAILURE) {
        ...
        adb_EncryptionMethodType_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _EncryptedDataType->property_EncryptionMethod;

                    _EncryptedDataType->property_EncryptionMethod = (adb_EncryptionMethodType_t*)NULL;
                    adb_EncryptedDataType_free(_EncryptedDataType, env);
                ...
                const axutil_env_t *env)
        {
            ...
            return axis2_extension_mapper_free(
                (adb_stubtype_t*) _EncryptedDataType,
                env,
                "adb_EncryptedDataType");
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);

            if (_EncryptedDataType->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _EncryptedDataType->property_TypeName);
            }

            adb_EncryptedDataType_reset_EncryptionMethod(_EncryptedDataType, env);
            adb_EncryptedDataType_reset_KeyInfo(_EncryptedDataType, env);
            adb_EncryptedDataType_reset_CipherData(_EncryptedDataType, env);
            adb_EncryptedDataType_reset_EncryptionProperties(_EncryptedDataType, env);
            adb_EncryptedDataType_reset_Id(_EncryptedDataType, env);
            adb_EncryptedDataType_reset_Type(_EncryptedDataType, env);
            adb_EncryptedDataType_reset_MimeType(_EncryptedDataType, env);
            adb_EncryptedDataType_reset_Encoding(_EncryptedDataType, env);
            

            if(_EncryptedDataType)
            {
                AXIS2_FREE(env->allocator, _EncryptedDataType);
                _EncryptedDataType = NULL;
            }
            ...
            AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                            "Failed in building adb object for EncryptedDataType : "
                ...
                return AXIS2_FAILURE;
                 ...
                 attribute_hash = axiom_element_get_all_attributes(parent_element, env);
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_EncryptedDataType_set_EncryptionMethod(_EncryptedDataType, env,
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_EncryptedDataType_set_KeyInfo(_EncryptedDataType, env,
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_EncryptedDataType_set_CipherData(_EncryptedDataType, env,
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_EncryptedDataType_set_EncryptionProperties(_EncryptedDataType, env,
                  ...
                  if(attrib_text != NULL)
                  {
                      ...
                      adb_EncryptedDataType_set_Id(_EncryptedDataType,
                                                          env, attrib_text);
                  ...
                  if(attrib_text != NULL)
                  {
                      ...
                      adb_EncryptedDataType_set_Type(_EncryptedDataType,
                  ...
                  if(attrib_text != NULL)
                  {
                      ...
                      adb_EncryptedDataType_set_MimeType(_EncryptedDataType,
                                                          env, attrib_text);
                  ...
                  if(attrib_text != NULL)
                  {
                      ...
                      adb_EncryptedDataType_set_Encoding(_EncryptedDataType,
                                                          env, axutil_uri_parse_string(env, attrib_text));
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            ...
            if (_EncryptedDataType == NULL)
            {
                return adb_EncryptedDataType_serialize_obj(
                    _EncryptedDataType, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            }
            else
            {
                return axis2_extension_mapper_serialize(
                    (adb_stubtype_t*) _EncryptedDataType, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index, "adb_EncryptedDataType");
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axis2_char_t* type_attrib = NULL;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, NULL);
            ...
            if(!parent_tag_closed)
            {
                ...
                if(_EncryptedDataType->is_valid_Id)
                {
                        ...
                        p_prefix = NULL;
                           ...
                           text_value = (axis2_char_t*) AXIS2_MALLOC (env-> allocator, sizeof (axis2_char_t) * 
                                                            (5  + ADB_DEFAULT_NAMESPACE_PREFIX_LIMIT +
                                                             axutil_strlen(_EncryptedDataType->property_Id) + 
                                                                axutil_strlen("Id")));
                           sprintf(text_value, " %s%s%s=\"%s\"", p_prefix?p_prefix:"", (p_prefix && axutil_strcmp(p_prefix, ""))?":":"",
                                                "Id", _EncryptedDataType->property_Id);
                           axutil_stream_write(stream, env, text_value, axutil_strlen(text_value));
                           AXIS2_FREE(env-> allocator, text_value);
                        
                   }
                   
                if(_EncryptedDataType->is_valid_Type)
                {
                
                        p_prefix = NULL;
                      
                           text_value = axutil_uri_to_string(_EncryptedDataType->property_Type, env, AXIS2_URI_UNP_OMITUSERINFO);
                ...
                if(_EncryptedDataType->is_valid_MimeType)
                {
                        ...
                        p_prefix = NULL;
                           ...
                           text_value = (axis2_char_t*) AXIS2_MALLOC (env-> allocator, sizeof (axis2_char_t) * 
                                                            (5  + ADB_DEFAULT_NAMESPACE_PREFIX_LIMIT +
                                                             axutil_strlen(_EncryptedDataType->property_MimeType) + 
                                                                axutil_strlen("MimeType")));
                           sprintf(text_value, " %s%s%s=\"%s\"", p_prefix?p_prefix:"", (p_prefix && axutil_strcmp(p_prefix, ""))?":":"",
                                                "MimeType", _EncryptedDataType->property_MimeType);
                           axutil_stream_write(stream, env, text_value, axutil_strlen(text_value));
                           AXIS2_FREE(env-> allocator, text_value);
                        
                   }
                   
                if(_EncryptedDataType->is_valid_Encoding)
                {
                
                        p_prefix = NULL;
                      
                           text_value = axutil_uri_to_string(_EncryptedDataType->property_Encoding, env, AXIS2_URI_UNP_OMITUSERINFO);
                           string_to_stream = (axis2_char_t*) AXIS2_MALLOC (env-> allocator, sizeof (axis2_char_t) *
                                                            (5  + ADB_DEFAULT_NAMESPACE_PREFIX_LIMIT +
                                                             axutil_strlen(text_value) + 
              ...
              type_attrib = axutil_strcat(env, " ", xsi_prefix, ":type=\"EncryptedDataType\"", NULL);
            ...
            xsi_ns = axiom_namespace_create (env,
                                 ...
                                 xsi_prefix);
            xsi_type_attri = axiom_attribute_create (env, "type", "EncryptedDataType", xsi_ns);
            ...
            axiom_element_add_attribute (parent_element, env, xsi_type_attri, parent);
                   ...
                   if (!_EncryptedDataType->is_valid_EncryptionMethod)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_EncryptionMethodType_serialize(_EncryptedDataType->property_EncryptionMethod, 
                   ...
                   if (!_EncryptedDataType->is_valid_KeyInfo)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_KeyInfoType_serialize(_EncryptedDataType->property_KeyInfo, 
                                                                                 env, current_node, parent_element,
                   ...
                   if (!_EncryptedDataType->is_valid_CipherData)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_CipherDataType_serialize(_EncryptedDataType->property_CipherData, 
                                                                                 env, current_node, parent_element,
                   ...
                   if (!_EncryptedDataType->is_valid_EncryptionProperties)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_EncryptionPropertiesType_serialize(_EncryptedDataType->property_EncryptionProperties, 
                                                                                 env, current_node, parent_element,
                    ...
                    if(parent_tag_closed)
                    {
                       if(_EncryptedDataType->is_valid_Id)
                       {
                           ...
                           text_value = _EncryptedDataType->property_Id;
                    ...
                    if(parent_tag_closed)
                    {
                       if(_EncryptedDataType->is_valid_MimeType)
                       {
                           ...
                           text_value = _EncryptedDataType->property_MimeType;
            ...
            adb_EncryptedDataType_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_EncryptedDataType_get_EncryptionMethod(_EncryptedDataType,
                                             env);
            }
            ...
            adb_EncryptedDataType_get_EncryptionMethod(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _EncryptedDataType->property_EncryptionMethod;
             }
            ...
            adb_EncryptedDataType_set_EncryptionMethod(
                    ...
                    adb_EncryptionMethodType_t*  arg_EncryptionMethod)
             {
                ...
                if(_EncryptedDataType->is_valid_EncryptionMethod &&
                        arg_EncryptionMethod == _EncryptedDataType->property_EncryptionMethod)
                {
                ...
                _EncryptedDataType->property_EncryptionMethod = arg_EncryptionMethod;
                        _EncryptedDataType->is_valid_EncryptionMethod = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
                ...
                if(_EncryptedDataType->property_EncryptionMethod != NULL)
                {
                   
                   adb_EncryptionMethodType_free(_EncryptedDataType->property_EncryptionMethod, env);
                     _EncryptedDataType->property_EncryptionMethod = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_TRUE);
               
               return !_EncryptedDataType->is_valid_EncryptionMethod;
           }
           ...
           adb_EncryptedDataType_set_EncryptionMethod_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_EncryptedDataType_reset_EncryptionMethod(_EncryptedDataType, env);
           }
            ...
            adb_EncryptedDataType_get_property2(
                ...
                const axutil_env_t *env)
            {
                return adb_EncryptedDataType_get_KeyInfo(_EncryptedDataType,
                                             env);
            }
            ...
            adb_EncryptedDataType_get_KeyInfo(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _EncryptedDataType->property_KeyInfo;
             }
            ...
            adb_EncryptedDataType_set_KeyInfo(
                    ...
                    adb_KeyInfoType_t*  arg_KeyInfo)
             {
                ...
                if(_EncryptedDataType->is_valid_KeyInfo &&
                        arg_KeyInfo == _EncryptedDataType->property_KeyInfo)
                {
                ...
                _EncryptedDataType->property_KeyInfo = arg_KeyInfo;
                        _EncryptedDataType->is_valid_KeyInfo = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
                ...
                if(_EncryptedDataType->property_KeyInfo != NULL)
                {
                   
                   adb_KeyInfoType_free(_EncryptedDataType->property_KeyInfo, env);
                     _EncryptedDataType->property_KeyInfo = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_EncryptedDataType->is_valid_KeyInfo;
           }
           ...
           adb_EncryptedDataType_set_KeyInfo_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_EncryptedDataType_reset_KeyInfo(_EncryptedDataType, env);
           }
            ...
            adb_EncryptedDataType_get_property3(
                ...
                const axutil_env_t *env)
            {
                return adb_EncryptedDataType_get_CipherData(_EncryptedDataType,
                                             env);
            }
            ...
            adb_EncryptedDataType_get_CipherData(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _EncryptedDataType->property_CipherData;
             }
            ...
            adb_EncryptedDataType_set_CipherData(
                    ...
                    adb_CipherDataType_t*  arg_CipherData)
             {
                ...
                if(_EncryptedDataType->is_valid_CipherData &&
                        arg_CipherData == _EncryptedDataType->property_CipherData)
                {
                ...
                _EncryptedDataType->property_CipherData = arg_CipherData;
                        _EncryptedDataType->is_valid_CipherData = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
                ...
                if(_EncryptedDataType->property_CipherData != NULL)
                {
                   
                   adb_CipherDataType_free(_EncryptedDataType->property_CipherData, env);
                     _EncryptedDataType->property_CipherData = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_EncryptedDataType->is_valid_CipherData;
           }
           ...
           adb_EncryptedDataType_set_CipherData_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_EncryptedDataType_reset_CipherData(_EncryptedDataType, env);
           }
            ...
            adb_EncryptedDataType_get_property4(
                ...
                const axutil_env_t *env)
            {
                return adb_EncryptedDataType_get_EncryptionProperties(_EncryptedDataType,
                                             env);
            }
            ...
            adb_EncryptedDataType_get_EncryptionProperties(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _EncryptedDataType->property_EncryptionProperties;
             }
            ...
            adb_EncryptedDataType_set_EncryptionProperties(
                    ...
                    adb_EncryptionPropertiesType_t*  arg_EncryptionProperties)
             {
                ...
                if(_EncryptedDataType->is_valid_EncryptionProperties &&
                        arg_EncryptionProperties == _EncryptedDataType->property_EncryptionProperties)
                {
                ...
                _EncryptedDataType->property_EncryptionProperties = arg_EncryptionProperties;
                        _EncryptedDataType->is_valid_EncryptionProperties = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
                ...
                if(_EncryptedDataType->property_EncryptionProperties != NULL)
                {
                   
                   adb_EncryptionPropertiesType_free(_EncryptedDataType->property_EncryptionProperties, env);
                     _EncryptedDataType->property_EncryptionProperties = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_EncryptedDataType->is_valid_EncryptionProperties;
           }
           ...
           adb_EncryptedDataType_set_EncryptionProperties_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_EncryptedDataType_reset_EncryptionProperties(_EncryptedDataType, env);
           }
            ...
            adb_EncryptedDataType_get_property5(
                ...
                const axutil_env_t *env)
            {
                return adb_EncryptedDataType_get_Id(_EncryptedDataType,
                                             env);
            }
            ...
            adb_EncryptedDataType_get_Id(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _EncryptedDataType->property_Id;
             }
            ...
            adb_EncryptedDataType_set_Id(
                    ...
                    const axis2_char_t*  arg_Id)
             {
                ...
                if(_EncryptedDataType->is_valid_Id &&
                        arg_Id == _EncryptedDataType->property_Id)
                {
                ...
                _EncryptedDataType->property_Id = (axis2_char_t *)axutil_strdup(env, arg_Id);
                        if(NULL == _EncryptedDataType->property_Id)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for Id");
                            return AXIS2_FAILURE;
                        }
                        _EncryptedDataType->is_valid_Id = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
                ...
                if(_EncryptedDataType->property_Id != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _EncryptedDataType->property_Id);
                     _EncryptedDataType->property_Id = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_EncryptedDataType->is_valid_Id;
           }
           ...
           adb_EncryptedDataType_set_Id_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_EncryptedDataType_reset_Id(_EncryptedDataType, env);
           }
            ...
            adb_EncryptedDataType_get_property6(
                ...
                const axutil_env_t *env)
            {
                return adb_EncryptedDataType_get_Type(_EncryptedDataType,
                                             env);
            }
            ...
            adb_EncryptedDataType_get_Type(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _EncryptedDataType->property_Type;
             }
            ...
            adb_EncryptedDataType_set_Type(
                    ...
                    axutil_uri_t*  arg_Type)
             {
                ...
                if(_EncryptedDataType->is_valid_Type &&
                        arg_Type == _EncryptedDataType->property_Type)
                {
                ...
                _EncryptedDataType->property_Type = arg_Type;
                        _EncryptedDataType->is_valid_Type = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
                ...
                if(_EncryptedDataType->property_Type != NULL)
                {
                   
                   
                      axutil_uri_free(_EncryptedDataType->property_Type, env);
                     _EncryptedDataType->property_Type = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_EncryptedDataType->is_valid_Type;
           }
           ...
           adb_EncryptedDataType_set_Type_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_EncryptedDataType_reset_Type(_EncryptedDataType, env);
           }
            ...
            adb_EncryptedDataType_get_property7(
                ...
                const axutil_env_t *env)
            {
                return adb_EncryptedDataType_get_MimeType(_EncryptedDataType,
                                             env);
            }
            ...
            adb_EncryptedDataType_get_MimeType(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _EncryptedDataType->property_MimeType;
             }
            ...
            adb_EncryptedDataType_set_MimeType(
                    ...
                    const axis2_char_t*  arg_MimeType)
             {
                ...
                if(_EncryptedDataType->is_valid_MimeType &&
                        arg_MimeType == _EncryptedDataType->property_MimeType)
                {
                ...
                _EncryptedDataType->property_MimeType = (axis2_char_t *)axutil_strdup(env, arg_MimeType);
                        if(NULL == _EncryptedDataType->property_MimeType)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for MimeType");
                            return AXIS2_FAILURE;
                        }
                        _EncryptedDataType->is_valid_MimeType = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
                ...
                if(_EncryptedDataType->property_MimeType != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _EncryptedDataType->property_MimeType);
                     _EncryptedDataType->property_MimeType = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_EncryptedDataType->is_valid_MimeType;
           }
           ...
           adb_EncryptedDataType_set_MimeType_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_EncryptedDataType_reset_MimeType(_EncryptedDataType, env);
           }
            ...
            adb_EncryptedDataType_get_property8(
                ...
                const axutil_env_t *env)
            {
                return adb_EncryptedDataType_get_Encoding(_EncryptedDataType,
                                             env);
            }
            ...
            adb_EncryptedDataType_get_Encoding(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _EncryptedDataType->property_Encoding;
             }
            ...
            adb_EncryptedDataType_set_Encoding(
                    ...
                    axutil_uri_t*  arg_Encoding)
             {
                ...
                if(_EncryptedDataType->is_valid_Encoding &&
                        arg_Encoding == _EncryptedDataType->property_Encoding)
                {
                ...
                _EncryptedDataType->property_Encoding = arg_Encoding;
                        _EncryptedDataType->is_valid_Encoding = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _EncryptedDataType, AXIS2_FAILURE);
                ...
                if(_EncryptedDataType->property_Encoding != NULL)
                {
                   
                   
                      axutil_uri_free(_EncryptedDataType->property_Encoding, env);
                     _EncryptedDataType->property_Encoding = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_EncryptedDataType->is_valid_Encoding;
           }
           ...
           adb_EncryptedDataType_set_Encoding_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_EncryptedDataType_reset_Encoding(_EncryptedDataType, env);
           }
