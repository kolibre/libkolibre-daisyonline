 ...
 */
        ...
        #ifndef ADB_INTERNALSERVERERRORFAULTTYPE_H
        #define ADB_INTERNALSERVERERRORFAULTTYPE_H

       /**
        * adb_internalServerErrorFaultType.h
        *
       ...
       /**
        *  adb_internalServerErrorFaultType class
        */
        ...
        typedef struct adb_internalServerErrorFaultType adb_internalServerErrorFaultType_t;
        ...
        /**
         * Constructor for creating adb_internalServerErrorFaultType_t
         * @param env pointer to environment struct
         * @return newly created adb_internalServerErrorFaultType_t object
         */
         ...
         * @param  _internalServerErrorFaultType adb_internalServerErrorFaultType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_internalServerErrorFaultType_t object
         * @param  _internalServerErrorFaultType adb_internalServerErrorFaultType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for reason. 
         * @param  _internalServerErrorFaultType adb_internalServerErrorFaultType_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_internalServerErrorFaultType_declare_parent_namespaces(
        ...
        /**
         * Check whether the adb_internalServerErrorFaultType is a particle class (E.g. group, inner sequence)
        ...
        adb_internalServerErrorFaultType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_internalServerErrorFaultType_t object and return the property value.
     ...
     #endif /* ADB_INTERNALSERVERERRORFAULTTYPE_H */
