 ...
 */
        ...
        #ifndef ADB_CONTENTMETADATA_H
        #define ADB_CONTENTMETADATA_H

       /**
        * adb_contentMetadata.h
        *
        ...
        */
        ...
        typedef struct adb_contentMetadata adb_contentMetadata_t;
        ...
        /**
         * Constructor for creating adb_contentMetadata_t
         * @param env pointer to environment struct
         * @return newly created adb_contentMetadata_t object
         */
         ...
         * @param  _contentMetadata adb_contentMetadata_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_contentMetadata_t object
         * @param  _contentMetadata adb_contentMetadata_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for sample. 
         * @param  _contentMetadata adb_contentMetadata_t object
         * @param env pointer to environment struct
       ...
       adb_contentMetadata_declare_parent_namespaces(
         ...
         * @param  _contentMetadata adb_contentMetadata_t object
         * @param env pointer to environment struct
         * @param contentMetadata_om_node node to serialize from
         * @param contentMetadata_om_element parent element to serialize from
        ...
        adb_contentMetadata_serialize(
            adb_contentMetadata_t* _contentMetadata,
            const axutil_env_t *env,
            axiom_node_t* contentMetadata_om_node, axiom_element_t *contentMetadata_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_contentMetadata is a particle class (E.g. group, inner sequence)
        ...
        adb_contentMetadata_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_contentMetadata_t object and return the property value.
