 ...
 */
        ...
        #ifndef ADB_MULTIPLECHOICEQUESTION_TYPE0_H
        #define ADB_MULTIPLECHOICEQUESTION_TYPE0_H

       /**
        * adb_multipleChoiceQuestion_type0.h
        *
       ...
       /**
        *  adb_multipleChoiceQuestion_type0 class
        */
        ...
        typedef struct adb_multipleChoiceQuestion_type0 adb_multipleChoiceQuestion_type0_t;
        ...
        /**
         * Constructor for creating adb_multipleChoiceQuestion_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_multipleChoiceQuestion_type0_t object
         */
         ...
         * @param  _multipleChoiceQuestion_type0 adb_multipleChoiceQuestion_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_multipleChoiceQuestion_type0_t object
         * @param  _multipleChoiceQuestion_type0 adb_multipleChoiceQuestion_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for label. 
         * @param  _multipleChoiceQuestion_type0 adb_multipleChoiceQuestion_type0_t object
         * @param env pointer to environment struct
         ...
         * @param  _multipleChoiceQuestion_type0 adb_multipleChoiceQuestion_type0_t object
         * @param env pointer to environment struct
         * @param arg_choices adb_choices_type0_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _multipleChoiceQuestion_type0 adb_multipleChoiceQuestion_type0_t object
         * @param env pointer to environment struct
         * @param arg_allowMultipleSelections axis2_bool_t
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_multipleChoiceQuestion_type0_declare_parent_namespaces(
         ...
         * @param  _multipleChoiceQuestion_type0 adb_multipleChoiceQuestion_type0_t object
         * @param env pointer to environment struct
         * @param multipleChoiceQuestion_type0_om_node node to serialize from
         * @param multipleChoiceQuestion_type0_om_element parent element to serialize from
        ...
        adb_multipleChoiceQuestion_type0_serialize(
            adb_multipleChoiceQuestion_type0_t* _multipleChoiceQuestion_type0,
            const axutil_env_t *env,
            axiom_node_t* multipleChoiceQuestion_type0_om_node, axiom_element_t *multipleChoiceQuestion_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_multipleChoiceQuestion_type0 is a particle class (E.g. group, inner sequence)
         ...
         * @param _choices adb_choices_type0_t*
         * @param _id axis2_char_t*
         * @param _allowMultipleSelections axis2_bool_t
         * @return newly created adb_multipleChoiceQuestion_type0_t object
         */
        adb_multipleChoiceQuestion_type0_t* AXIS2_CALL
        adb_multipleChoiceQuestion_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_multipleChoiceQuestion_type0_t object and return the property value.
     ...
     #endif /* ADB_MULTIPLECHOICEQUESTION_TYPE0_H */
