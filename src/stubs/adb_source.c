 ...
 */
        ...
        #include "adb_source.h"
               ...
               /*
                * implmentation of the source|http://purl.org/dc/elements/1.1/ element
                */
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_source_create(
            const axutil_env_t *env)
        {
            adb_source_t *_source = NULL;
            
                axutil_qname_t* qname = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _source = (adb_source_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_source_t));
            ...
            memset(_source, 0, sizeof(adb_source_t));

            _source->property_TypeName = axutil_strdup(env, "adb_source");
            _source->is_valid_source  = AXIS2_FALSE;
        ...
        {
            adb_source_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_source_create(env);

            
              status = adb_source_set_source(
                                     adb_obj,
                                     env,
                                     _source);
              if(status == AXIS2_FAILURE) {
                  adb_source_free (adb_obj, env);
                  return NULL;
              }
        ...
        axiom_node_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _source->property_source;

                    adb_source_free(_source, env);
                ...
                const axutil_env_t *env)
        {
            ...
            if (_source->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _source->property_TypeName);
            }

            adb_source_reset_source(_source, env);
            
              if(_source->qname)
              {
                  axutil_qname_free (_source->qname, env);
                  _source->qname = NULL;
              }
            ...
            if(_source)
            {
                AXIS2_FREE(env->allocator, _source);
                _source = NULL;
            }
                ...
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            return adb_source_deserialize_obj(
                _source,
                env,
                dp_parent,
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
                ...
                return adb_source_serialize_obj(
                    _source, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axiom_attribute_t* xsi_type_attri = NULL;
            ...
            adb_source_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_source_get_source(_source,
                                             env);
            }
            ...
            adb_source_get_source(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _source->property_source;
             }
            ...
            adb_source_set_source(
                    ...
                    axiom_node_t*  arg_source)
             {
                ...
                if(_source->is_valid_source &&
                        arg_source == _source->property_source)
                {
                ...
                _source->property_source = arg_source;
                        _source->is_valid_source = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _source, AXIS2_TRUE);
               
               return !_source->is_valid_source;
           }
           ...
           adb_source_set_source_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_source_reset_source(_source, env);
           }
