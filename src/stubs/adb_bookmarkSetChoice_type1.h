 ...
 */
        ...
        #ifndef ADB_BOOKMARKSETCHOICE_TYPE1_H
        #define ADB_BOOKMARKSETCHOICE_TYPE1_H

       /**
        * adb_bookmarkSetChoice_type1.h
        *
       ...
       /**
        *  adb_bookmarkSetChoice_type1 class
        */
        ...
        typedef struct adb_bookmarkSetChoice_type1 adb_bookmarkSetChoice_type1_t;
        ...
        /**
         * Constructor for creating adb_bookmarkSetChoice_type1_t
         * @param env pointer to environment struct
         * @return newly created adb_bookmarkSetChoice_type1_t object
         */
         ...
         * @param  _bookmarkSetChoice_type1 adb_bookmarkSetChoice_type1_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_bookmarkSetChoice_type1_t object
         * @param  _bookmarkSetChoice_type1 adb_bookmarkSetChoice_type1_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for bookmark. 
         * @param  _bookmarkSetChoice_type1 adb_bookmarkSetChoice_type1_t object
         * @param env pointer to environment struct
       ...
       adb_bookmarkSetChoice_type1_declare_parent_namespaces(
         ...
         * @param  _bookmarkSetChoice_type1 adb_bookmarkSetChoice_type1_t object
         * @param env pointer to environment struct
         * @param bookmarkSetChoice_type1_om_node node to serialize from
         * @param bookmarkSetChoice_type1_om_element parent element to serialize from
        ...
        adb_bookmarkSetChoice_type1_serialize(
            adb_bookmarkSetChoice_type1_t* _bookmarkSetChoice_type1,
            const axutil_env_t *env,
            axiom_node_t* bookmarkSetChoice_type1_om_node, axiom_element_t *bookmarkSetChoice_type1_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_bookmarkSetChoice_type1 is a particle class (E.g. group, inner sequence)
        ...
        adb_bookmarkSetChoice_type1_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_bookmarkSetChoice_type1_t object and return the property value.
     ...
     #endif /* ADB_BOOKMARKSETCHOICE_TYPE1_H */
