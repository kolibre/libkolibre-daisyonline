 ...
 */
        ...
        #ifndef ADB_KEYNAME_H
        #define ADB_KEYNAME_H
        ...
        */
        ...
        typedef struct adb_KeyName adb_KeyName_t;
        ...
        /**
         * Constructor for creating adb_KeyName_t
         * @param env pointer to environment struct
         * @return newly created adb_KeyName_t object
         */
         ...
         * @param  _KeyName adb_KeyName_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for KeyName. 
         * @param  _KeyName adb_KeyName_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_KeyName_declare_parent_namespaces(
         ...
         * @param  _KeyName adb_KeyName_t object
         * @param env pointer to environment struct
         * @param KeyName_om_node node to serialize from
         * @param KeyName_om_element parent element to serialize from
        ...
        adb_KeyName_serialize(
            adb_KeyName_t* _KeyName,
            const axutil_env_t *env,
            axiom_node_t* KeyName_om_node, axiom_element_t *KeyName_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_KeyName is a particle class (E.g. group, inner sequence)
        ...
        adb_KeyName_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_KeyName_t object and return the property value.
