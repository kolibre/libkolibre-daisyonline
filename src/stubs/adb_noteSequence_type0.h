 ...
 */
        ...
        #ifndef ADB_NOTESEQUENCE_TYPE0_H
        #define ADB_NOTESEQUENCE_TYPE0_H

       /**
        * adb_noteSequence_type0.h
        *
        ...
        */
        ...
        typedef struct adb_noteSequence_type0 adb_noteSequence_type0_t;
        ...
        /**
         * Constructor for creating adb_noteSequence_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_noteSequence_type0_t object
         */
         ...
         * @param  _noteSequence_type0 adb_noteSequence_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_noteSequence_type0_t object
         * @param  _noteSequence_type0 adb_noteSequence_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for text. 
         * @param  _noteSequence_type0 adb_noteSequence_type0_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_noteSequence_type0_declare_parent_namespaces(
         ...
         * @param  _noteSequence_type0 adb_noteSequence_type0_t object
         * @param env pointer to environment struct
         * @param noteSequence_type0_om_node node to serialize from
         * @param noteSequence_type0_om_element parent element to serialize from
        ...
        adb_noteSequence_type0_serialize(
            adb_noteSequence_type0_t* _noteSequence_type0,
            const axutil_env_t *env,
            axiom_node_t* noteSequence_type0_om_node, axiom_element_t *noteSequence_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_noteSequence_type0 is a particle class (E.g. group, inner sequence)
        ...
        adb_noteSequence_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_noteSequence_type0_t object and return the property value.
     ...
     #endif /* ADB_NOTESEQUENCE_TYPE0_H */
