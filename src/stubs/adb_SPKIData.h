 ...
 */
        ...
        #ifndef ADB_SPKIDATA_H
        #define ADB_SPKIDATA_H
        ...
        */
        ...
        typedef struct adb_SPKIData adb_SPKIData_t;
        ...
        /**
         * Constructor for creating adb_SPKIData_t
         * @param env pointer to environment struct
         * @return newly created adb_SPKIData_t object
         */
         ...
         * @param  _SPKIData adb_SPKIData_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for SPKIData. 
         * @param  _SPKIData adb_SPKIData_t object
         * @param env pointer to environment struct
       ...
       adb_SPKIData_declare_parent_namespaces(
         ...
         * @param  _SPKIData adb_SPKIData_t object
         * @param env pointer to environment struct
         * @param SPKIData_om_node node to serialize from
         * @param SPKIData_om_element parent element to serialize from
        ...
        adb_SPKIData_serialize(
            adb_SPKIData_t* _SPKIData,
            const axutil_env_t *env,
            axiom_node_t* SPKIData_om_node, axiom_element_t *SPKIData_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SPKIData is a particle class (E.g. group, inner sequence)
        ...
        adb_SPKIData_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SPKIData_t object and return the property value.
