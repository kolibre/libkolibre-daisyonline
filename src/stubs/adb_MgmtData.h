 ...
 */
        ...
        #ifndef ADB_MGMTDATA_H
        #define ADB_MGMTDATA_H
        ...
        */
        ...
        typedef struct adb_MgmtData adb_MgmtData_t;
        ...
        /**
         * Constructor for creating adb_MgmtData_t
         * @param env pointer to environment struct
         * @return newly created adb_MgmtData_t object
         */
         ...
         * @param  _MgmtData adb_MgmtData_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for MgmtData. 
         * @param  _MgmtData adb_MgmtData_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_MgmtData_declare_parent_namespaces(
         ...
         * @param  _MgmtData adb_MgmtData_t object
         * @param env pointer to environment struct
         * @param MgmtData_om_node node to serialize from
         * @param MgmtData_om_element parent element to serialize from
        ...
        adb_MgmtData_serialize(
            adb_MgmtData_t* _MgmtData,
            const axutil_env_t *env,
            axiom_node_t* MgmtData_om_node, axiom_element_t *MgmtData_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_MgmtData is a particle class (E.g. group, inner sequence)
        ...
        adb_MgmtData_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_MgmtData_t object and return the property value.
