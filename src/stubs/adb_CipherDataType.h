 ...
 */
        ...
        #ifndef ADB_CIPHERDATATYPE_H
        #define ADB_CIPHERDATATYPE_H

       /**
        * adb_CipherDataType.h
        *
        ...
        */
        ...
        typedef struct adb_CipherDataType adb_CipherDataType_t;
        ...
        /**
         * Constructor for creating adb_CipherDataType_t
         * @param env pointer to environment struct
         * @return newly created adb_CipherDataType_t object
         */
         ...
         * @param  _CipherDataType adb_CipherDataType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_CipherDataType_t object
         * @param  _CipherDataType adb_CipherDataType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _CipherDataType adb_CipherDataType_t object
         * @param env pointer to environment struct
         ...
         * @param  _CipherDataType adb_CipherDataType_t object
         * @param env pointer to environment struct
         * @param arg_CipherValue axutil_base64_binary_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_CipherDataType_declare_parent_namespaces(
         ...
         * @param  _CipherDataType adb_CipherDataType_t object
         * @param env pointer to environment struct
         * @param CipherDataType_om_node node to serialize from
         * @param CipherDataType_om_element parent element to serialize from
        ...
        adb_CipherDataType_serialize(
            adb_CipherDataType_t* _CipherDataType,
            const axutil_env_t *env,
            axiom_node_t* CipherDataType_om_node, axiom_element_t *CipherDataType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_CipherDataType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_CipherDataType_t
         * @param env pointer to environment struct
         * @param _CipherValue axutil_base64_binary_t*
        ...
        adb_CipherDataType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_CipherDataType_t object and return the property value.
