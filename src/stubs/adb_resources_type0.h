 ...
 */
        ...
        #ifndef ADB_RESOURCES_TYPE0_H
        #define ADB_RESOURCES_TYPE0_H

       /**
        * adb_resources_type0.h
        *
        ...
        */
        ...
        typedef struct adb_resources_type0 adb_resources_type0_t;
        ...
        /**
         * Constructor for creating adb_resources_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_resources_type0_t object
         */
         ...
         * @param  _resources_type0 adb_resources_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_resources_type0_t object
         * @param  _resources_type0 adb_resources_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for resource. Deprecated for array types, Use adb_resources_type0_get_resource_at instead
         * @param  _resources_type0 adb_resources_type0_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for resource.Deprecated for array types, Use adb_resources_type0_set_resource_at
         * or adb_resources_type0_add_resource instead.
         * @param  _resources_type0 adb_resources_type0_t object
         * @param env pointer to environment struct
         ...
         * @param  _resources_type0 _ adb_resources_type0_t object
         * @param env pointer to environment struct.
       ...
       adb_resources_type0_declare_parent_namespaces(
         ...
         * @param  _resources_type0 adb_resources_type0_t object
         * @param env pointer to environment struct
         * @param resources_type0_om_node node to serialize from
         * @param resources_type0_om_element parent element to serialize from
        ...
        adb_resources_type0_serialize(
            adb_resources_type0_t* _resources_type0,
            const axutil_env_t *env,
            axiom_node_t* resources_type0_om_node, axiom_element_t *resources_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_resources_type0 is a particle class (E.g. group, inner sequence)
        ...
        adb_resources_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_resources_type0_t object and return the property value.
