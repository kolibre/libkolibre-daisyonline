 ...
 */
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_contentMetadata_type0_set_sample_nil(
                        adb_contentMetadata_type0_t* _contentMetadata_type0,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_contentMetadata_type0_set_metadata_nil(
                        adb_contentMetadata_type0_t* _contentMetadata_type0,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_contentMetadata_type0_set_requiresReturn_nil(
                        adb_contentMetadata_type0_t* _contentMetadata_type0,
                        const axutil_env_t *env);
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_contentMetadata_type0_create(
            const axutil_env_t *env)
        {
            adb_contentMetadata_type0_t *_contentMetadata_type0 = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _contentMetadata_type0 = (adb_contentMetadata_type0_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_contentMetadata_type0_t));

            if(NULL == _contentMetadata_type0)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_contentMetadata_type0, 0, sizeof(adb_contentMetadata_type0_t));

            _contentMetadata_type0->property_TypeName = axutil_strdup(env, "adb_contentMetadata_type0");
            _contentMetadata_type0->property_sample  = NULL;
                  _contentMetadata_type0->is_valid_sample  = AXIS2_FALSE;
            _contentMetadata_type0->property_metadata  = NULL;
                  _contentMetadata_type0->is_valid_metadata  = AXIS2_FALSE;
            _contentMetadata_type0->property_category  = NULL;
                  _contentMetadata_type0->is_valid_category  = AXIS2_FALSE;
            _contentMetadata_type0->is_valid_requiresReturn  = AXIS2_FALSE;
            

            return _contentMetadata_type0;
        }
        ...
        {
            adb_contentMetadata_type0_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_contentMetadata_type0_create(env);

            
              status = adb_contentMetadata_type0_set_sample(
                                     adb_obj,
                                     env,
                                     _sample);
              if(status == AXIS2_FAILURE) {
                  adb_contentMetadata_type0_free (adb_obj, env);
                  return NULL;
              }
            
              status = adb_contentMetadata_type0_set_metadata(
                                     adb_obj,
                                     env,
                                     _metadata);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_contentMetadata_type0_set_category(
                                     adb_obj,
                                     env,
                                     _category);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_contentMetadata_type0_set_requiresReturn(
                                     adb_obj,
                                     env,
                                     _requiresReturn);
              if(status == AXIS2_FAILURE) {
        ...
        adb_sample_type0_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _contentMetadata_type0->property_sample;

                    _contentMetadata_type0->property_sample = (adb_sample_type0_t*)NULL;
                    adb_contentMetadata_type0_free(_contentMetadata_type0, env);
                ...
                const axutil_env_t *env)
        {
            ...
            return axis2_extension_mapper_free(
                (adb_stubtype_t*) _contentMetadata_type0,
                env,
                "adb_contentMetadata_type0");
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _contentMetadata_type0, AXIS2_FAILURE);

            if (_contentMetadata_type0->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _contentMetadata_type0->property_TypeName);
            }

            adb_contentMetadata_type0_reset_sample(_contentMetadata_type0, env);
            adb_contentMetadata_type0_reset_metadata(_contentMetadata_type0, env);
            adb_contentMetadata_type0_reset_category(_contentMetadata_type0, env);
            adb_contentMetadata_type0_reset_requiresReturn(_contentMetadata_type0, env);
            

            if(_contentMetadata_type0)
            {
                AXIS2_FREE(env->allocator, _contentMetadata_type0);
                _contentMetadata_type0 = NULL;
            }
            ...
            AXIS2_PARAM_CHECK(env->error, _contentMetadata_type0, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                            "Failed in building adb object for contentMetadata_type0 : "
                ...
                return AXIS2_FAILURE;
                 ...
                 attribute_hash = axiom_element_get_all_attributes(parent_element, env);
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_contentMetadata_type0_set_sample(_contentMetadata_type0, env,
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_contentMetadata_type0_set_metadata(_contentMetadata_type0, env,
                  ...
                  if(attrib_text != NULL)
                  {
                      ...
                      adb_contentMetadata_type0_set_category(_contentMetadata_type0,
                                                          env, attrib_text);
                  ...
                  if(attrib_text != NULL)
                  {
                           ...
                           {
                               adb_contentMetadata_type0_set_requiresReturn(_contentMetadata_type0,
                                                          env, AXIS2_TRUE);
                           }
                           else
                           {
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            ...
            if (_contentMetadata_type0 == NULL)
            {
                return adb_contentMetadata_type0_serialize_obj(
                    _contentMetadata_type0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            }
            else
            {
                return axis2_extension_mapper_serialize(
                    (adb_stubtype_t*) _contentMetadata_type0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index, "adb_contentMetadata_type0");
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axis2_char_t* type_attrib = NULL;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _contentMetadata_type0, NULL);
            ...
            if(!parent_tag_closed)
            {
                ...
                if(_contentMetadata_type0->is_valid_category)
                {
                        ...
                        p_prefix = NULL;
                           ...
                           text_value = (axis2_char_t*) AXIS2_MALLOC (env-> allocator, sizeof (axis2_char_t) * 
                                                            (5  + ADB_DEFAULT_NAMESPACE_PREFIX_LIMIT +
                                                             axutil_strlen(_contentMetadata_type0->property_category) + 
                                                                axutil_strlen("category")));
                           sprintf(text_value, " %s%s%s=\"%s\"", p_prefix?p_prefix:"", (p_prefix && axutil_strcmp(p_prefix, ""))?":":"",
                                                "category", _contentMetadata_type0->property_category);
                           axutil_stream_write(stream, env, text_value, axutil_strlen(text_value));
                           AXIS2_FREE(env-> allocator, text_value);
                        
                   }
                   
                if(_contentMetadata_type0->is_valid_requiresReturn)
                {
                
                        p_prefix = NULL;
                      
                           
                           text_value = (axis2_char_t*)((_contentMetadata_type0->property_requiresReturn)?"true":"false");
              ...
              type_attrib = axutil_strcat(env, " ", xsi_prefix, ":type=\"contentMetadata_type0\"", NULL);
            ...
            xsi_ns = axiom_namespace_create (env,
                                 ...
                                 xsi_prefix);
            xsi_type_attri = axiom_attribute_create (env, "type", "contentMetadata_type0", xsi_ns);
            ...
            axiom_element_add_attribute (parent_element, env, xsi_type_attri, parent);
                   ...
                   if (!_contentMetadata_type0->is_valid_sample)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_sample_type0_serialize(_contentMetadata_type0->property_sample, 
                   ...
                   if (!_contentMetadata_type0->is_valid_metadata)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_metadata_type0_serialize(_contentMetadata_type0->property_metadata, 
                                                                                 env, current_node, parent_element,
                    ...
                    if(parent_tag_closed)
                    {
                       if(_contentMetadata_type0->is_valid_category)
                       {
                           ...
                           text_value = _contentMetadata_type0->property_category;
                    ...
                    if(parent_tag_closed)
                    {
                       if(_contentMetadata_type0->is_valid_requiresReturn)
                       {
                           ...
                           text_value =  (axis2_char_t*)((_contentMetadata_type0->property_requiresReturn)?axutil_strdup(env, "true"):axutil_strdup(env, "false"));
            ...
            adb_contentMetadata_type0_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_contentMetadata_type0_get_sample(_contentMetadata_type0,
                                             env);
            }
            ...
            adb_contentMetadata_type0_get_sample(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _contentMetadata_type0->property_sample;
             }
            ...
            adb_contentMetadata_type0_set_sample(
                    ...
                    adb_sample_type0_t*  arg_sample)
             {
                ...
                if(_contentMetadata_type0->is_valid_sample &&
                        arg_sample == _contentMetadata_type0->property_sample)
                {
                ...
                _contentMetadata_type0->property_sample = arg_sample;
                        _contentMetadata_type0->is_valid_sample = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _contentMetadata_type0, AXIS2_FAILURE);
                ...
                if(_contentMetadata_type0->property_sample != NULL)
                {
                   
                   adb_sample_type0_free(_contentMetadata_type0->property_sample, env);
                     _contentMetadata_type0->property_sample = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _contentMetadata_type0, AXIS2_TRUE);
               
               return !_contentMetadata_type0->is_valid_sample;
           }
           ...
           adb_contentMetadata_type0_set_sample_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_contentMetadata_type0_reset_sample(_contentMetadata_type0, env);
           }
            ...
            adb_contentMetadata_type0_get_property2(
                ...
                const axutil_env_t *env)
            {
                return adb_contentMetadata_type0_get_metadata(_contentMetadata_type0,
                                             env);
            }
            ...
            adb_contentMetadata_type0_get_metadata(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _contentMetadata_type0->property_metadata;
             }
            ...
            adb_contentMetadata_type0_set_metadata(
                    ...
                    adb_metadata_type0_t*  arg_metadata)
             {
                ...
                if(_contentMetadata_type0->is_valid_metadata &&
                        arg_metadata == _contentMetadata_type0->property_metadata)
                {
                ...
                _contentMetadata_type0->property_metadata = arg_metadata;
                        _contentMetadata_type0->is_valid_metadata = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _contentMetadata_type0, AXIS2_FAILURE);
                ...
                if(_contentMetadata_type0->property_metadata != NULL)
                {
                   
                   adb_metadata_type0_free(_contentMetadata_type0->property_metadata, env);
                     _contentMetadata_type0->property_metadata = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_contentMetadata_type0->is_valid_metadata;
           }
           ...
           adb_contentMetadata_type0_set_metadata_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_contentMetadata_type0_reset_metadata(_contentMetadata_type0, env);
           }
            ...
            adb_contentMetadata_type0_get_property3(
                ...
                const axutil_env_t *env)
            {
                return adb_contentMetadata_type0_get_category(_contentMetadata_type0,
                                             env);
            }
            ...
            adb_contentMetadata_type0_get_category(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _contentMetadata_type0->property_category;
             }
            ...
            adb_contentMetadata_type0_set_category(
                    ...
                    const axis2_char_t*  arg_category)
             {
                ...
                if(_contentMetadata_type0->is_valid_category &&
                        arg_category == _contentMetadata_type0->property_category)
                {
                ...
                _contentMetadata_type0->property_category = (axis2_char_t *)axutil_strdup(env, arg_category);
                        if(NULL == _contentMetadata_type0->property_category)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for category");
                            return AXIS2_FAILURE;
                        }
                        _contentMetadata_type0->is_valid_category = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _contentMetadata_type0, AXIS2_FAILURE);
                ...
                if(_contentMetadata_type0->property_category != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _contentMetadata_type0->property_category);
                     _contentMetadata_type0->property_category = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_contentMetadata_type0->is_valid_category;
           }
           ...
           adb_contentMetadata_type0_set_category_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_contentMetadata_type0_reset_category(_contentMetadata_type0, env);
           }
            ...
            adb_contentMetadata_type0_get_property4(
                ...
                const axutil_env_t *env)
            {
                return adb_contentMetadata_type0_get_requiresReturn(_contentMetadata_type0,
                                             env);
            }
            ...
            adb_contentMetadata_type0_get_requiresReturn(
                    ...
                    const axutil_env_t *env)
             {
                    ...
                    AXIS2_PARAM_CHECK(env->error, _contentMetadata_type0, (axis2_bool_t)0);
                  

                return _contentMetadata_type0->property_requiresReturn;
             }
            ...
            adb_contentMetadata_type0_set_requiresReturn(
                    ...
                    axis2_bool_t  arg_requiresReturn)
             {
                ...
                if(_contentMetadata_type0->is_valid_requiresReturn &&
                        arg_requiresReturn == _contentMetadata_type0->property_requiresReturn)
                {
                ...
                _contentMetadata_type0->property_requiresReturn = arg_requiresReturn;
                        _contentMetadata_type0->is_valid_requiresReturn = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_contentMetadata_type0->is_valid_requiresReturn;
           }
           ...
           adb_contentMetadata_type0_set_requiresReturn_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_contentMetadata_type0_reset_requiresReturn(_contentMetadata_type0, env);
           }
