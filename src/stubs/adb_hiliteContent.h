 ...
 */
        ...
        #ifndef ADB_HILITECONTENT_H
        #define ADB_HILITECONTENT_H
        ...
        */
        ...
        typedef struct adb_hiliteContent adb_hiliteContent_t;
        ...
        /**
         * Constructor for creating adb_hiliteContent_t
         * @param env pointer to environment struct
         * @return newly created adb_hiliteContent_t object
         */
         ...
         * @param  _hiliteContent adb_hiliteContent_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_hiliteContent_t object
         * @param  _hiliteContent adb_hiliteContent_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for ncxRef. 
         * @param  _hiliteContent adb_hiliteContent_t object
         * @param env pointer to environment struct
         * @return axutil_uri_t*
         */
         ...
         * @param  _hiliteContent adb_hiliteContent_t object
         * @param env pointer to environment struct
         * @return adb_hiliteContentChoice_type0_t*
         */
         ...
         * @param  _hiliteContent adb_hiliteContent_t object
         * @param env pointer to environment struct
         * @param arg_hiliteContentChoice_type0 adb_hiliteContentChoice_type0_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_hiliteContent_declare_parent_namespaces(
         ...
         * @param  _hiliteContent adb_hiliteContent_t object
         * @param env pointer to environment struct
         * @param hiliteContent_om_node node to serialize from
         * @param hiliteContent_om_element parent element to serialize from
        ...
        adb_hiliteContent_serialize(
            adb_hiliteContent_t* _hiliteContent,
            const axutil_env_t *env,
            axiom_node_t* hiliteContent_om_node, axiom_element_t *hiliteContent_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_hiliteContent is a particle class (E.g. group, inner sequence)
         ...
         * @param _hiliteContentChoice_type0 adb_hiliteContentChoice_type0_t*
         * @return newly created adb_hiliteContent_t object
         */
        adb_hiliteContent_t* AXIS2_CALL
        adb_hiliteContent_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_hiliteContent_t object and return the property value.
