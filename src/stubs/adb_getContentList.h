 ...
 */
        ...
        #ifndef ADB_GETCONTENTLIST_H
        #define ADB_GETCONTENTLIST_H

       /**
        * adb_getContentList.h
        *
        ...
        */
        ...
        typedef struct adb_getContentList adb_getContentList_t;
        ...
        /**
         * Constructor for creating adb_getContentList_t
         * @param env pointer to environment struct
         * @return newly created adb_getContentList_t object
         */
         ...
         * @param  _getContentList adb_getContentList_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getContentList_t object
         * @param  _getContentList adb_getContentList_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for id. 
         * @param  _getContentList adb_getContentList_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getContentList_declare_parent_namespaces(
         ...
         * @param  _getContentList adb_getContentList_t object
         * @param env pointer to environment struct
         * @param getContentList_om_node node to serialize from
         * @param getContentList_om_element parent element to serialize from
        ...
        adb_getContentList_serialize(
            adb_getContentList_t* _getContentList,
            const axutil_env_t *env,
            axiom_node_t* getContentList_om_node, axiom_element_t *getContentList_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getContentList is a particle class (E.g. group, inner sequence)
        ...
        adb_getContentList_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getContentList_t object and return the property value.
