 ...
 */
        ...
        #ifndef ADB_KEYINFOTYPE_H
        #define ADB_KEYINFOTYPE_H
        ...
        */
        ...
        typedef struct adb_KeyInfoType adb_KeyInfoType_t;
        ...
        /**
         * Constructor for creating adb_KeyInfoType_t
         * @param env pointer to environment struct
         * @return newly created adb_KeyInfoType_t object
         */
         ...
         * @param  _KeyInfoType adb_KeyInfoType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for KeyInfoTypeChoice. Deprecated for array types, Use adb_KeyInfoType_get_KeyInfoTypeChoice_at instead
         * @param  _KeyInfoType adb_KeyInfoType_t object
         * @param env pointer to environment struct
         * @return Array of adb_KeyInfoTypeChoice_t*s.
         */
        ...
        /**
         * Setter for KeyInfoTypeChoice.Deprecated for array types, Use adb_KeyInfoType_set_KeyInfoTypeChoice_at
         * or adb_KeyInfoType_add_KeyInfoTypeChoice instead.
         * @param  _KeyInfoType adb_KeyInfoType_t object
         * @param env pointer to environment struct
         * @param arg_KeyInfoTypeChoice Array of adb_KeyInfoTypeChoice_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of KeyInfoTypeChoice.
         * @param  _KeyInfoType adb_KeyInfoType_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @return ith adb_KeyInfoTypeChoice_t* of the array
         */
        ...
        /**
         * Set the ith element of KeyInfoTypeChoice. (If the ith already exist, it will be replaced)
         * @param  _KeyInfoType adb_KeyInfoType_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_KeyInfoTypeChoice element to set adb_KeyInfoTypeChoice_t* to the array
         * @return ith adb_KeyInfoTypeChoice_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _KeyInfoType adb_KeyInfoType_t object
         * @param env pointer to environment struct
         * @param arg_KeyInfoTypeChoice element to add adb_KeyInfoTypeChoice_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _KeyInfoType adb_KeyInfoType_t object
         * @param env pointer to environment struct.
         * @return the size of the KeyInfoTypeChoice array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of KeyInfoTypeChoice.
         * @param  _KeyInfoType adb_KeyInfoType_t object
         * @param env pointer to environment struct
         ...
         * @param  _KeyInfoType _ adb_KeyInfoType_t object
         * @param env pointer to environment struct.
       ...
       adb_KeyInfoType_declare_parent_namespaces(
         ...
         * @param  _KeyInfoType adb_KeyInfoType_t object
         * @param env pointer to environment struct
         * @param KeyInfoType_om_node node to serialize from
         * @param KeyInfoType_om_element parent element to serialize from
        ...
        adb_KeyInfoType_serialize(
            adb_KeyInfoType_t* _KeyInfoType,
            const axutil_env_t *env,
            axiom_node_t* KeyInfoType_om_node, axiom_element_t *KeyInfoType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_KeyInfoType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_KeyInfoType_t
         * @param env pointer to environment struct
         * @param _KeyInfoTypeChoice axutil_array_list_t*
        ...
        adb_KeyInfoType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_KeyInfoType_t object and return the property value.
