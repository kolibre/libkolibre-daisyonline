 ...
 */
        ...
        #ifndef ADB_SIGNATUREPROPERTYTYPE_H
        #define ADB_SIGNATUREPROPERTYTYPE_H

       /**
        * adb_SignaturePropertyType.h
        *
       ...
       /**
        *  adb_SignaturePropertyType class
        */
        ...
        typedef struct adb_SignaturePropertyType adb_SignaturePropertyType_t;
        ...
        /**
         * Constructor for creating adb_SignaturePropertyType_t
         * @param env pointer to environment struct
         * @return newly created adb_SignaturePropertyType_t object
         */
         ...
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_SignaturePropertyType_t object
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for SignaturePropertyTypeChoice. Deprecated for array types, Use adb_SignaturePropertyType_get_SignaturePropertyTypeChoice_at instead
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object
         * @param env pointer to environment struct
         * @return Array of adb_SignaturePropertyTypeChoice_t*s.
         */
        ...
        /**
         * Setter for SignaturePropertyTypeChoice.Deprecated for array types, Use adb_SignaturePropertyType_set_SignaturePropertyTypeChoice_at
         * or adb_SignaturePropertyType_add_SignaturePropertyTypeChoice instead.
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object
         * @param env pointer to environment struct
         * @param arg_SignaturePropertyTypeChoice Array of adb_SignaturePropertyTypeChoice_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of SignaturePropertyTypeChoice.
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @return ith adb_SignaturePropertyTypeChoice_t* of the array
         */
        ...
        /**
         * Set the ith element of SignaturePropertyTypeChoice. (If the ith already exist, it will be replaced)
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_SignaturePropertyTypeChoice element to set adb_SignaturePropertyTypeChoice_t* to the array
         * @return ith adb_SignaturePropertyTypeChoice_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object
         * @param env pointer to environment struct
         * @param arg_SignaturePropertyTypeChoice element to add adb_SignaturePropertyTypeChoice_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object
         * @param env pointer to environment struct.
         * @return the size of the SignaturePropertyTypeChoice array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of SignaturePropertyTypeChoice.
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object
         * @param env pointer to environment struct
         ...
         * @param  _SignaturePropertyType _ adb_SignaturePropertyType_t object
         * @param env pointer to environment struct.
       ...
       adb_SignaturePropertyType_declare_parent_namespaces(
         ...
         * @param  _SignaturePropertyType adb_SignaturePropertyType_t object
         * @param env pointer to environment struct
         * @param SignaturePropertyType_om_node node to serialize from
         * @param SignaturePropertyType_om_element parent element to serialize from
        ...
        adb_SignaturePropertyType_serialize(
            adb_SignaturePropertyType_t* _SignaturePropertyType,
            const axutil_env_t *env,
            axiom_node_t* SignaturePropertyType_om_node, axiom_element_t *SignaturePropertyType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SignaturePropertyType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_SignaturePropertyType_t
         * @param env pointer to environment struct
         * @param _SignaturePropertyTypeChoice axutil_array_list_t*
        ...
        adb_SignaturePropertyType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SignaturePropertyType_t object and return the property value.
     ...
     #endif /* ADB_SIGNATUREPROPERTYTYPE_H */
