 ...
 */
        ...
        #ifndef ADB_DSAKEYVALUETYPESEQUENCE_TYPE0_H
        #define ADB_DSAKEYVALUETYPESEQUENCE_TYPE0_H

       /**
        * adb_DSAKeyValueTypeSequence_type0.h
        *
       ...
       /**
        *  adb_DSAKeyValueTypeSequence_type0 class
        */
        ...
        typedef struct adb_DSAKeyValueTypeSequence_type0 adb_DSAKeyValueTypeSequence_type0_t;
        ...
        /**
         * Constructor for creating adb_DSAKeyValueTypeSequence_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_DSAKeyValueTypeSequence_type0_t object
         */
         ...
         * @param  _DSAKeyValueTypeSequence_type0 adb_DSAKeyValueTypeSequence_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_DSAKeyValueTypeSequence_type0_t object
         * @param  _DSAKeyValueTypeSequence_type0 adb_DSAKeyValueTypeSequence_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for P. 
         * @param  _DSAKeyValueTypeSequence_type0 adb_DSAKeyValueTypeSequence_type0_t object
         * @param env pointer to environment struct
         ...
         * @param  _DSAKeyValueTypeSequence_type0 adb_DSAKeyValueTypeSequence_type0_t object
         * @param env pointer to environment struct
         * @param arg_P adb_CryptoBinary_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _DSAKeyValueTypeSequence_type0 adb_DSAKeyValueTypeSequence_type0_t object
         * @param env pointer to environment struct
         * @param arg_Q adb_CryptoBinary_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_DSAKeyValueTypeSequence_type0_declare_parent_namespaces(
         ...
         * @param  _DSAKeyValueTypeSequence_type0 adb_DSAKeyValueTypeSequence_type0_t object
         * @param env pointer to environment struct
         * @param DSAKeyValueTypeSequence_type0_om_node node to serialize from
         * @param DSAKeyValueTypeSequence_type0_om_element parent element to serialize from
        ...
        adb_DSAKeyValueTypeSequence_type0_serialize(
            adb_DSAKeyValueTypeSequence_type0_t* _DSAKeyValueTypeSequence_type0,
            const axutil_env_t *env,
            axiom_node_t* DSAKeyValueTypeSequence_type0_om_node, axiom_element_t *DSAKeyValueTypeSequence_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_DSAKeyValueTypeSequence_type0 is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_DSAKeyValueTypeSequence_type0_t
         * @param env pointer to environment struct
         * @param _P adb_CryptoBinary_t*
         * @param _Q adb_CryptoBinary_t*
         * @return newly created adb_DSAKeyValueTypeSequence_type0_t object
         */
        adb_DSAKeyValueTypeSequence_type0_t* AXIS2_CALL
        adb_DSAKeyValueTypeSequence_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_DSAKeyValueTypeSequence_type0_t object and return the property value.
     ...
     #endif /* ADB_DSAKEYVALUETYPESEQUENCE_TYPE0_H */
