 ...
 */
        ...
        #ifndef ADB_KEYINFO_H
        #define ADB_KEYINFO_H
        ...
        */
        ...
        typedef struct adb_KeyInfo adb_KeyInfo_t;
        ...
        /**
         * Constructor for creating adb_KeyInfo_t
         * @param env pointer to environment struct
         * @return newly created adb_KeyInfo_t object
         */
         ...
         * @param  _KeyInfo adb_KeyInfo_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for KeyInfo. 
         * @param  _KeyInfo adb_KeyInfo_t object
         * @param env pointer to environment struct
       ...
       adb_KeyInfo_declare_parent_namespaces(
         ...
         * @param  _KeyInfo adb_KeyInfo_t object
         * @param env pointer to environment struct
         * @param KeyInfo_om_node node to serialize from
         * @param KeyInfo_om_element parent element to serialize from
        ...
        adb_KeyInfo_serialize(
            adb_KeyInfo_t* _KeyInfo,
            const axutil_env_t *env,
            axiom_node_t* KeyInfo_om_node, axiom_element_t *KeyInfo_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_KeyInfo is a particle class (E.g. group, inner sequence)
        ...
        adb_KeyInfo_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_KeyInfo_t object and return the property value.
