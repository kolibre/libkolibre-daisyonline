 ...
 */
        ...
        #ifndef ADB_GETCONTENTMETADATARESPONSE_H
        #define ADB_GETCONTENTMETADATARESPONSE_H

       /**
        * adb_getContentMetadataResponse.h
        *
       ...
       /**
        *  adb_getContentMetadataResponse class
        */
        ...
        typedef struct adb_getContentMetadataResponse adb_getContentMetadataResponse_t;
        ...
        /**
         * Constructor for creating adb_getContentMetadataResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_getContentMetadataResponse_t object
         */
         ...
         * @param  _getContentMetadataResponse adb_getContentMetadataResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getContentMetadataResponse_t object
         * @param  _getContentMetadataResponse adb_getContentMetadataResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getContentMetadataResponse adb_getContentMetadataResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _getContentMetadataResponse adb_getContentMetadataResponse_t object
         * @param env pointer to environment struct
         * @param arg_contentMetadata adb_contentMetadata_type0_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getContentMetadataResponse_declare_parent_namespaces(
         ...
         * @param  _getContentMetadataResponse adb_getContentMetadataResponse_t object
         * @param env pointer to environment struct
         * @param getContentMetadataResponse_om_node node to serialize from
         * @param getContentMetadataResponse_om_element parent element to serialize from
        ...
        adb_getContentMetadataResponse_serialize(
            adb_getContentMetadataResponse_t* _getContentMetadataResponse,
            const axutil_env_t *env,
            axiom_node_t* getContentMetadataResponse_om_node, axiom_element_t *getContentMetadataResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getContentMetadataResponse is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_getContentMetadataResponse_t
         * @param env pointer to environment struct
         * @param _contentMetadata adb_contentMetadata_type0_t*
         * @return newly created adb_getContentMetadataResponse_t object
         */
        adb_getContentMetadataResponse_t* AXIS2_CALL
        adb_getContentMetadataResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getContentMetadataResponse_t object and return the property value.
     ...
     #endif /* ADB_GETCONTENTMETADATARESPONSE_H */
