 ...
 */
       ...
       /************************* Private Function prototypes ********************************/
                ...
                axis2_status_t AXIS2_CALL
                adb_ManifestType_set_Reference_nil(
                        adb_ManifestType_t* _ManifestType,
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_ManifestType_create(
            const axutil_env_t *env)
        {
            adb_ManifestType_t *_ManifestType = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _ManifestType = (adb_ManifestType_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_ManifestType_t));

            if(NULL == _ManifestType)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_ManifestType, 0, sizeof(adb_ManifestType_t));

            _ManifestType->property_TypeName = axutil_strdup(env, "adb_ManifestType");
            _ManifestType->property_Reference  = NULL;
                  _ManifestType->is_valid_Reference  = AXIS2_FALSE;
            _ManifestType->property_Id  = NULL;
                  _ManifestType->is_valid_Id  = AXIS2_FALSE;
        ...
        adb_ManifestType_create_with_values(
            const axutil_env_t *env,
                ...
                axis2_char_t* _Id)
        {
            adb_ManifestType_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_ManifestType_create(env);

            
              status = adb_ManifestType_set_Reference(
                                     adb_obj,
                                     env,
                                     _Reference);
              if(status == AXIS2_FAILURE) {
                  adb_ManifestType_free (adb_obj, env);
                  return NULL;
              }
            
              status = adb_ManifestType_set_Id(
                                     adb_obj,
                                     env,
                                     _Id);
              if(status == AXIS2_FAILURE) {
        ...
        axutil_array_list_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _ManifestType->property_Reference;

                    _ManifestType->property_Reference = (axutil_array_list_t*)NULL;
                    adb_ManifestType_free(_ManifestType, env);
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _ManifestType, AXIS2_FAILURE);

            if (_ManifestType->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _ManifestType->property_TypeName);
            }

            adb_ManifestType_reset_Reference(_ManifestType, env);
            adb_ManifestType_reset_Id(_ManifestType, env);
            

            if(_ManifestType)
            {
                AXIS2_FREE(env->allocator, _ManifestType);
                _ManifestType = NULL;
            }
            ...
            AXIS2_PARAM_CHECK(env->error, _ManifestType, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                            "Failed in building adb object for ManifestType : "
                 ...
                 attribute_hash = axiom_element_get_all_attributes(parent_element, env);
                     ...
                     */
                      ...
                      */
                               ...
                               {
                                    status = adb_ManifestType_set_Reference(_ManifestType, env,
                                                                   arr_list);
                               }
                  ...
                  if(attrib_text != NULL)
                  {
                      ...
                      adb_ManifestType_set_Id(_ManifestType,
                                                          env, attrib_text);
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            ...
            if (_ManifestType == NULL)
            {
                return adb_ManifestType_serialize_obj(
                    _ManifestType, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            }
            else
            {
                return axis2_extension_mapper_serialize(
                    (adb_stubtype_t*) _ManifestType, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index, "adb_ManifestType");
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axis2_char_t* type_attrib = NULL;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _ManifestType, NULL);
            ...
            if(!parent_tag_closed)
            {
              ...
              type_attrib = axutil_strcat(env, " ", xsi_prefix, ":type=\"ManifestType\"", NULL);
            ...
            xsi_ns = axiom_namespace_create (env,
                                 ...
                                 xsi_prefix);
            xsi_type_attri = axiom_attribute_create (env, "type", "ManifestType", xsi_ns);
            ...
            axiom_element_add_attribute (parent_element, env, xsi_type_attri, parent);
                   ...
                   if (!_ManifestType->is_valid_Reference)
                   {
                   ...
                   else
                   {
                      ...
                      */
                     if (_ManifestType->property_Reference != NULL)
                     {
                         ...
                         count = axutil_array_list_size(_ManifestType->property_Reference, env);
                         for(i = 0; i < count; i ++)
                         {
                            element = axutil_array_list_get(_ManifestType->property_Reference, env, i);
                    ...
                    if(parent_tag_closed)
                    {
                       if(_ManifestType->is_valid_Id)
                       {
                           ...
                           text_value = _ManifestType->property_Id;
            ...
            adb_ManifestType_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_ManifestType_get_Reference(_ManifestType,
                                             env);
            }
            ...
            adb_ManifestType_get_Reference(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _ManifestType->property_Reference;
             }
            ...
            adb_ManifestType_set_Reference(
                    ...
                    axutil_array_list_t*  arg_Reference)
             {
                ...
                if(_ManifestType->is_valid_Reference &&
                        arg_Reference == _ManifestType->property_Reference)
                {
                ...
                _ManifestType->property_Reference = arg_Reference;
                        if(non_nil_exists)
                        {
                            _ManifestType->is_valid_Reference = AXIS2_TRUE;
                        }
                    ...
                    const axutil_env_t *env, int i)
            {
                ...
                ret_val = (adb_ReferenceType_t*)axutil_array_list_get(_ManifestType->property_Reference, env, i);
                    ...
                    adb_ReferenceType_t* arg_Reference)
            {
                ...
                if( _ManifestType->is_valid_Reference &&
                    _ManifestType->property_Reference &&
                
                    arg_Reference == (adb_ReferenceType_t*)axutil_array_list_get(_ManifestType->property_Reference, env, i))
                  
                {
                    ...
                    if(NULL != arg_Reference)
                    {
                        ...
                        if(_ManifestType->property_Reference != NULL)
                        {
                            size = axutil_array_list_size(_ManifestType->property_Reference, env);
                            for(j = 0, non_nil_count = 0; j < size; j ++ )
                            {
                                if(i == j) continue; 
                                if(NULL != axutil_array_list_get(_ManifestType->property_Reference, env, i))
                                {
                                    non_nil_count ++;
                                    non_nil_exists = AXIS2_TRUE;
                                    if(non_nil_count >= 1)
                ...
                if(_ManifestType->property_Reference == NULL)
                {
                    _ManifestType->property_Reference = axutil_array_list_create(env, 10);
                }
                ...
                if(NULL != element)
                {
                  ...
                  adb_ReferenceType_free((adb_ReferenceType_t*)element, env);
                   ...
                   axutil_array_list_set(_ManifestType->property_Reference , env, i, arg_Reference);
                  _ManifestType->is_valid_Reference = AXIS2_TRUE;
            ...
            adb_ManifestType_add_Reference(
                    ...
                    adb_ReferenceType_t* arg_Reference)
             {
                ...
                if(_ManifestType->property_Reference == NULL)
                {
                   ...
                   axutil_array_list_add(_ManifestType->property_Reference , env, arg_Reference);
                  _ManifestType->is_valid_Reference = AXIS2_TRUE;
                return AXIS2_SUCCESS;
             }
                    ...
                    const axutil_env_t *env)
            {
                ...
                AXIS2_PARAM_CHECK(env->error, _ManifestType, -1);
                if(_ManifestType->property_Reference == NULL)
                {
                    return 0;
                }
                return axutil_array_list_size(_ManifestType->property_Reference, env);
            }
            ...
            adb_ManifestType_remove_Reference_at(
                    ...
                    const axutil_env_t *env, int i)
            {
                return adb_ManifestType_set_Reference_nil_at(_ManifestType, env, i);
            }
                ...
                if(element != NULL)
                {
                   ...
                   adb_ReferenceType_free((adb_ReferenceType_t*)element, env);
                     element = NULL;
                      ...
                      axutil_array_list_free(_ManifestType->property_Reference, env);
                  }
                _ManifestType->is_valid_Reference = AXIS2_FALSE; 
               return AXIS2_SUCCESS;
           }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _ManifestType, AXIS2_TRUE);
               
               return !_ManifestType->is_valid_Reference;
           }
           ...
           adb_ManifestType_set_Reference_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_ManifestType_reset_Reference(_ManifestType, env);
           }
                   ...
                   const axutil_env_t *env, int i)
           {
               ...
               return (_ManifestType->is_valid_Reference == AXIS2_FALSE ||
                        NULL == _ManifestType->property_Reference || 
                        NULL == axutil_array_list_get(_ManifestType->property_Reference, env, i));
           }
                   ...
                   const axutil_env_t *env, int i)
           {
                ...
                axutil_array_list_set(_ManifestType->property_Reference , env, i, NULL);
            ...
            adb_ManifestType_get_property2(
                ...
                const axutil_env_t *env)
            {
                return adb_ManifestType_get_Id(_ManifestType,
                                             env);
            }
            ...
            adb_ManifestType_get_Id(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _ManifestType->property_Id;
             }
            ...
            adb_ManifestType_set_Id(
                    ...
                    const axis2_char_t*  arg_Id)
             {
                ...
                if(_ManifestType->is_valid_Id &&
                        arg_Id == _ManifestType->property_Id)
                {
                ...
                _ManifestType->property_Id = (axis2_char_t *)axutil_strdup(env, arg_Id);
                        if(NULL == _ManifestType->property_Id)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for Id");
                            return AXIS2_FAILURE;
                        }
                        _ManifestType->is_valid_Id = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _ManifestType, AXIS2_FAILURE);
                ...
                if(_ManifestType->property_Id != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _ManifestType->property_Id);
                     _ManifestType->property_Id = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_ManifestType->is_valid_Id;
           }
           ...
           adb_ManifestType_set_Id_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_ManifestType_reset_Id(_ManifestType, env);
           }
