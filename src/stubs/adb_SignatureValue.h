 ...
 */
        ...
        #ifndef ADB_SIGNATUREVALUE_H
        #define ADB_SIGNATUREVALUE_H

       /**
        * adb_SignatureValue.h
        *
        ...
        */
        ...
        typedef struct adb_SignatureValue adb_SignatureValue_t;
        ...
        /**
         * Constructor for creating adb_SignatureValue_t
         * @param env pointer to environment struct
         * @return newly created adb_SignatureValue_t object
         */
         ...
         * @param  _SignatureValue adb_SignatureValue_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_SignatureValue_t object
         * @param  _SignatureValue adb_SignatureValue_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _SignatureValue adb_SignatureValue_t object
         * @param env pointer to environment struct
       ...
       adb_SignatureValue_declare_parent_namespaces(
         ...
         * @param  _SignatureValue adb_SignatureValue_t object
         * @param env pointer to environment struct
         * @param SignatureValue_om_node node to serialize from
         * @param SignatureValue_om_element parent element to serialize from
        ...
        adb_SignatureValue_serialize(
            adb_SignatureValue_t* _SignatureValue,
            const axutil_env_t *env,
            axiom_node_t* SignatureValue_om_node, axiom_element_t *SignatureValue_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SignatureValue is a particle class (E.g. group, inner sequence)
        ...
        adb_SignatureValue_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SignatureValue_t object and return the property value.
