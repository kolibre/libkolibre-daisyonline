 ...
 */
        ...
        #include "adb_noActiveSessionFault.h"
               ...
               /*
                * implmentation of the noActiveSessionFault|http://www.daisy.org/ns/daisy-online/ element
                */
        ...
        struct adb_noActiveSessionFault
        {
            ...
            adb_noActiveSessionFaultType_t* property_noActiveSessionFault;
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_noActiveSessionFault_set_noActiveSessionFault_nil(
                        adb_noActiveSessionFault_t* _noActiveSessionFault,
                        const axutil_env_t *env);
            


       /************************* Function Implmentations ********************************/
        adb_noActiveSessionFault_t* AXIS2_CALL
        adb_noActiveSessionFault_create(
            const axutil_env_t *env)
        {
            adb_noActiveSessionFault_t *_noActiveSessionFault = NULL;
            
                axutil_qname_t* qname = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _noActiveSessionFault = (adb_noActiveSessionFault_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_noActiveSessionFault_t));
            ...
            memset(_noActiveSessionFault, 0, sizeof(adb_noActiveSessionFault_t));

            _noActiveSessionFault->property_TypeName = axutil_strdup(env, "adb_noActiveSessionFault");
        ...
        adb_noActiveSessionFault_t* AXIS2_CALL
        adb_noActiveSessionFault_create_with_values(
            const axutil_env_t *env,
                adb_noActiveSessionFaultType_t* _noActiveSessionFault)
        {
            ...
            adb_obj = adb_noActiveSessionFault_create(env);
              ...
              status = adb_noActiveSessionFault_set_noActiveSessionFault(
                                     adb_obj,
                                     env,
        ...
        adb_noActiveSessionFaultType_t* AXIS2_CALL
                adb_noActiveSessionFault_free_popping_value(
                        adb_noActiveSessionFault_t* _noActiveSessionFault,
                        const axutil_env_t *env)
                {
                    adb_noActiveSessionFaultType_t* value;

                    
                    
                    value = _noActiveSessionFault->property_noActiveSessionFault;

                    _noActiveSessionFault->property_noActiveSessionFault = (adb_noActiveSessionFaultType_t*)NULL;
                    adb_noActiveSessionFault_free(_noActiveSessionFault, env);
        ...
        axis2_status_t AXIS2_CALL
        adb_noActiveSessionFault_free(
                adb_noActiveSessionFault_t* _noActiveSessionFault,
                const axutil_env_t *env)
        {
            
            
            return adb_noActiveSessionFault_free_obj(
                _noActiveSessionFault,
                env);
        ...
        axis2_status_t AXIS2_CALL
        adb_noActiveSessionFault_free_obj(
                adb_noActiveSessionFault_t* _noActiveSessionFault,
                const axutil_env_t *env)
        {
            ...
            adb_noActiveSessionFault_reset_noActiveSessionFault(_noActiveSessionFault, env);
        ...
        axis2_status_t AXIS2_CALL
        adb_noActiveSessionFault_deserialize(
                adb_noActiveSessionFault_t* _noActiveSessionFault,
                const axutil_env_t *env,
                ...
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            return adb_noActiveSessionFault_deserialize_obj(
                _noActiveSessionFault,
                env,
                dp_parent,
        ...
        axis2_status_t AXIS2_CALL
        adb_noActiveSessionFault_deserialize_obj(
                adb_noActiveSessionFault_t* _noActiveSessionFault,
                const axutil_env_t *env,
                axiom_node_t **dp_parent,
                axis2_bool_t *dp_is_early_node_valid,
                axis2_bool_t dont_care_minoccurs)
        {
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(env, "noActiveSessionFault", "http://www.daisy.org/ns/daisy-online/", NULL);
                                 

                           if (adb_noActiveSessionFaultType_is_particle() ||  
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      element = (void*)axis2_extension_mapper_create_from_node(env, &current_node, "adb_noActiveSessionFaultType");

                                      status =  adb_noActiveSessionFaultType_deserialize((adb_noActiveSessionFaultType_t*)element,
                                      ...
                                      {
                                          status = adb_noActiveSessionFault_set_noActiveSessionFault(_noActiveSessionFault, env,
                                                                   (adb_noActiveSessionFaultType_t*)element);
                                      }
          ...
          adb_noActiveSessionFault_is_particle()
          {
          ...
          void AXIS2_CALL
          adb_noActiveSessionFault_declare_parent_namespaces(
                    adb_noActiveSessionFault_t* _noActiveSessionFault,
        ...
        adb_noActiveSessionFault_serialize(
                adb_noActiveSessionFault_t* _noActiveSessionFault,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            
            
                return adb_noActiveSessionFault_serialize_obj(
                    _noActiveSessionFault, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            
        }

        axiom_node_t* AXIS2_CALL
        adb_noActiveSessionFault_serialize_obj(
                adb_noActiveSessionFault_t* _noActiveSessionFault,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axiom_attribute_t* xsi_type_attri = NULL;
            ...
            AXIS2_PARAM_CHECK(env->error, _noActiveSessionFault, NULL);
                   ...
                   else
                   {
                    ...
                    adb_noActiveSessionFaultType_serialize(_noActiveSessionFault->property_noActiveSessionFault, 
                                                                                 env, current_node, parent_element,
                                                                                 adb_noActiveSessionFaultType_is_particle() || AXIS2_TRUE, namespaces, next_ns_index);
             ...
             */
            adb_noActiveSessionFaultType_t* AXIS2_CALL
            adb_noActiveSessionFault_get_property1(
                adb_noActiveSessionFault_t* _noActiveSessionFault,
                const axutil_env_t *env)
            {
                return adb_noActiveSessionFault_get_noActiveSessionFault(_noActiveSessionFault,
                                             env);
            }
             ...
             */
            adb_noActiveSessionFaultType_t* AXIS2_CALL
            adb_noActiveSessionFault_get_noActiveSessionFault(
                    adb_noActiveSessionFault_t* _noActiveSessionFault,
                    const axutil_env_t *env)
             {
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_noActiveSessionFault_set_noActiveSessionFault(
                    adb_noActiveSessionFault_t* _noActiveSessionFault,
                    const axutil_env_t *env,
                    adb_noActiveSessionFaultType_t*  arg_noActiveSessionFault)
             {
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_noActiveSessionFault_reset_noActiveSessionFault(
                   adb_noActiveSessionFault_t* _noActiveSessionFault,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _noActiveSessionFault, AXIS2_FAILURE);
                ...
                if(_noActiveSessionFault->property_noActiveSessionFault != NULL)
                {
                   ...
                   adb_noActiveSessionFaultType_free(_noActiveSessionFault->property_noActiveSessionFault, env);
                     _noActiveSessionFault->property_noActiveSessionFault = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_noActiveSessionFault_is_noActiveSessionFault_nil(
                   adb_noActiveSessionFault_t* _noActiveSessionFault,
                   const axutil_env_t *env)
           {
           ...
           adb_noActiveSessionFault_set_noActiveSessionFault_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_noActiveSessionFault_reset_noActiveSessionFault(_noActiveSessionFault, env);
           }
