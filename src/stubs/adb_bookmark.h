 ...
 */
        ...
        #ifndef ADB_BOOKMARK_H
        #define ADB_BOOKMARK_H
        ...
        */
        ...
        typedef struct adb_bookmark adb_bookmark_t;
        ...
        /**
         * Constructor for creating adb_bookmark_t
         * @param env pointer to environment struct
         * @return newly created adb_bookmark_t object
         */
         ...
         * @param  _bookmark adb_bookmark_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for bookmark. 
         * @param  _bookmark adb_bookmark_t object
         * @param env pointer to environment struct
       ...
       adb_bookmark_declare_parent_namespaces(
         ...
         * @param  _bookmark adb_bookmark_t object
         * @param env pointer to environment struct
         * @param bookmark_om_node node to serialize from
         * @param bookmark_om_element parent element to serialize from
        ...
        adb_bookmark_serialize(
            adb_bookmark_t* _bookmark,
            const axutil_env_t *env,
            axiom_node_t* bookmark_om_node, axiom_element_t *bookmark_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_bookmark is a particle class (E.g. group, inner sequence)
        ...
        adb_bookmark_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_bookmark_t object and return the property value.
