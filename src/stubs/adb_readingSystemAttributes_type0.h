 ...
 */
        ...
        #ifndef ADB_READINGSYSTEMATTRIBUTES_TYPE0_H
        #define ADB_READINGSYSTEMATTRIBUTES_TYPE0_H

       /**
        * adb_readingSystemAttributes_type0.h
        *
       ...
       /**
        *  adb_readingSystemAttributes_type0 class
        */
        ...
        typedef struct adb_readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t;
        ...
        /**
         * Constructor for creating adb_readingSystemAttributes_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_readingSystemAttributes_type0_t object
         */
         ...
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_readingSystemAttributes_type0_t object
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for readingSystemAttributesChoice_type1. Deprecated for array types, Use adb_readingSystemAttributes_type0_get_readingSystemAttributesChoice_type1_at instead
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct
         * @return Array of adb_readingSystemAttributesChoice_type1_t*s.
         */
        ...
        /**
         * Setter for readingSystemAttributesChoice_type1.Deprecated for array types, Use adb_readingSystemAttributes_type0_set_readingSystemAttributesChoice_type1_at
         * or adb_readingSystemAttributes_type0_add_readingSystemAttributesChoice_type1 instead.
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct
         * @param arg_readingSystemAttributesChoice_type1 Array of adb_readingSystemAttributesChoice_type1_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of readingSystemAttributesChoice_type1.
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @return ith adb_readingSystemAttributesChoice_type1_t* of the array
         */
        ...
        /**
         * Set the ith element of readingSystemAttributesChoice_type1. (If the ith already exist, it will be replaced)
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_readingSystemAttributesChoice_type1 element to set adb_readingSystemAttributesChoice_type1_t* to the array
         * @return ith adb_readingSystemAttributesChoice_type1_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct
         * @param arg_readingSystemAttributesChoice_type1 element to add adb_readingSystemAttributesChoice_type1_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct.
         * @return the size of the readingSystemAttributesChoice_type1 array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of readingSystemAttributesChoice_type1.
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct
         ...
         * @param  _readingSystemAttributes_type0 _ adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct.
       ...
       adb_readingSystemAttributes_type0_declare_parent_namespaces(
         ...
         * @param  _readingSystemAttributes_type0 adb_readingSystemAttributes_type0_t object
         * @param env pointer to environment struct
         * @param readingSystemAttributes_type0_om_node node to serialize from
         * @param readingSystemAttributes_type0_om_element parent element to serialize from
        ...
        adb_readingSystemAttributes_type0_serialize(
            adb_readingSystemAttributes_type0_t* _readingSystemAttributes_type0,
            const axutil_env_t *env,
            axiom_node_t* readingSystemAttributes_type0_om_node, axiom_element_t *readingSystemAttributes_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_readingSystemAttributes_type0 is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_readingSystemAttributes_type0_t
         * @param env pointer to environment struct
         * @param _readingSystemAttributesChoice_type1 axutil_array_list_t*
        ...
        adb_readingSystemAttributes_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_readingSystemAttributes_type0_t object and return the property value.
     ...
     #endif /* ADB_READINGSYSTEMATTRIBUTES_TYPE0_H */
