 ...
 */
        ...
        #ifndef ADB_OBJECTTYPESEQUENCE_H
        #define ADB_OBJECTTYPESEQUENCE_H

       /**
        * adb_ObjectTypeSequence.h
        *
        ...
        */
        ...
        typedef struct adb_ObjectTypeSequence adb_ObjectTypeSequence_t;
        ...
        /**
         * Constructor for creating adb_ObjectTypeSequence_t
         * @param env pointer to environment struct
         * @return newly created adb_ObjectTypeSequence_t object
         */
         ...
         * @param  _ObjectTypeSequence adb_ObjectTypeSequence_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_ObjectTypeSequence_t object
         * @param  _ObjectTypeSequence adb_ObjectTypeSequence_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _ObjectTypeSequence adb_ObjectTypeSequence_t object
         * @param env pointer to environment struct
         * @return axiom_node_t*
         */
       ...
       adb_ObjectTypeSequence_declare_parent_namespaces(
         ...
         * @param  _ObjectTypeSequence adb_ObjectTypeSequence_t object
         * @param env pointer to environment struct
         * @param ObjectTypeSequence_om_node node to serialize from
         * @param ObjectTypeSequence_om_element parent element to serialize from
        ...
        adb_ObjectTypeSequence_serialize(
            adb_ObjectTypeSequence_t* _ObjectTypeSequence,
            const axutil_env_t *env,
            axiom_node_t* ObjectTypeSequence_om_node, axiom_element_t *ObjectTypeSequence_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_ObjectTypeSequence is a particle class (E.g. group, inner sequence)
        ...
        adb_ObjectTypeSequence_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_ObjectTypeSequence_t object and return the property value.
     ...
     #endif /* ADB_OBJECTTYPESEQUENCE_H */
