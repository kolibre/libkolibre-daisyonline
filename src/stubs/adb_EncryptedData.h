 ...
 */
        ...
        #ifndef ADB_ENCRYPTEDDATA_H
        #define ADB_ENCRYPTEDDATA_H
        ...
        */
        ...
        typedef struct adb_EncryptedData adb_EncryptedData_t;
        ...
        /**
         * Constructor for creating adb_EncryptedData_t
         * @param env pointer to environment struct
         * @return newly created adb_EncryptedData_t object
         */
         ...
         * @param  _EncryptedData adb_EncryptedData_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_EncryptedData_t object
         * @param  _EncryptedData adb_EncryptedData_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _EncryptedData adb_EncryptedData_t object
         * @param env pointer to environment struct
         * @return adb_EncryptedDataType_t*
         */
         ...
         * @param  _EncryptedData adb_EncryptedData_t object
         * @param env pointer to environment struct
         * @param arg_EncryptedData adb_EncryptedDataType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_EncryptedData_declare_parent_namespaces(
         ...
         * @param  _EncryptedData adb_EncryptedData_t object
         * @param env pointer to environment struct
         * @param EncryptedData_om_node node to serialize from
         * @param EncryptedData_om_element parent element to serialize from
        ...
        adb_EncryptedData_serialize(
            adb_EncryptedData_t* _EncryptedData,
            const axutil_env_t *env,
            axiom_node_t* EncryptedData_om_node, axiom_element_t *EncryptedData_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_EncryptedData is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_EncryptedData_t
         * @param env pointer to environment struct
         * @param _EncryptedData adb_EncryptedDataType_t*
         * @return newly created adb_EncryptedData_t object
         */
        adb_EncryptedData_t* AXIS2_CALL
        adb_EncryptedData_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_EncryptedData_t object and return the property value.
