 ...
 */
        ...
        #ifndef ADB_REFERENCETYPEE2_H
        #define ADB_REFERENCETYPEE2_H

       /**
        * adb_ReferenceTypeE2.h
        *
        ...
        */
        ...
        typedef struct adb_ReferenceTypeE2 adb_ReferenceTypeE2_t;
        ...
        /**
         * Constructor for creating adb_ReferenceTypeE2_t
         * @param env pointer to environment struct
         * @return newly created adb_ReferenceTypeE2_t object
         */
         ...
         * @param  _ReferenceTypeE2 adb_ReferenceTypeE2_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_ReferenceTypeE2_t object
         * @param  _ReferenceTypeE2 adb_ReferenceTypeE2_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for extraElement. Deprecated for array types, Use adb_ReferenceTypeE2_get_extraElement_at instead
         * @param  _ReferenceTypeE2 adb_ReferenceTypeE2_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for extraElement.Deprecated for array types, Use adb_ReferenceTypeE2_set_extraElement_at
         * or adb_ReferenceTypeE2_add_extraElement instead.
         * @param  _ReferenceTypeE2 adb_ReferenceTypeE2_t object
         * @param env pointer to environment struct
         ...
         * @param  _ReferenceTypeE2 _ adb_ReferenceTypeE2_t object
         * @param env pointer to environment struct.
       ...
       adb_ReferenceTypeE2_declare_parent_namespaces(
         ...
         * @param  _ReferenceTypeE2 adb_ReferenceTypeE2_t object
         * @param env pointer to environment struct
         * @param ReferenceTypeE2_om_node node to serialize from
         * @param ReferenceTypeE2_om_element parent element to serialize from
        ...
        adb_ReferenceTypeE2_serialize(
            adb_ReferenceTypeE2_t* _ReferenceTypeE2,
            const axutil_env_t *env,
            axiom_node_t* ReferenceTypeE2_om_node, axiom_element_t *ReferenceTypeE2_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_ReferenceTypeE2 is a particle class (E.g. group, inner sequence)
        ...
        adb_ReferenceTypeE2_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_ReferenceTypeE2_t object and return the property value.
