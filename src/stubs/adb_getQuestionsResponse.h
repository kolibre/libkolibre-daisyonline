 ...
 */
        ...
        #ifndef ADB_GETQUESTIONSRESPONSE_H
        #define ADB_GETQUESTIONSRESPONSE_H

       /**
        * adb_getQuestionsResponse.h
        *
       ...
       /**
        *  adb_getQuestionsResponse class
        */
        ...
        typedef struct adb_getQuestionsResponse adb_getQuestionsResponse_t;
        ...
        /**
         * Constructor for creating adb_getQuestionsResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_getQuestionsResponse_t object
         */
         ...
         * @param  _getQuestionsResponse adb_getQuestionsResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getQuestionsResponse_t object
         * @param  _getQuestionsResponse adb_getQuestionsResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getQuestionsResponse adb_getQuestionsResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _getQuestionsResponse adb_getQuestionsResponse_t object
         * @param env pointer to environment struct
         * @param arg_questions adb_questions_type0_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getQuestionsResponse_declare_parent_namespaces(
         ...
         * @param  _getQuestionsResponse adb_getQuestionsResponse_t object
         * @param env pointer to environment struct
         * @param getQuestionsResponse_om_node node to serialize from
         * @param getQuestionsResponse_om_element parent element to serialize from
        ...
        adb_getQuestionsResponse_serialize(
            adb_getQuestionsResponse_t* _getQuestionsResponse,
            const axutil_env_t *env,
            axiom_node_t* getQuestionsResponse_om_node, axiom_element_t *getQuestionsResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getQuestionsResponse is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_getQuestionsResponse_t
         * @param env pointer to environment struct
         * @param _questions adb_questions_type0_t*
         * @return newly created adb_getQuestionsResponse_t object
         */
        adb_getQuestionsResponse_t* AXIS2_CALL
        adb_getQuestionsResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getQuestionsResponse_t object and return the property value.
     ...
     #endif /* ADB_GETQUESTIONSRESPONSE_H */
