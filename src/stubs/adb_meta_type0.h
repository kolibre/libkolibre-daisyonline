 ...
 */
        ...
        #ifndef ADB_META_TYPE0_H
        #define ADB_META_TYPE0_H
        ...
        */
        ...
        typedef struct adb_meta_type0 adb_meta_type0_t;
        ...
        /**
         * Constructor for creating adb_meta_type0_t
         * @param env pointer to environment struct
         * @return newly created adb_meta_type0_t object
         */
         ...
         * @param  _meta_type0 adb_meta_type0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for name. 
         * @param  _meta_type0 adb_meta_type0_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_meta_type0_declare_parent_namespaces(
         ...
         * @param  _meta_type0 adb_meta_type0_t object
         * @param env pointer to environment struct
         * @param meta_type0_om_node node to serialize from
         * @param meta_type0_om_element parent element to serialize from
        ...
        adb_meta_type0_serialize(
            adb_meta_type0_t* _meta_type0,
            const axutil_env_t *env,
            axiom_node_t* meta_type0_om_node, axiom_element_t *meta_type0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_meta_type0 is a particle class (E.g. group, inner sequence)
        ...
        adb_meta_type0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_meta_type0_t object and return the property value.
