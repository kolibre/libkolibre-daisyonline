 ...
 */
        ...
        #ifndef ADB_DIGESTVALUE_H
        #define ADB_DIGESTVALUE_H
        ...
        */
        ...
        typedef struct adb_DigestValue adb_DigestValue_t;
        ...
        /**
         * Constructor for creating adb_DigestValue_t
         * @param env pointer to environment struct
         * @return newly created adb_DigestValue_t object
         */
         ...
         * @param  _DigestValue adb_DigestValue_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _DigestValue adb_DigestValue_t object
         * @param env pointer to environment struct
       ...
       adb_DigestValue_declare_parent_namespaces(
         ...
         * @param  _DigestValue adb_DigestValue_t object
         * @param env pointer to environment struct
         * @param DigestValue_om_node node to serialize from
         * @param DigestValue_om_element parent element to serialize from
        ...
        adb_DigestValue_serialize(
            adb_DigestValue_t* _DigestValue,
            const axutil_env_t *env,
            axiom_node_t* DigestValue_om_node, axiom_element_t *DigestValue_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_DigestValue is a particle class (E.g. group, inner sequence)
        ...
        adb_DigestValue_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_DigestValue_t object and return the property value.
