 ...
 */
        ...
        #ifndef ADB_SIMPLELITERAL_H
        #define ADB_SIMPLELITERAL_H
        ...
        */
        ...
        typedef struct adb_SimpleLiteral adb_SimpleLiteral_t;
        ...
        /**
         * Constructor for creating adb_SimpleLiteral_t
         * @param env pointer to environment struct
         * @return newly created adb_SimpleLiteral_t object
         */
         ...
         * @param  _SimpleLiteral adb_SimpleLiteral_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_SimpleLiteral_t object
         * @param  _SimpleLiteral adb_SimpleLiteral_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _SimpleLiteral adb_SimpleLiteral_t object
         * @param env pointer to environment struct
         * @return axiom_node_t*
         */
       ...
       adb_SimpleLiteral_declare_parent_namespaces(
         ...
         * @param  _SimpleLiteral adb_SimpleLiteral_t object
         * @param env pointer to environment struct
         * @param SimpleLiteral_om_node node to serialize from
         * @param SimpleLiteral_om_element parent element to serialize from
        ...
        adb_SimpleLiteral_serialize(
            adb_SimpleLiteral_t* _SimpleLiteral,
            const axutil_env_t *env,
            axiom_node_t* SimpleLiteral_om_node, axiom_element_t *SimpleLiteral_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SimpleLiteral is a particle class (E.g. group, inner sequence)
        ...
        adb_SimpleLiteral_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SimpleLiteral_t object and return the property value.
