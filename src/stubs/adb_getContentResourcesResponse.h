 ...
 */
        ...
        #ifndef ADB_GETCONTENTRESOURCESRESPONSE_H
        #define ADB_GETCONTENTRESOURCESRESPONSE_H

       /**
        * adb_getContentResourcesResponse.h
        *
       ...
       /**
        *  adb_getContentResourcesResponse class
        */
        ...
        typedef struct adb_getContentResourcesResponse adb_getContentResourcesResponse_t;
        ...
        /**
         * Constructor for creating adb_getContentResourcesResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_getContentResourcesResponse_t object
         */
         ...
         * @param  _getContentResourcesResponse adb_getContentResourcesResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getContentResourcesResponse_t object
         * @param  _getContentResourcesResponse adb_getContentResourcesResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getContentResourcesResponse adb_getContentResourcesResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _getContentResourcesResponse adb_getContentResourcesResponse_t object
         * @param env pointer to environment struct
         * @param arg_resources adb_resources_type0_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getContentResourcesResponse_declare_parent_namespaces(
         ...
         * @param  _getContentResourcesResponse adb_getContentResourcesResponse_t object
         * @param env pointer to environment struct
         * @param getContentResourcesResponse_om_node node to serialize from
         * @param getContentResourcesResponse_om_element parent element to serialize from
        ...
        adb_getContentResourcesResponse_serialize(
            adb_getContentResourcesResponse_t* _getContentResourcesResponse,
            const axutil_env_t *env,
            axiom_node_t* getContentResourcesResponse_om_node, axiom_element_t *getContentResourcesResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getContentResourcesResponse is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_getContentResourcesResponse_t
         * @param env pointer to environment struct
         * @param _resources adb_resources_type0_t*
         * @return newly created adb_getContentResourcesResponse_t object
         */
        adb_getContentResourcesResponse_t* AXIS2_CALL
        adb_getContentResourcesResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getContentResourcesResponse_t object and return the property value.
     ...
     #endif /* ADB_GETCONTENTRESOURCESRESPONSE_H */
