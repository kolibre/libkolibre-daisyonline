 ...
 */
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_service_type0_set_label_nil(
                        adb_service_type0_t* _service_type0,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_service_type0_set_id_nil(
                        adb_service_type0_t* _service_type0,
                        const axutil_env_t *env);
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_service_type0_create(
            const axutil_env_t *env)
        {
            adb_service_type0_t *_service_type0 = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _service_type0 = (adb_service_type0_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_service_type0_t));

            if(NULL == _service_type0)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_service_type0, 0, sizeof(adb_service_type0_t));

            _service_type0->property_TypeName = axutil_strdup(env, "adb_service_type0");
            _service_type0->property_label  = NULL;
                  _service_type0->is_valid_label  = AXIS2_FALSE;
            _service_type0->property_id  = NULL;
                  _service_type0->is_valid_id  = AXIS2_FALSE;
            

            return _service_type0;
        }

        adb_service_type0_t* AXIS2_CALL
        adb_service_type0_create_with_values(
            const axutil_env_t *env,
                adb_label_type0_t* _label,
                axis2_char_t* _id)
        {
            adb_service_type0_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_service_type0_create(env);

            
              status = adb_service_type0_set_label(
                                     adb_obj,
                                     env,
                                     _label);
              if(status == AXIS2_FAILURE) {
                  adb_service_type0_free (adb_obj, env);
                  return NULL;
              }
            
              status = adb_service_type0_set_id(
                                     adb_obj,
                                     env,
                                     _id);
              if(status == AXIS2_FAILURE) {
        ...
        adb_label_type0_t* AXIS2_CALL
                adb_service_type0_free_popping_value(
                        adb_service_type0_t* _service_type0,
                        const axutil_env_t *env)
                {
                    ...
                    value = _service_type0->property_label;

                    _service_type0->property_label = (adb_label_type0_t*)NULL;
                    adb_service_type0_free(_service_type0, env);
                ...
                const axutil_env_t *env)
        {
            ...
            if (_service_type0->property_TypeName != NULL)
            {
              AXIS2_FREE(env->allocator, _service_type0->property_TypeName);
            }

            adb_service_type0_reset_label(_service_type0, env);
            adb_service_type0_reset_id(_service_type0, env);
            

            if(_service_type0)
            {
                AXIS2_FREE(env->allocator, _service_type0);
                _service_type0 = NULL;
            }
                ...
                axis2_bool_t dont_care_minoccurs)
        {
          ...
          void AXIS2_CALL
          adb_service_type0_declare_parent_namespaces(
                    adb_service_type0_t* _service_type0,
        ...
        adb_service_type0_serialize(
                adb_service_type0_t* _service_type0,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            
            
            if (_service_type0 == NULL)
            {
                return adb_service_type0_serialize_obj(
                    _service_type0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            }
            else
            {
                return axis2_extension_mapper_serialize(
                    (adb_stubtype_t*) _service_type0, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index, "adb_service_type0");
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axis2_char_t* type_attrib = NULL;
            ...
            if(!parent_tag_closed)
            {
              ...
              type_attrib = axutil_strcat(env, " ", xsi_prefix, ":type=\"service_type0\"", NULL);
            ...
            xsi_ns = axiom_namespace_create (env,
                                 ...
                                 xsi_prefix);
            xsi_type_attri = axiom_attribute_create (env, "type", "service_type0", xsi_ns);
             ...
             */
            adb_label_type0_t* AXIS2_CALL
            adb_service_type0_get_property1(
                adb_service_type0_t* _service_type0,
                const axutil_env_t *env)
            {
                return adb_service_type0_get_label(_service_type0,
                                             env);
            }
            ...
            adb_service_type0_get_label(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _service_type0->property_label;
             }
            ...
            adb_service_type0_set_label(
                    ...
                    adb_label_type0_t*  arg_label)
             {
                ...
                if(_service_type0->is_valid_label &&
                        arg_label == _service_type0->property_label)
                {
                ...
                _service_type0->property_label = arg_label;
                        _service_type0->is_valid_label = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _service_type0, AXIS2_FAILURE);
                ...
                if(_service_type0->property_label != NULL)
                {
                   
                   adb_label_type0_free(_service_type0->property_label, env);
                     _service_type0->property_label = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_service_type0_is_label_nil(
                   adb_service_type0_t* _service_type0,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               AXIS2_PARAM_CHECK(env->error, _service_type0, AXIS2_TRUE);
               
               return !_service_type0->is_valid_label;
           }
           ...
           adb_service_type0_set_label_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_service_type0_reset_label(_service_type0, env);
           }
            ...
            adb_service_type0_get_property2(
                adb_service_type0_t* _service_type0,
                const axutil_env_t *env)
            {
                return adb_service_type0_get_id(_service_type0,
                                             env);
            }
            ...
            adb_service_type0_get_id(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _service_type0->property_id;
             }
            ...
            adb_service_type0_set_id(
                    ...
                    const axis2_char_t*  arg_id)
             {
                ...
                if(_service_type0->is_valid_id &&
                        arg_id == _service_type0->property_id)
                {
                ...
                _service_type0->property_id = (axis2_char_t *)axutil_strdup(env, arg_id);
                        if(NULL == _service_type0->property_id)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for id");
                            return AXIS2_FAILURE;
                        }
                        _service_type0->is_valid_id = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _service_type0, AXIS2_FAILURE);
                ...
                if(_service_type0->property_id != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _service_type0->property_id);
                     _service_type0->property_id = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_service_type0->is_valid_id;
           }
           ...
           adb_service_type0_set_id_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_service_type0_reset_id(_service_type0, env);
           }
